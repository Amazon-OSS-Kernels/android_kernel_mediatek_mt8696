...
static const struct mtk_fixed_factor top_divs[] = {
	...
	FACTOR(CLK_TOP_HDMIRX_APLL_D6, "hdmirx_apll_d6", "hdmirx_apll_d3",
		1, 2),
	...
	FACTOR(CLK_TOP_TVDPLL_D6, "tvdpll_d6", "tvdpll_d3", 1, 2),
	FACTOR(CLK_TOP_MSDCPLL_D2, "msdcpll_d2", "msdcpll", 1, 2),
	FACTOR(CLK_TOP_MSDCPLL_D4, "msdcpll_d4", "msdcpll", 1, 4),
	FACTOR(CLK_TOP_MSDCPLL_D8, "msdcpll_d8", "msdcpll", 1, 8),
	FACTOR(CLK_TOP_HDMITX_PIXEL, "hdmitx_pixel", "None", 1, 1),
	...
	FACTOR(CLK_TOP_HDMITX_PIXEL_D3, "hdmitx_pixel_d3", "hdmitx_pixel",
		1, 3),
	FACTOR(CLK_TOP_HDMITX_PIXEL_D6, "hdmitx_pixel_d6", "hdmitx_pixel_d3",
		1, 2),
	FACTOR(CLK_TOP_CLKRTC_INT, "clkrtc_int", "clk26m", 1, 813),
	FACTOR(CLK_TOP_CLKRTC_EXT, "clkrtc_ext", "None", 1, 1),
	FACTOR(CLK_TOP_DMPLL, "dmpll", "None", 1, 1),
...
static struct mtk_mux top_muxes[] = {
	...
	MUX_GATE_CLR_SET_UPD_FLAGS(CLK_TOP_MEMSEL, "memsel",
	    memsel_parents, 0x010, 0x014, 0x018, 16, 2, 23,
	    0x4, 2, CLK_IS_CRITICAL),
	MUX_GATE_CLR_SET_UPD_FLAGS(CLK_TOP_MEMREF_104_SEL, "memref_104_sel",
	    memref_104_parents, 0x010, 0x014, 0x018, 24, 1, 31, 0x4, 3,
	    CLK_IS_CRITICAL),
	/* CLK_CFG_1 */
	MUX_GATE_CLR_SET_UPD_FLAGS(CLK_TOP_MEM52M_SEL, "mem52m_sel",
	    mem52m_parents, 0x020, 0x024, 0x028, 0, 1, 7, 0x4, 4,
	    CLK_IS_CRITICAL),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SD_SEL, "sd_sel",
	    sd_parents, 0x020, 0x024, 0x028, 8, 2, 15, 0x4, 5),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_MMSEL, "mmsel",
	...
	/* CLK_CFG_2 */
	MUX_GATE_CLR_SET_UPD(CLK_TOP_VDEC_SLOW_SEL, "vdec_slow_sel",
	...
	MUX_GATE_CLR_SET_UPD(CLK_TOP_RSZ_SEL, "rsz_sel",
	...
	MUX_GATE_CLR_SET_UPD(CLK_TOP_USB20_SEL, "usb20_sel",
	    usb20_parents, 0x040, 0x044, 0x048, 16, 2, 23, 0x4, 14),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_USB30_SEL, "usb30_sel",
	...
	/* CLK_CFG_5 */
	MUX_GATE_CLR_SET_UPD(CLK_TOP_MSDC50_2_HC_SEL, "msdc50_2_hc_sel",
	    msdc50_0_hc_parents, 0x060, 0x064, 0x068, 0, 2, 7, 0x4, 20),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_MSDC0P_AESSEL, "msdc0p_aessel",
	...
	/* CLK_CFG_6 */
	MUX_GATE_CLR_SET_UPD(CLK_TOP_AUDIO_26MSEL, "audio_26msel",
	    audio_26msel_parents, 0x070, 0x074, 0x078, 0, 1, 7, 0x4, 24),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_AUD_INTBUSSEL, "aud_intbussel",
	    aud_intbussel_parents, 0x070, 0x074, 0x078, 8, 3, 15, 0x4, 25),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_APLL_SEL, "apll_sel",
	...
	MUX_GATE_CLR_SET_UPD(CLK_TOP_APLL6_SEL, "apll6_sel",
	    apll6_parents, 0x080, 0x084, 0x088, 24, 3, 31, 0x8, 0),
	/* CLK_CFG_8 */
	MUX_GATE_CLR_SET_UPD(CLK_TOP_A1SYSHP_SEL, "a1syshp_sel",
	    a1syshp_parents, 0x090, 0x094, 0x098, 0, 3, 7, 0x8, 1),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_A2SYSHP_SEL, "a2syshp_sel",
	    a2syshp_parents, 0x090, 0x094, 0x098, 8, 3, 15, 0x8, 2),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_A3SYSHP_SEL, "a3syshp_sel",
	    a3syshp_parents, 0x090, 0x094, 0x098, 16, 5, 23, 0x8, 3),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_A4SYSHP_SEL, "a4syshp_sel",
	    a4syshp_parents, 0x090, 0x094, 0x098, 24, 5, 31, 0x8, 4),
	/* CLK_CFG_9 */
	MUX_GATE_CLR_SET_UPD(CLK_TOP_ASML_SEL, "asml_sel",
	    asml_parents, 0x0a0, 0x0a4, 0x0a8, 0, 2, 7, 0x8, 5),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_ASMM_SEL, "asmm_sel",
	    asml_parents, 0x0a0, 0x0a4, 0x0a8, 8, 2, 15, 0x8, 6),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_ASMH_SEL, "asmh_sel",
	...
	MUX_GATE_CLR_SET_UPD_FLAGS(CLK_TOP_RV33_SEL, "rv33_sel",
	    ...
	    CLK_IS_CRITICAL),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_STC_TOP_27MSEL, "stc_top_27msel",
	    stc_top_27msel_parents, 0x0c0, 0x0c4, 0x0c8, 8, 2, 15, 0x8, 14),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_OSD_SEL, "osd_sel",
	    osd_parents, 0x0c0, 0x0c4, 0x0c8, 16, 4, 23, 0x8, 15),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_VDO3_SEL, "vdo3_sel",
	    vdo3_parents, 0x0c0, 0x0c4, 0x0c8, 24, 4, 31, 0x8, 16),
	/* CLK_CFG_12 */
	MUX_GATE_CLR_SET_UPD(CLK_TOP_VDO4_SEL, "vdo4_sel",
	    vdo4_parents, 0x0d0, 0x0d4, 0x0d8, 0, 3, 7, 0x8, 17),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_HD_SEL, "hd_sel",
	    hd_parents, 0x0d0, 0x0d4, 0x0d8, 8, 2, 15, 0x8, 18),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_NR_SEL, "nr_sel",
	    nr_parents, 0x0d0, 0x0d4, 0x0d8, 16, 3, 23, 0x8, 19),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_PE2_MAC_P0_SEL, "pe2_mac_p0_sel",
	...
	MUX_GATE_CLR_SET_UPD(CLK_TOP_HDCP_24MSEL, "hdcp_24msel",
	    hdcp_24msel_parents, 0x0e0, 0x0e4, 0x0e8, 8, 2, 15, 0x8, 22),
	MUX_GATE_CLR_SET_UPD_FLAGS(CLK_TOP_RTC_SEL, "rtc_sel",
	...
	/* CLK_CFG_14 */
	MUX_GATE_CLR_SET_UPD(CLK_TOP_ETH_250MSEL, "eth_250msel",
	    eth_250msel_parents, 0x0f0, 0x0f4, 0x0f8, 0, 2, 7, 0x8, 25),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_ETH_125MSEL, "eth_125msel",
	    eth_125msel_parents, 0x0f0, 0x0f4, 0x0f8, 8, 2, 15, 0x8, 26),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_ETH_50MRMSEL, "eth_50mrmsel",
	...
	/* CLK_CFG_15 */
	MUX_GATE_CLR_SET_UPD(CLK_TOP_PWMINFRA_SEL, "pwminfra_sel",
	...
	MUX_GATE_CLR_SET_UPD(CLK_TOP_DI_SEL, "di_sel",
	...
	MUX_GATE_CLR_SET_UPD(CLK_TOP_HD20_DACR_SEL, "hd20_dacr_sel",
	    hd20_dacr_parents, 0x110, 0x114, 0x118, 16, 2, 23, 0xC, 4),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_HD20_HDCP_SEL, "hd20_hdcp_sel",
	    hd20_hdcp_parents, 0x110, 0x114, 0x118, 24, 2, 31, 0xC, 5),
	/* CLK_CFG_17 */
	MUX_GATE_CLR_SET_UPD(CLK_TOP_HDMI_SEL, "hdmi_sel",
	...
	MUX_GATE_CLR_SET_UPD_FLAGS(CLK_TOP_CUPMSEL, "cupmsel",
...
static const struct mtk_gate infra_clks[] = {
	/* INFRA0 */
	GATE_INFRA0_FLAGS(CLK_INFRA_DBGCLK, "infra_dbgclk", "axi_sel", 0,
					CLK_IS_CRITICAL),
...
#define PLL_B(_id, _name, _reg, _pwr_reg, _en_mask, _flags, \
		...
		_pcw_chg_shift, _en_reg, _pll_en_bit, _div_table) {		\
		.id = _id,						\
		.name = _name,						\
		.reg = _reg,						\
		.pwr_reg = _pwr_reg,					\
...
static const struct mtk_pll_data plls[] = {
	...
	PLL(CLK_APMIXED_VDECPLL, "vdecpll", 0x0190, 0x019C, 0x00000001,
		0, 0, 32, 8, 0x0190, 4, 0, 0, 0, 0x0194, 0, 0x0190, 31, 0, 0),
	PLL(CLK_APMIXED_ETHERPLL, "etherpll", 0x0180, 0x018C, 0x00000001,
		0, 0, 32, 8, 0x0180, 4, 0, 0, 0, 0x0184, 0, 0x0180, 31, 0, 0),
	PLL(CLK_APMIXED_OSDPLL, "osdpll", 0x0200, 0x020C, 0x00000001,
		0, 0, 32, 8, 0x0200, 4, 0, 0, 0, 0x0204, 0, 0x0200, 31, 0, 0),
	...
	PLL(CLK_APMIXED_MSDCPLL, "msdcpll", 0x0150, 0x015C, 0x00000001,
		0, 0, 32, 8, 0x0150, 4, 0, 0, 0, 0x0154, 0, 0x0150, 31, 0, 0),
	PLL(CLK_APMIXED_TVDPLL, "tvdpll", 0x0170, 0x017C, 0x00000001,
		0, 0, 32, 8, 0x0170, 4, 0, 0, 0, 0x0174, 0, 0x0170, 31, 0, 0),
	...
	PLL_B(CLK_APMIXED_ARMPLL, "armpll", 0x0110, 0x011C, 0x00000001,
		...
		0, 0, armpll_div_table),
	PLL(CLK_APMIXED_CCIPLL, "ccipll", 0x02A0, 0x02AC, 0x00000001,
		0, 0, 32, 8, 0x02A0, 4, 0, 0, 0, 0x2A4, 0, 0x02A0, 31, 0, 0),
};
