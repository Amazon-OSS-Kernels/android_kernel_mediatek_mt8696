...
struct cmdq_sec_mtee_context {
	...
	struct KREE_SHAREDMEM_PARAM wsm_param;
	KREE_SHAREDMEM_HANDLE wsm_ex_handle;
	struct KREE_SHAREDMEM_PARAM wsm_ex_param;
	KREE_SHAREDMEM_HANDLE wsm_ex2_handle;
	struct KREE_SHAREDMEM_PARAM wsm_ex2_param;
	KREE_SHAREDMEM_HANDLE mem_handle;
	struct KREE_SHAREDMEM_PARAM mem_param;
#if 0
