...
#define CMDQ_THREAD_SEC_SUB_DISP	(CMDQ_MIN_SECURE_THREAD_ID + 2)
#define CMDQ_THREAD_SEC_MDP_0		(CMDQ_MIN_SECURE_THREAD_ID + 3)
#define CMDQ_THREAD_SEC_MDP_1		(CMDQ_MIN_SECURE_THREAD_ID + 4)
