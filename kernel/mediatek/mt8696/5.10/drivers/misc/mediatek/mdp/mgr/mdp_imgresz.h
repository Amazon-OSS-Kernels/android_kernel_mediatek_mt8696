...
bool mdp_imgresz_is_hardware_ready(
	enum imgresz_ticket_fun_type function_type, IMGRESZ_TICKET *pTicket);
 ...
 */
int mdp_imgresz_hw_done_callback(IMGRESZ_TICKET ticket,
 ...
 * else if have normal task,
 * test normal hardware available ? dispatch normal ticket : wait
 ...
 */
enum MDP_TASK_STATUS mdp_imgresz_release_hw(
	struct mdp_task_struct *pTask);
