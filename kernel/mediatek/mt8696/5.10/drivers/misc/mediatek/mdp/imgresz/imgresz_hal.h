...
/*((tgW+8)*hfactor/0x40000)*/
#define IMG_VdoPart_GetSrcW(tgW, hfactor)  ((((tgW)+8)*hfactor/0x40000)+32)
#define IMG_VdoPart_GetSrcPoint(tgPoint, hfactor) ((tgPoint)*hfactor/0x40000-3)

extern int imgresz_log_level;

extern void imgresz_writel_relaxed(u32 value, void __iomem *addr);
extern void imgresz_writel(u32 value, void __iomem *addr);
extern u32 imgresz_readl_relaxed(void __iomem *addr);
...
void imgresz_hal_set_src_rm_rpr(void __iomem *base, bool rpr_mode,
	bool rpr_racing);
void imgresz_hal_set_src_first_row(void __iomem *base,
	bool firstrow);
void imgresz_hal_set_src_last_row(void __iomem *base,
	bool lastrow);
void imgresz_hal_set_vdo_cbcr_swap(void __iomem *base,
	bool cbcr_swap);
...
void imgresz_hal_coeff_h8tap_vdo_partition_offset
	(void __iomem *base,
...
void imgresz_hal_set_src_pic_wid_hei_vdo_partition
	(void __iomem *base,
		unsigned int y_width, unsigned int c_width,
		unsigned int height);
void imgresz_hal_coeff_set_rpr_H_factor
	(void __iomem *base, uint32_t src_width, uint32_t dst_width);
void imgresz_hal_coeff_set_rpr_V_factor
	(void __iomem *base, uint32_t src_height, uint32_t dst_height);
...
/* UFO hal interfaces. */
void imgresz_ufo_partition_set_start_point
		(void __iomem *base, unsigned int x, unsigned int y);
...
void imgresz_ufo_src_buf(void __iomem *base,
	void __iomem *base_sec, uint32_t y_addr, uint32_t c_addr);
void imgresz_ufo_srclen_buf(void __iomem *base,
	void __iomem *base_sec, uint32_t y_len_addr, uint32_t c_len_addr);
int imgresz_ufo_vdo_v_partition_offset_update(
		void __iomem *base, void __iomem *base_sec,
		uint32_t src_buf_wid, uint32_t part1_src_bgn);
void imgresz_hal_set_src_offset_vdo_partition
	(void __iomem *base, unsigned int y_h_offset, unsigned int y_v_offset,
