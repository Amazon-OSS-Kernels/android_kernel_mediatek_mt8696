...
EXPORT_SYMBOL(als_flush_report);
...
EXPORT_SYMBOL(als_register_data_path);
...
EXPORT_SYMBOL(als_register_control_path);
...
EXPORT_SYMBOL(alsps_aal_enable);
...
EXPORT_SYMBOL(alsps_aal_get_data);
/* *************************************************** */
