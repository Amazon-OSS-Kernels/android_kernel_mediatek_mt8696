...
/* HDMI21 Type def start */

enum HDMI21_TMDS_CLOCK {

	HDMI21_27M,	/* 0x0 27M */
	HDMI21_54M,	/* 0x1 54M */
	HDMI21_74_175M,	/* 0x2 74.175M */
	HDMI21_74_25M,	/* 0x3 74.25M */
	HDMI21_148_35M,	/* 0x4 148.35M */
	HDMI21_148_5M,	/* 0x5 148.5M */
	HDMI21_296_7M,	/* 0x6 296.7M */
	HDMI21_297M,	/* 0x7 297M */
...
enum HDMI21_MODE_T {
	...
	HDMI21_SOURCE_26M = 0,
	HDMI21_SOURCE_TVDPLL,
	HDMI21_REPEATER_BYPASS,
	HDMI21_REPEATER_PASSTHROUGH,
...
enum XVYCC_GAMUT_TYPE_T {
	GAMUT_TYPE_AVCHD = 0,
	GAMUT_TYPE_AVCHD_FIXED = 1,
};

enum HDMI_VIDEO_ASPECT_T {
	HDMI_4_3 = 0,
	HDMI_16_9,
};
...
struct VID_DOVI_LOWLATENCY_MD_INFO_T {
	...
	unsigned char ucDoViGameVSIFPB5;
	unsigned char ucDoViGameVSIFPB10;
	unsigned char ucDoViGameVSIFPB11;
	unsigned char ucDoViGameVSIFPB12;
	unsigned char ucDoViGameVSIFPB13;
	unsigned char ucDoViVS10signalType;
};
...
/* from audio driver see x_aud_dec.h AUD_DEC_SAMPLE_FREQ_T */
	enum AUDIO_SAMPLING_T e_dsp_fs;
...
struct HDMI_EDID_T {
	...
	unsigned int ui2_sink_colorimetry;
	...
	unsigned int ui4_hdmi_atmos_joc_ch_type;
	...
	unsigned char ui1_sink_support_mat_profile;
	...
	unsigned char u1_sink_qms_en;
	unsigned char u1_sink_qms_tfr_min;
	unsigned char u1_sink_qms_tfr_max;
...
struct CEC_SEND_MSG {
	...
	struct APK_CEC_ACK_INFO result;
};
...
#define MTK_HDMI_AUDIO_SETTING                  HDMI_IOWR(6, \
	struct HDMITX_AUDIO_PARA)
#define MTK_HDMI_FACTORY_MODE_ENABLE            HDMI_IOW(7, int)
#define MTK_HDMI_FACTORY_GET_STATUS             HDMI_IOWR(8, \
	int)
#define MTK_HDMI_WRITE_DEV                      HDMI_IOWR(9, \
	struct hdmi_device_write)
#define MTK_HDMI_READ_DEV                       HDMI_IOWR(10, \
	unsigned int)
#define MTK_HDMI_ENABLE_LOG                     HDMI_IOWR(11, \
	unsigned int)
#define MTK_HDMI_CHECK_EDID                     HDMI_IOWR(12, \
	unsigned int)
#define MTK_HDMI_INFOFRAME_SETTING              HDMI_IOWR(13, \
	struct hdmi_para_setting)
#define MTK_HDMI_COLOR_DEEP                     HDMI_IOWR(14, \
	struct hdmi_para_setting)
#define MTK_HDMI_ENABLE_HDCP                    HDMI_IOWR(15, \
	unsigned int)
#define MTK_HDMI_STATUS                         HDMI_IOWR(16, \
	unsigned int)
#define MTK_HDMI_HDCP_KEY                       HDMI_IOWR(17, \
	struct hdmi_hdcp_key)
#define MTK_HDMI_GET_EDID                       HDMI_IOWR(18, \
	struct HDMI_EDID_T)
#define MTK_HDMI_SETLA                          HDMI_IOWR(19, \
	struct CEC_DRV_ADDR_CFG)
#define MTK_HDMI_GET_CECCMD                     HDMI_IOWR(20, \
	struct CEC_FRAME_DESCRIPTION_IO)
#define MTK_HDMI_SET_CECCMD                     HDMI_IOWR(21, \
	struct CEC_SEND_MSG)
#define MTK_HDMI_CEC_ENABLE                     HDMI_IOWR(22, unsigned int)
#define MTK_HDMI_GET_CECADDR                    HDMI_IOWR(23, \
	struct CEC_ADDRESS_IO)
#define MTK_HDMI_CECRX_MODE                     HDMI_IOWR(24, \
	unsigned int)
#define MTK_HDMI_SENDSLTDATA                    HDMI_IOWR(25, \
	struct send_slt_data)
#define MTK_HDMI_GET_SLTDATA                    HDMI_IOWR(27, \
	struct CEC_SLT_DATA)
#define MTK_HDMI_VIDEO_MUTE                     HDMI_IOWR(28, int)
#define MTK_HDMI_GET_CECSTS                     HDMI_IOWR(29, \
	struct APK_CEC_ACK_INFO)
#define MTK_HDMI_CEC_USR_CMD                    HDMI_IOWR(30, \
	struct CEC_USR_CMD_T)
#define MTK_HDMI_HDCP_INFO                      HDMI_IOWR(31, \
	struct HDCP_INFO)
#define MTK_HDMI_HDR_ENABLE                     HDMI_IOWR(32, \
	enum HDMI_FORCE_HDR_ENABLE)
...
#define MTK_HDMI_FACTORY_DPI_STOP_AND_POWER_OFF HDMI_IOWR(42, int)
#define MTK_HDMI_VRR_ENABLE HDMI_IOWR(43, unsigned int)
#define MTK_HDMI_ARC_ENABLE                     HDMI_IOWR(44, unsigned int)
#define MTK_HDMI_LOW_LATENCY_MODE               HDMI_IOWR(45, unsigned int)
#define MTK_HDMI_EARLY_SUSPEND_MODE             HDMI_IOWR(46, unsigned int)


#define fgIsHDRes(u1Res) (( \
	u1Res == HDMI_VIDEO_1280x720p_60Hz) || \
	(u1Res == HDMI_VIDEO_1280x720p_50Hz) || \
	(u1Res == HDMI_VIDEO_1920x1080i_60Hz) || \
	(u1Res == HDMI_VIDEO_1920x1080i_50Hz) || \
	(u1Res == HDMI_VIDEO_1920x1080p_30Hz) || \
	(u1Res == HDMI_VIDEO_1920x1080p_25Hz) || \
	(u1Res == HDMI_VIDEO_1920x1080p_24Hz) || \
	(u1Res == HDMI_VIDEO_1920x1080p_23Hz) || \
	(u1Res == HDMI_VIDEO_1920x1080p_29Hz) || \
	(u1Res == HDMI_VIDEO_1920x1080p_60Hz) || \
	(u1Res == HDMI_VIDEO_1920x1080p_50Hz) || \
	(u1Res == HDMI_VIDEO_1280x720p3d_60Hz) ||\
	(u1Res == HDMI_VIDEO_1280x720p3d_50Hz) || \
	(u1Res == HDMI_VIDEO_1920x1080i3d_60Hz) || \
	(u1Res == HDMI_VIDEO_1920x1080i3d_50Hz) || \
	(u1Res == HDMI_VIDEO_1920x1080p3d_24Hz) || \
	(u1Res == HDMI_VIDEO_1920x1080p3d_23Hz) || \
	(u1Res == HDMI_VIDEO_3840x2160P_23_976HZ) || \
	(u1Res == HDMI_VIDEO_3840x2160P_24HZ) || \
	(u1Res == HDMI_VIDEO_3840x2160P_25HZ) ||\
	(u1Res == HDMI_VIDEO_3840x2160P_29_97HZ) || \
	(u1Res == HDMI_VIDEO_3840x2160P_30HZ) || \
	(u1Res == HDMI_VIDEO_4096x2160P_24HZ) || \
	(u1Res == HDMI_VIDEO_3840x2160P_60HZ) || \
	(u1Res == HDMI_VIDEO_3840x2160P_50HZ) || \
	(u1Res == HDMI_VIDEO_4096x2160P_60HZ) ||\
	(u1Res == HDMI_VIDEO_4096x2160P_50HZ) || \
	(u1Res == HDMI_VIDEO_1280x720p_59_94Hz) ||\
	(u1Res == HDMI_VIDEO_1920x1080p_59_94Hz) || \
	(u1Res == HDMI_VIDEO_3840x2160P_59_94HZ) ||\
	(u1Res == HDMI_VIDEO_4096x2160P_59_94HZ))

#define  fgVideoIsNtsc(ucFmt)  (( \
	ucFmt == HDMI_VIDEO_720x480i_60Hz) || \
	(ucFmt == HDMI_VIDEO_720x480p_60Hz) ||\
	(ucFmt == HDMI_VIDEO_1280x720p_60Hz) || \
	(ucFmt == HDMI_VIDEO_1920x1080i_60Hz) || \
	(ucFmt == HDMI_VIDEO_1920x1080p_30Hz) || \
	(ucFmt == HDMI_VIDEO_1920x1080p_24Hz) || \
	(ucFmt == HDMI_VIDEO_1920x1080p_23Hz) || \
	(ucFmt == HDMI_VIDEO_1920x1080p_29Hz) ||\
(ucFmt == HDMI_VIDEO_1920x1080p_60Hz) || /*(ucFmt == RES_1080P30HZ)||*/\
	(ucFmt == HDMI_VIDEO_1280x720p3d_60Hz) || \
	(ucFmt == HDMI_VIDEO_1920x1080i3d_60Hz) || \
	(ucFmt == HDMI_VIDEO_1920x1080p3d_24Hz) || \
	(ucFmt == HDMI_VIDEO_1920x1080p3d_23Hz) || \
	(ucFmt == HDMI_VIDEO_3840x2160P_23_976HZ) || \
	(ucFmt == HDMI_VIDEO_3840x2160P_24HZ) || \
	(ucFmt == HDMI_VIDEO_3840x2160P_29_97HZ) || \
	(ucFmt == HDMI_VIDEO_3840x2160P_30HZ) || \
	(ucFmt == HDMI_VIDEO_4096x2160P_24HZ) || \
	(ucFmt == HDMI_VIDEO_3840x2160P_60HZ) || \
	(ucFmt == HDMI_VIDEO_4096x2160P_60HZ) || \
	(ucFmt == HDMI_VIDEO_1280x720p_59_94Hz) ||\
	(ucFmt == HDMI_VIDEO_1920x1080p_59_94Hz) || \
	(ucFmt == HDMI_VIDEO_3840x2160P_59_94HZ) ||\
	(ucFmt == HDMI_VIDEO_4096x2160P_59_94HZ))

#define fgFMTis4k2k(ucFmt) ((  \
ucFmt == HDMI_VIDEO_3840x2160P_23_976HZ) ||  \
(ucFmt == HDMI_VIDEO_3840x2160P_24HZ) || \
	(ucFmt == HDMI_VIDEO_3840x2160P_25HZ) ||  \
	(ucFmt == HDMI_VIDEO_3840x2160P_29_97HZ) || \
	(ucFmt == HDMI_VIDEO_3840x2160P_30HZ) ||  \
	(ucFmt == HDMI_VIDEO_4096x2160P_24HZ) || \
	(ucFmt == HDMI_VIDEO_3840x2160P_60HZ) || \
	(ucFmt == HDMI_VIDEO_3840x2160P_50HZ) || \
	(ucFmt == HDMI_VIDEO_4096x2160P_60HZ) || \
	(ucFmt == HDMI_VIDEO_4096x2160P_50HZ) || \
	(ucFmt == HDMI_VIDEO_3840x2160P_59_94HZ) || \
	(ucFmt == HDMI_VIDEO_4096x2160P_59_94HZ))

#define fgFMTis4k2k_6G(ucFmt) ((   \
ucFmt == HDMI_VIDEO_3840x2160P_60HZ) || \
(ucFmt == HDMI_VIDEO_3840x2160P_50HZ) || \
	(ucFmt == HDMI_VIDEO_4096x2160P_60HZ) ||  \
	(ucFmt == HDMI_VIDEO_4096x2160P_50HZ) || \
...
struct COMPAT_HDMI_EDID_T {
	...
	compat_uint_t ui4_pal_resolution;	/* use EDID_VIDEO_RES_T */
	...
	compat_uint_t ui4_hdmi_ac3_ch_type;
	/* use AVD_AC3_CH_TYPE1 */
	compat_uint_t ui4_hdmi_ac3_ch3ch4ch5ch7_type;
	compat_uint_t ui4_hdmi_ec3_ch_type;
	/* AVD_DOLBY_PLUS_CH_TYPE1 */
	compat_uint_t ui4_hdmi_ec3_ch3ch4ch5ch7_type;
	...
	unsigned short ui2_sink_ID_manufacturer_name;/* (08H~09H) */
	unsigned short ui2_sink_ID_product_code;	/* (0aH~0bH) */
	compat_uint_t ui4_sink_ID_serial_number;	/* (0cH~0fH) */
	unsigned char ui1_sink_week_of_manufacture;	/* (10H) */
	/* (11H)  base on year 1990 */
	unsigned char ui1_sink_year_of_manufacture;
	unsigned char b_sink_SCDC_present;
...
struct COMPAT_CEC_SEND_MSG {
	unsigned int pv_tag;
	struct CEC_FRAME_INFO t_frame_info;
	unsigned char b_enqueue_ok;
};

struct COMPAT_CEC_HEADER_BLOCK_IO {
	unsigned char destination:4;
	unsigned char initiator:4;
};

struct COMPAT_CEC_FRAME_BLOCK_IO {
	struct COMPAT_CEC_HEADER_BLOCK_IO header;
	unsigned char opcode;
	unsigned char operand[15];
};

struct COMPAT_CEC_FRAME_DESCRIPTION_IO {
	unsigned char size;
	unsigned char sendidx;
	unsigned char reTXcnt;
	unsigned int txtag;
	struct COMPAT_CEC_FRAME_BLOCK_IO blocks;
};


/* ACK info */
struct COMPAT_APK_CEC_ACK_INFO {
	unsigned int pv_tag;
	compat_uint_t e_ack_cond;
};

struct compat_hdmi_hdcp_drmkey {
	unsigned char u1Hdcpkey[HDCPKEY_LENGTH_DRM];
};

struct compat_hdmi_hdcp_key {
	unsigned char u1Hdcpkey[287];
};

struct compat_hdmi_para_setting {
	compat_uint_t u4Data1;
	compat_uint_t u4Data2;
};

enum compat_hdmi_force_hdr_enable {
...
#define COMPAT_MTK_HDMI_AUDIO_SETTING         HDMI_IOWR(6,  \
	struct HDMITX_AUDIO_PARA)
#define COMPAT_MTK_HDMI_FACTORY_MODE_ENABLE   HDMI_IOW(7,   \
	int)
#define COMPAT_MTK_HDMI_FACTORY_GET_STATUS    HDMI_IOWR(8,  \
	int)
#define COMPAT_MTK_HDMI_WRITE_DEV             HDMI_IOWR(9,  \
	struct hdmi_device_write)
...
#define COMPAT_MTK_HDMI_INFOFRAME_SETTING   HDMI_IOWR(13,   \
	struct hdmi_para_setting)
#define COMPAT_MTK_HDMI_COLOR_DEEP     HDMI_IOWR(14, struct hdmi_para_setting)
#define COMPAT_MTK_HDMI_ENABLE_HDCP    HDMI_IOWR(15, unsigned int)
#define COMPAT_MTK_HDMI_STATUS         HDMI_IOWR(16, unsigned int)
#define COMPAT_MTK_HDMI_HDCP_KEY       HDMI_IOWR(17, struct hdmi_hdcp_key)
#define COMPAT_MTK_HDMI_GET_EDID       HDMI_IOWR(18, struct HDMI_EDID_T)
#define COMPAT_MTK_HDMI_SETLA          HDMI_IOWR(19, struct CEC_DRV_ADDR_CFG)
#define COMPAT_MTK_HDMI_GET_CECCMD     HDMI_IOWR(20,  \
	struct COMPAT_CEC_FRAME_DESCRIPTION_IO)
#define COMPAT_MTK_HDMI_SET_CECCMD     HDMI_IOWR(21,  \
	struct COMPAT_CEC_SEND_MSG)
#define COMPAT_MTK_HDMI_CEC_ENABLE     HDMI_IOWR(22, unsigned int)
#define COMPAT_MTK_HDMI_GET_CECADDR    HDMI_IOWR(23, struct CEC_ADDRESS_IO)
#define COMPAT_MTK_HDMI_CECRX_MODE     HDMI_IOWR(24, unsigned int)
#define COMPAT_MTK_HDMI_SENDSLTDATA    HDMI_IOWR(25, struct send_slt_data)
#define COMPAT_MTK_HDMI_GET_SLTDATA    HDMI_IOWR(27, struct CEC_SLT_DATA)
#define COMPAT_MTK_HDMI_VIDEO_MUTE     HDMI_IOWR(28, int)
#define COMPAT_MTK_HDMI_GET_CECSTS     HDMI_IOWR(29,  \
	struct COMPAT_APK_CEC_ACK_INFO)
#define COMPAT_MTK_HDMI_CEC_USR_CMD    HDMI_IOWR(30, struct CEC_USR_CMD_T)
#define COMPAT_MTK_HDMI_HDR_ENABLE     HDMI_IOWR(32, enum HDMI_FORCE_HDR_ENABLE)
#define COMPAT_MTK_HDMI_VRR_ENABLE     HDMI_IOWR(43, unsigned int)
#define COMPAT_MTK_HDMI_ARC_ENABLE     HDMI_IOWR(44, unsigned int)
#define COMPAT_MTK_HDMI_LOW_LATENCY_MODE    HDMI_IOWR(45, unsigned int)
