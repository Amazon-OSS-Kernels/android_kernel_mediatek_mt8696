...
#define RG_HDMITX21_PRE_CROSS_POINT_D0_DP_SEL (0x1 << 31)
#define RG_HDMITX21_PRE_CROSS_POINT_D1_DP_SEL (0x1 << 30)
#define RG_HDMITX21_PRE_CROSS_POINT_D2_DP_SEL (0x1 << 29)
#define RG_HDMITX21_PRE_CROSS_POINT_CK_DP_SEL (0x1 << 28)
#define RG_HDMITX21_PRE_CROSS_POINT_D0_FFE1_SEL (0x1 << 27)
#define RG_HDMITX21_PRE_CROSS_POINT_D1_FFE1_SEL (0x1 << 26)
#define RG_HDMITX21_PRE_CROSS_POINT_D2_FFE1_SEL (0x1 << 25)
#define RG_HDMITX21_PRE_CROSS_POINT_CK_FFE1_SEL (0x1 << 24)
#define RG_HDMITX21_PRE_CROSS_POINT_D0_FFE2_SEL (0x1 << 23)
#define RG_HDMITX21_PRE_CROSS_POINT_D1_FFE2_SEL (0x1 << 22)
#define RG_HDMITX21_PRE_CROSS_POINT_D2_FFE2_SEL (0x1 << 21)
#define RG_HDMITX21_PRE_CROSS_POINT_CK_FFE2_SEL (0x1 << 20)
#define RG_HDMITX21_BIAS_PI_OD1P25 (0x1 << 19)
#define RG_HDMITX21_BIAS_PI_OD1P125 (0x1 << 18)
#define RG_HDMITX21_SLDO_VREF_SEL (0x3 << 16)
#define RG_HDMITX21_POSDIV_DIV3_CTRL (0x1 << 15)
#define RG_HDMITXPLL_REF_CK_SEL	(0x1 << 3)
#define RG_HDMITXCLKSQ_EN	(0x1 << 2)
#define RG_HDMITXCLKSQ_HYS_EN	(0x1 << 1)
#define RG_HDMITXCLKSQ_LPFEN	(0x1 << 0)

#define RG_HDMITX21_PRE_CROSS_POINT_D0_DP_SEL_SHIFT (31)
#define RG_HDMITX21_PRE_CROSS_POINT_D1_DP_SEL_SHIFT (30)
#define RG_HDMITX21_PRE_CROSS_POINT_D2_DP_SEL_SHIFT (29)
#define RG_HDMITX21_PRE_CROSS_POINT_CK_DP_SEL_SHIFT (28)
#define RG_HDMITX21_PRE_CROSS_POINT_D0_FFE1_SEL_SHIFT (27)
#define RG_HDMITX21_PRE_CROSS_POINT_D1_FFE1_SEL_SHIFT (26)
#define RG_HDMITX21_PRE_CROSS_POINT_D2_FFE1_SEL_SHIFT (25)
#define RG_HDMITX21_PRE_CROSS_POINT_CK_FFE1_SEL_SHIFT (24)
#define RG_HDMITX21_PRE_CROSS_POINT_D0_FFE2_SEL_SHIFT (23)
#define RG_HDMITX21_PRE_CROSS_POINT_D1_FFE2_SEL_SHIFT (22)
#define RG_HDMITX21_PRE_CROSS_POINT_D2_FFE2_SEL_SHIFT (21)
#define RG_HDMITX21_PRE_CROSS_POINT_CK_FFE2_SEL_SHIFT (20)
#define RG_HDMITX21_BIAS_PI_OD1P25_SHIFT (19)
#define RG_HDMITX21_BIAS_PI_OD1P125_SHIFT (18)
#define RG_HDMITX21_SLDO_VREF_SEL_SHIFT (16)
#define RG_HDMITX21_POSDIV_DIV3_CTRL_SHIFT (15)
#define RG_HDMITXPLL_REF_CK_SEL_SHIFT	(3)
#define RG_HDMITXCLKSQ_EN_SHIFT	(2)
#define RG_HDMITXCLKSQ_HYS_EN_SHIFT	(1)
#define RG_HDMITXCLKSQ_LPFEN_SHIFT	(0)
...
#define RG_HDMITX21_BG_PWD (0x1 << 31)
#define RG_HDMITX21_BG_MONEN (0x1 << 30)
#define RG_HDMITX21_BG_CKEN (0x1 << 29)
#define RG_HDMITX21_BG_LPF_EN (0x1 << 28)
#define RG_HDMITX21_BIAS_PE_BG_VREF_SEL (0x3 << 26)
#define RG_HDMITX21_PLL_BG_VREF_SEL (0x3 << 24)
#define RG_HDMITX21_BG_CKDIV (0x3 << 22)
#define RG_HDMITX21_BIAS_PE_VREF_SELB (0x1 << 21)
#define RG_HDMITX21_BIAS_PE_PWR_VREF_SEL (0x3 << 19)
#define RG_HDMITX21_PRE_CROSS_POINT_D0_DP_SEL1	(0x1 << 18)
#define RG_HDMITX21_PRE_CROSS_POINT_D1_DP_SEL1	(0x1 << 17)
#define RG_HDMITX21_PRE_CROSS_POINT_D2_DP_SEL1	(0x1 << 16)
#define RG_HDMITX21_PRE_CROSS_POINT_CK_DP_SEL1	(0x1 << 15)
#define RG_HDMITX21_PRE_CROSS_POINT_D0_FFE1_SEL1	(0x1 << 14)
#define RG_HDMITX21_PRE_CROSS_POINT_D1_FFE1_SEL1	(0x1 << 13)
#define RG_HDMITX21_PRE_CROSS_POINT_D2_FFE1_SEL1	(0x1 << 12)
#define RG_HDMITX21_PRE_CROSS_POINT_CK_FFE1_CKSEL1	(0x1 << 11)
#define RG_HDMITX21_PRE_CROSS_POINT_D0_FFE2_SEL1	(0x1 << 10)
#define RG_HDMITX21_PRE_CROSS_POINT_D1_FFE2_SEL1	(0x1 << 9)
#define RG_HDMITX21_PRE_CROSS_POINT_D2_FFE2_SEL1	(0x1 << 8)
#define RG_HDMITX21_PRE_CROSS_POINT_CK_FFE2_CKSEL1	(0x1 << 7)
#define RG_HDMITX21_VREF_GEN2_EN	(0x1 << 6)
#define RG_HDMITX21_VREF_GEN2_REFSEL	(0x3 << 4)
#define RG_HDMITX21_VREF_SEL	(0x1 << 3)
#define RG_HDMITX21_VREF_GEN2_0P96_SEL	(0x1 << 2)

#define RG_HDMITX21_BG_PWD_SHIFT (31)
#define RG_HDMITX21_BG_MONEN_SHIFT (30)
#define RG_HDMITX21_BG_CKEN_SHIFT (29)
#define RG_HDMITX21_BG_LPF_EN_SHIFT (28)
#define RG_HDMITX21_BIAS_PE_BG_VREF_SEL_SHIFT (26)
#define RG_HDMITX21_PLL_BG_VREF_SEL_SHIFT (24)
#define RG_HDMITX21_BG_CKDIV_SHIFT (22)
#define RG_HDMITX21_BIAS_PE_VREF_SELB_SHIFT (21)
#define RG_HDMITX21_BIAS_PE_PWR_VREF_SEL_SHIFT (19)
#define RG_HDMITX21_PRE_CROSS_POINT_D0_DP_SEL1_SHIFT	(18)
#define RG_HDMITX21_PRE_CROSS_POINT_D1_DP_SEL1_SHIFT	(17)
#define RG_HDMITX21_PRE_CROSS_POINT_D2_DP_SEL1_SHIFT	(16)
#define RG_HDMITX21_PRE_CROSS_POINT_CK_DP_SEL1_SHIFT	(15)
#define RG_HDMITX21_PRE_CROSS_POINT_D0_FFE1_SEL1_SHIFT	(14)
#define RG_HDMITX21_PRE_CROSS_POINT_D1_FFE1_SEL1_SHIFT	(13)
#define RG_HDMITX21_PRE_CROSS_POINT_D2_FFE1_SEL1_SHIFT	(12)
#define RG_HDMITX21_PRE_CROSS_POINT_CK_FFE1_CKSEL1_SHIFT	(11)
#define RG_HDMITX21_PRE_CROSS_POINT_D0_FFE2_SEL1_SHIFT	(10)
#define RG_HDMITX21_PRE_CROSS_POINT_D1_FFE2_SEL1_SHIFT	(9)
#define RG_HDMITX21_PRE_CROSS_POINT_D2_FFE2_SEL1_SHIFT	(8)
#define RG_HDMITX21_PRE_CROSS_POINT_CK_FFE2_CKSEL1_SHIFT	(7)
#define RG_HDMITX21_VREF_GEN2_EN_SHIFT	(6)
#define RG_HDMITX21_VREF_GEN2_REFSEL_SHIFT	(4)
#define RG_HDMITX21_VREF_SEL_SHIFT	(3)
#define RG_HDMITX21_VREF_GEN2_0P96_SEL_SHIFT	(2)
...
#define RG_EARCRX_PWM_CDR_TOBDET_EN (0x1 << 30)
...
#define RG_EARCRX_PWM_CDR_TOBDET_EN_SHIFT (30)
...
#define RG_EARCRXPLL_GLIT_CHFREE_EN (0x1 << 8)
...
#define RG_EARCRXPLL_GLIT_CHFREE_EN_SHIFT (8)
...
#define RG_EARCRXPLL_SDM_PWR_ON (0x1 << 3)
#define RG_EARCRXPLL_SDM_ISO_EN (0x1 << 2)
#define RG_EARCRXPLL_ARC_EN (0x1 << 1)
#define RG_EARCRXPLL_SDM_PCW_CHG (0x1 << 0)
...
#define RG_EARCRXPLL_ARC_EN_SHIFT (1)
#define RG_EARCRXPLL_SDM_PCW_CHG_SHIFT (0)

#define HDMI_1_READ_PLL	0x68

#define RGS_HDMITXPLL_VCOCAL_CRLT	(0x1 << 31)
#define RGS_HDMITXPLL_VCOCAL_STATE	(0xff << 23)
#define RGS_PWM_CDR_TOBDET_FLAG	(0x1 << 15)
#define AD_EARCRXPLL_SDM_PWR_ACK	(0x1 << 14)

#define RGS_HDMITXPLL_VCOCAL_CRLT_SHIFT (31)
#define RGS_HDMITXPLL_VCOCAL_STATE_SHIFT (23)
#define RGS_PWM_CDR_TOBDET_FLAG_SHIFT	(15)
#define AD_EARCRXPLL_SDM_PWR_ACK_SHIFT	(14)
...
#define reg_osdtvd_rx_dpclr_sel (0x1 << 22)
#define reg_osdtvd_rx_div_config (0x1f << 16)
#define reg_HDMI_CTL_3_8	(0x1 << 8)
#define reg_hdmitx_ref_xtal_sel (0x1 << 7)
#define reg_hdmitx_ref_rxck_sel (0x1 << 6)
#define reg_hdmitx_ref_tvd_osd_sel (0x1 << 5)
#define reg_osdtvd_div_config (0x1f << 0)

#define reg_osdtvd_rx_dpclr_sel_SHIFT (22)
#define reg_osdtvd_rx_div_config_SHIFT (16)
#define reg_HDMI_CTL_3_8_SHIFT	(8)
#define reg_hdmitx_ref_xtal_sel_SHIFT (7)
#define reg_hdmitx_ref_rxck_sel_SHIFT (6)
#define reg_hdmitx_ref_tvd_osd_sel_SHIFT (5)
#define reg_osdtvd_div_config_SHIFT (0)
...
#define HDMI_VRR_CFG 0x1D8
#define RG_VRR_EN (1 << 0)
...
#define HDMITX_RST	(0x1 << 31)
#define HDMITX_SWSYSRST		(0x88001 << 11)
#define rgb2hdmi_rst_en		(0x1 << 25)
...
extern struct clk *vdout_hd_sel;
extern struct clk *vdout_sd_sel;
...
extern struct delayed_work hdr10p_delay_work;
extern bool _fgQMSEnable;
extern unsigned char qms_tfr;
...
extern unsigned int hdmi_vdout_read(unsigned short u2Reg);
...
extern int hdmi_video_config(enum HDMI_VIDEO_RESOLUTION vformat);
...
extern bool fgCaHDMIInstallHdcpKey(unsigned char *pdata,
	unsigned int u4Len);
extern bool fgCaHDMIGetAKsv(unsigned char *pdata);
extern bool fgCaHDMIGetEfuse(unsigned char *pdata);
...
#define vWriteHdmiGRLMsk(dAddr, dVal, dMsk) \
	(vWriteByteHdmiGRL((dAddr), (bReadByteHdmiGRL(dAddr) & (~(dMsk))) | \
	((dVal) & (dMsk))))
...
#define vWriteHdmiSYSMsk(dAddr, dVal, dMsk) \
	(vWriteHdmiSYS((dAddr), (dReadHdmiSYS(dAddr) & (~(dMsk))) | \
	((dVal) & (dMsk))))
...
#define vWriteHdmiTOPCKMsk(dAddr, dVal, dMsk) \
	(vWriteHdmiTOPCK((dAddr), (dReadHdmiTOPCK(dAddr) & (~(dMsk))) | \
	((dVal) & (dMsk))))
...
#define vWriteIoHdmiAnaMsk(dAddr, dVal, dMsk) \
	vWriteIoHdmiAna((dAddr), (dReadIoHdmiAna(dAddr) & (~(dMsk))) | \
	((dVal) & (dMsk)))
...
#define vWriteINFRASYSMsk(dAddr, dVal, dMsk) \
	(vWriteINFRASYS((dAddr), (dReadINFRASYS(dAddr) & (~(dMsk))) | \
	((dVal) & (dMsk))))
...
#define vWriteHdmiCECMsk(dAddr, dVal, dMsk) \
	(vWriteHdmiCEC((dAddr), (dReadHdmiCEC(dAddr) & (~(dMsk))) | \
	((dVal) & (dMsk))))
#define vWriteHdmiCECUnMsk(dAddr, dMsk)(vWriteHdmiCEC((dAddr), \
(dReadHdmiCEC(dAddr) & (~(dMsk)))))
...
#define vWriteRGB2HDMIMsk(dAddr, dVal, dMsk) \
	(vWriteRGB2HDMI((dAddr), (dReadRGB2HDMI(dAddr) & (~(dMsk))) | \
	((dVal) & (dMsk))))
...
#define vWriteP2IMsk(dAddr, dVal, dMsk) \
	(vWriteP2I((dAddr), (dReadP2I(dAddr) & (~(dMsk))) | \
	((dVal) & (dMsk))))
...
(vWriteVdout10((dAddr), (dReadVdout10(dAddr) & (~(dMsk))) | \
((dVal) & (dMsk))))
...
#define vWriteVdout15Msk(dAddr, dVal, dMsk) \
	(vWriteVdout15((dAddr), (dReadVdout15(dAddr) & (~(dMsk))) | \
	((dVal) & (dMsk))))
...
#define vWriteVdout1cMsk(dAddr, dVal, dMsk) \
	(vWriteVdout1c((dAddr), (dReadVdout1c(dAddr) & (~(dMsk))) | \
	((dVal) & (dMsk))))
...
#define PORT_EDGE_RECORD_CNT 8
extern unsigned int port_edge_cnt[PORT_EDGE_RECORD_CNT];

#define PORT_IRQ_CNT 4
extern unsigned int port_irq_value[PORT_IRQ_CNT];
extern unsigned int port_status_value[PORT_IRQ_CNT];
extern unsigned char port_status;

#define HDMI_LOW_LATENCY_MODE_AUTO 0
#define HDMI_LOW_LATENCY_MODE_DIS 1
#define HDMI_LOW_LATENCY_MODE_EN 2
extern bool _fgAllmEnable;
extern bool _fg14GameModeEnable;
extern unsigned int low_latency_io_mode;
extern bool low_latency_disp_en;

extern bool _fgVoutInVsync;
...
extern int force_video_config(enum HDMI_VIDEO_RESOLUTION vformat);
extern int force_audio_config(void);
extern int pmx_parameter(enum HDMI_VIDEO_RESOLUTION vformat, int temp);
...
extern void hdmi_resstatus(void);
extern unsigned char bCheckPordHotPlug(unsigned char bMode);
extern unsigned char bCheckPortStatus(unsigned char bMode);
...
extern void vSetHdmiI2SChNum(unsigned char bChNum,
...
extern void vHalSendVendorSpecificInfoFrame(
...
extern void hdmi_hdcp_information(struct HDCP_INFO *hdcp_information);
...
extern void vHalSendAudioInfoFrame(unsigned char bData1,
...
extern void vSendHFVendorSpecificInfoFrame(void);

extern void vSetHDMITxPLL(unsigned int bResIndex,
...
extern enum VID_PLA_DR_TYPE_T hdr_status(char *str);
...
extern void hdmi_480p_pattern(void);
extern void hdmi_1080p_pattern(void);
extern void DoviVsifVerCtrl(unsigned int ver);
void vQMSCB(bool en);
extern void mtk_hdmi_audio_extcon_state(bool state);
void Hdr10pVsifPacketHandler(struct work_struct *work);
#endif
