...
bool _fgDuringDolbyOff = FALSE;
bool _fgVoutInVsync = FALSE;
bool _fgLowLatencyDolbyVisionEnable;
bool _fgQMSEnable;
unsigned char qms_tfr;
bool _fgVrrEnable;
bool _fgMConstEnable;
bool _fgAllmEnable;
...
struct HDMI_AV_INFO_T *_prAvdAVInfo = &_stAvdAVInfo;
...
#define HDMI_RES_STR(x)  (                            \
	(x) == HDMI_VIDEO_720x480i_60Hz  ? "RES_480I" : \
	(x) == HDMI_VIDEO_720x576i_50Hz  ? "RES_576I" : \
	(x) == HDMI_VIDEO_720x480p_60Hz  ? "RES_480P" : \
	(x) == HDMI_VIDEO_720x576p_50Hz  ? "RES_576P" : \
	(x) == HDMI_VIDEO_1280x720p_60Hz  ? "RES_720P60HZ" : \
	(x) == HDMI_VIDEO_1280x720p_50Hz  ? "RES_720P50HZ" : \
	(x) == HDMI_VIDEO_1920x1080i_60Hz  ? "RES_1080I60HZ" : \
	(x) == HDMI_VIDEO_1920x1080i_50Hz  ? "RES_1080I50HZ" : \
	(x) == HDMI_VIDEO_1920x1080p_30Hz  ? "RES_1080P30HZ" : \
	(x) == HDMI_VIDEO_1920x1080p_25Hz  ? "RES_1080P25HZ" : \
	(x) == HDMI_VIDEO_1920x1080p_24Hz  ? "RES_1080P24HZ" : \
	(x) == HDMI_VIDEO_1920x1080p_23Hz  ? "RES_1080P23_976HZ" : \
	(x) == HDMI_VIDEO_1920x1080p_29Hz  ? "RES_1080P29_97HZ" : \
	(x) == HDMI_VIDEO_1920x1080p_60Hz  ? "RES_1080P60HZ" : \
	(x) == HDMI_VIDEO_1920x1080p_50Hz  ? "RES_1080P50HZ" : \
	(x) == HDMI_VIDEO_1280x720p3d_60Hz  ? "RES_720p3d60Hz" : \
	(x) == HDMI_VIDEO_1280x720p3d_50Hz  ? "RES_720p3d50Hz" : \
	(x) == HDMI_VIDEO_1920x1080i3d_60Hz  ? "RES_1080i3d60Hz" : \
	(x) == HDMI_VIDEO_1920x1080i3d_50Hz  ? "RES_1080i3d50Hz" : \
	(x) == HDMI_VIDEO_1920x1080p3d_24Hz  ? "RES_1080P3d24Hz" : \
	(x) == HDMI_VIDEO_1920x1080p3d_23Hz  ? "RES_1080P3d23Hz" : \
	(x) == HDMI_VIDEO_3840x2160P_23_976HZ  ? "RES_2160P_23_976HZ" : \
	(x) == HDMI_VIDEO_3840x2160P_24HZ  ? "RES_2160P_24HZ" : \
	(x) == HDMI_VIDEO_3840x2160P_25HZ  ? "RES_2160P_25HZ" : \
	(x) == HDMI_VIDEO_3840x2160P_29_97HZ  ? "RES_2160P_29_97HZ" : \
	(x) == HDMI_VIDEO_3840x2160P_30HZ  ? "RES_2160P_30HZ" : \
	(x) == HDMI_VIDEO_4096x2160P_24HZ  ? "RES_2161P_24HZ" : \
	(x) == HDMI_VIDEO_3840x2160P_60HZ  ? "RES_2160P_60HZ" : \
	(x) == HDMI_VIDEO_3840x2160P_50HZ  ? "RES_2160P_50HZ" : \
	(x) == HDMI_VIDEO_4096x2160P_60HZ  ? "RES_2161P_60HZ" : \
	(x) == HDMI_VIDEO_4096x2160P_50HZ  ? "RES_2161P_50HZ" : \
	(x) == HDMI_VIDEO_1280x720p_59_94Hz  ? "RES_720P_59_94HZ" : \
	(x) == HDMI_VIDEO_1920x1080p_59_94Hz  ? "RES_1080P_59_94HZ" : \
	(x) == HDMI_VIDEO_3840x2160P_59_94HZ  ? "RES_2160P_59_94HZ" : \
	(x) == HDMI_VIDEO_4096x2160P_59_94HZ  ? "RES_2161P_59_94HZ" : \
											 "unknown")

#define HDMI_DEEP_COLOR_STR(x)  (                   \
	(x) == HDMI_DEEP_COLOR_AUTO  ? "HDMI_DEEP_COLOR_AUTO" : \
	(x) == HDMI_NO_DEEP_COLOR  ? "HDMI_DEEP_COLOR_8_BIT" : \
	(x) == HDMI_DEEP_COLOR_10_BIT  ? "HDMI_DEEP_COLOR_10_BIT" : \
	(x) == HDMI_DEEP_COLOR_12_BIT  ? "HDMI_DEEP_COLOR_12_BIT" : \
	(x) == HDMI_DEEP_COLOR_16_BIT  ? "HDMI_DEEP_COLOR_16_BIT" : \
								 "unknown")

#define HDMI_COLOR_SPACE_STR(x)  (           \
	(x) == HDMI_RGB  ? "HDMI_RGB" : \
	(x) == HDMI_RGB_FULL  ? "HDMI_RGB_FULL" : \
	(x) == HDMI_YCBCR_444  ? "HDMI_YCBCR_444" : \
	(x) == HDMI_YCBCR_422  ? "HDMI_YCBCR_422" : \
	(x) == HDMI_XV_YCC  ? "HDMI_XV_YCC" : \
	(x) == HDMI_YCBCR_444_FULL  ? "HDMI_YCBCR_444_FULL" : \
	(x) == HDMI_YCBCR_422_FULL  ? "HDMI_YCBCR_422_FULL" : \
	(x) == HDMI_YCBCR_420_FULL  ? "HDMI_YCBCR_420_FULL" : \
								 "unknown")

#define HDMI_AUD_FS_STR(x)  (            \
	(x) == HDMI_FS_32K  ? "HDMI_FS_32K" : \
	(x) == HDMI_FS_44K  ? "HDMI_FS_44K" : \
	(x) == HDMI_FS_48K  ? "HDMI_FS_48K" : \
	(x) == HDMI_FS_88K  ? "HDMI_FS_88K" : \
	(x) == HDMI_FS_96K  ? "HDMI_FS_96K" : \
	(x) == HDMI_FS_176K  ? "HDMI_FS_176K" : \
	(x) == HDMI_FS_192K  ? "HDMI_FS_192K" : \
						 "unknown")

#define HDMI_AUD_CODING_TYPE_STR(x)  (                      \
	(x) == 0  ? "Refer to Stream Header" : \
	(x) == 1  ? "PCM" : \
	(x) == 2  ? "AC3" : \
	(x) == 3  ? "MPEG1" : \
	(x) == 4  ? "MP3" : \
...
#define AUD_CH_MAP_STR(x)  ( \
	...
	(x) == 9  ? "RR,RL,LFE,FR,FL" : \
	(x) == 10  ? "RR,RL,FC,FR,FL" : \
	(x) == 11  ? "RR,RL,FC,LFE,FR,FL" : \
	(x) == 12  ? "RC,RR,RL,FR,FL" : \
	(x) == 13  ? "RC,RR,RL,LFE,FR,FL" : \
	(x) == 14  ? "RC,RR,RL,FC,FR,FL" : \
	(x) == 15  ? "RC,RR,RL,FC,LFE,FR,FL" : \
	(x) == 16  ? "RRC,RLC,RR,RL,FR,FL" : \
	(x) == 17  ? "RRC,RLC,RR,RL,LFE,FR,FL" : \
	(x) == 18  ? "RRC,RLC,RR,RL,FC,FR,FL" : \
	(x) == 19  ? "RRC,RLC,RR,RL,FC,LFE,FR,FL" : \
	(x) == 20  ? "FRC,FLC,FR,FL" : \
	(x) == 21  ? "FRC,FLC,LFE,FR,FL" : \
	(x) == 22  ? "FRC,FLC,FC,FR,FL" : \
	(x) == 23  ? "FRC,FLC,FC,LFE,FR,FL" : \
	(x) == 24  ? "FRC,FLC,RC,FR,FL" : \
	(x) == 25  ? "FRC,FLC,RC,LFE,FR,FL" : \
	(x) == 26  ? "FRC,FLC,RC,FC,FR,FL" : \
	(x) == 27  ? "FRC,FLC,RC,FC,LFE,FR,FL" : \
	(x) == 28  ? "FRC,FLC,RR,RL,FR,FL" : \
	(x) == 29  ? "FRC,FLC,RR,RL,LFE,FR,FL" : \
	(x) == 30  ? "FRC,FLC,RR,RL,FC,FR,FL" : \
	(x) == 31  ? "FRC,FLC,RR,RL,FC,LFE,FR,FL" : \
			"unknown")

#define AUD_DMINH_STR(x)  ( \
	(x) == 0  ? "Permiited down mixed stereo or no information" : \
	(x) == 1  ? "Prohibited down mixed stereo" : \
			"unknown")

#define AUD_SAMPLE_SIZE_STR(x)  ( \
	(x) == 0  ? "Refer to Stream Header" : \
	(x) == 1  ? "16 bit" : \
	(x) == 2  ? "20 bit" : \
	(x) == 3  ? "24 bit" : \
...
#define AVI_ACTIVE_PRESENT_STR(x)  ( \
	(x) == 0  ? "No data" : \
	(x) == 1  ? "Actuve Format(R0..R3) Valid" : \
			"unknown")


#define AVI_BAR_STR(x)  ( \
	(x) == 0  ? "Bar data not valid" : \
	(x) == 1  ? "Vert. Bar info valid" : \
	(x) == 2  ? "Horiz. Bar info valid" : \
	(x) == 3  ? "Vert. and Horiz Bar info valid" : \
			"unknown")

#define AVI_SCAN_STR(x)  ( \
	(x) == 0  ? "No data" : \
	(x) == 1  ? "Overscanned display" : \
	(x) == 2  ? "underscanned display" : \
	(x) == 3  ? "Future" : \
			"unknown")

#define AVI_COLORMETRY_STR(x)  ( \
	(x) == 0  ? "no data" : \
	(x) == 1  ? "ITU601" : \
	(x) == 2  ? "ITU709" : \
	(x) == 3  ? "Extended Colorimetry infor valid" : \
			"unknown")

#define AVI_ASPECT_STR(x)  ( \
	(x) == 0  ? "No data" : \
	(x) == 1  ? "4:3" : \
	(x) == 2  ? "16:9" : \
	(x) == 3  ? "Future" : \
...
#define AVI_ACTIVE_STR(x)  ( \
	...
	(x) == 6  ? "reserved" : \
	(x) == 7  ? "reserved" : \
	(x) == 8  ? "Same as picture aspect ratio" : \
	(x) == 9  ? "4:3(Center)" : \
	(x) == 10  ? "16:9(Center)" : \
	(x) == 11  ? "14:9(Center)" : \
	(x) == 12  ? "reserved" : \
	(x) == 13  ? "4:3(with shoot & protect 14:9 center)" : \
	(x) == 14  ? "16:9(with shoot & protect 14:9 center)" : \
	(x) == 15  ? "16:3(with shoot & protect 4:3 center)" : \
			"unknown")


#define AVI_IT_CONTENT_STR(x)  ( \
	(x) == 0  ? "no data" : \
	(x) == 1  ? "IT Content" : \
			"unknown")

#define AVI_EXT_COLORMETRY_STR(x)  ( \
	(x) == 0  ? "xvYCC601" : \
	(x) == 1  ? "xvYCC709" : \
	(x) == 2  ? "sYCC601" : \
	(x) == 3  ? "opYCC601" : \
...
#define AVI_RGB_RANGE_STR(x)  ( \
	(x) == 0  ? "depends on video format" : \
	(x) == 1  ? "Limit range" : \
	(x) == 2  ? "FULL range" : \
	(x) == 3  ? "Reserved" : \
			"unknown")

#define AVI_SCALE_STR(x)  ( \
	(x) == 0  ? "Unknown non-uniform scaling" : \
	(x) == 1  ? "Picture has been scaled horizontally" : \
	(x) == 2  ? "Picture has been scaled vertically" : \
	(x) == 3  ? "Picture has been scaled horizontally and vertically" : \
			"unknown")

#define SPD_DEVICE_STR(x)  ( \
	(x) == 0  ? "unknown" : \
	(x) == 1  ? "Digital STB" : \
	(x) == 2  ? "DVD Player" : \
	(x) == 3  ? "D-VHS" : \
	(x) == 4  ? "HDD Videorecorder" : \
	(x) == 5  ? "DVC" : \
	(x) == 6  ? "DSC" : \
	(x) == 7  ? "Video CD" : \
	(x) == 8  ? "Game" : \
...
#if (defined(CONFIG_MTK_IN_HOUSE_TEE_SUPPORT) || defined(CONFIG_OPTEE))
void ta_internal_hdmi_write(unsigned int u4Reg,
unsigned int u4data)
{
...
/* //////////////////////////////////////////// */
unsigned int hdmi_vdout_read(unsigned short u2Reg)
{
	unsigned int u4Data = 0;

	internal_hdmi_read(hdmi_reg[REG_HDMI_VDOUT] + u2Reg, &u4Data);
...
void hdmi_drv_write(unsigned short u2Reg, unsigned int u4Data)
{
	...
	if (!((u2Reg == 0x424) || (u2Reg == 0x1C8) || (u2Reg == 0x1CC)
		|| (u2Reg == 0x1A0) || (u2Reg == 0x1E0)
		|| (u2Reg == 0x378) || (u2Reg == 0x37C)
		|| ((u2Reg <= 0x14C) && (u2Reg >= 0x0C0))
		|| ((u2Reg <= 0x364) && (u2Reg >= 0x200))
		|| (((u2Reg <= 0xD00) && (u2Reg >= 0xC00)) &&
		(u2Reg != 0xc08) && (u2Reg != 0xc10) && (u2Reg != 0xcac)))) {
		HDMI_REG_LOG(
		"[W]addr = 0x%04x, data = 0x%08x\n",
		u2Reg, u4Data);
...
unsigned int hdmi_rgb2hdmi_read(unsigned int u2Reg)
{
	...
	internal_hdmi_read(hdmi_reg[REG_HDMI_RGB2HDMI] +
		u2Reg - 0x1800, &u4Data);
	HDMI_REG_LOG("[R]addr = 0x%04x, data = 0x%08x\n", u2Reg, u4Data);
	return u4Data;
}
...
{
	HDMI_REG_LOG("[W]addr= 0x%04x, data = 0x%08x\n", u2Reg, u4Data);
	internal_hdmi_write(hdmi_reg[REG_HDMI_RGB2HDMI] +
		u2Reg - 0x1800, u4Data);
}
...
bool hdmi_ddc_request(unsigned char req)
{
	...
	if (down_interruptible(&hdcp_update_mutex)) {
		TX_DEF_LOG(
		"can't get semaphore in %s() for boot time\n",
		__func__);
		return TRUE;
	}
	...
	if (req == 5) {
		/* reset DDC */
		vWriteHdmiGRLMsk(TOP_MISC_CTLR, DISABLE_IDLE_DDC_RESET,
		...
		if (bReadByteHdmiGRL(HDCP2X_DDCM_STATUS) & DDC_I2C_BUS_LOW) {
			vWriteHdmiGRLMsk(DDC_CTRL, (CLOCK_SCL <<
	...
	/* step2 : stop polling */
	vWriteHdmiGRLMsk(HDCP2X_POL_CTRL,
	HDCP2X_DIS_POLL_EN, HDCP2X_DIS_POLL_EN);

	/* step4 : stop hdcp2.x */
	vWriteHdmiGRLMsk(HDCP2X_GP_IN, 0xdb << HDCP2X_GP_IN3_SHIFT,
	HDCP2X_GP_IN3);
...
{
	vWriteIoHdmiAnaMsk(HDMI_ANA_CTL, (0x1 << 16), (0x1 << 16));//1006
...
void MuteHDMIAudio(void)
{
	...
	if (bReadByteHdmiGRL(AIP_CTRL) & DSD_EN)
		...
		vWriteHdmiGRLMsk(AIP_TXCTRL,
		AUD_MUTE_FIFO_EN, AUD_MUTE_FIFO_EN);
}
...
{
	if ((bResIndex == HDMI_VIDEO_3840x2160P_50HZ) ||
		(bResIndex == HDMI_VIDEO_4096x2160P_50HZ)
		|| (bResIndex == HDMI_VIDEO_3840x2160P_59_94HZ)
	    || (bResIndex == HDMI_VIDEO_4096x2160P_59_94HZ)
	    || (bResIndex == HDMI_VIDEO_3840x2160P_60HZ)
...
void vResetHDMI(char bRst)
{
	...
	if (bRst) {
		vWriteHdmiGRLMsk(HDMITX_CONFIG,
			0x0, 0x1<<31);//1006
		vWriteHdmiGRLMsk(HDMITX_CONFIG,
			0x1<<31, 0x1<<31);//1006
		//vWriteRGB2HDMIMsk(MMSYS_SW0_RST_B, 0, rgb2hdmi_rst_en);1006
		//vWriteRGB2HDMIMsk(MMSYS_SW0_RST_B,1006
		//rgb2hdmi_rst_en, rgb2hdmi_rst_en);
	} else {
		//vWriteHdmiSYSMsk(MMSYS_VDOUT_SW_RST, MMSYS_VDOUT_HDMI_RST,1006
		//	MMSYS_VDOUT_HDMI_RST);
	}
}
...
unsigned char bGetChannelMapping(void)
{
	...
	HDMI_PLUG_LOG(
"u1Aud_Input_Chan_Cnt = %d; ui1_aud_out_ch_number = %d;------\n",
...
void vSetHdmiDsdConfig(unsigned char bChNum, bool fgRxDsdBypass)
{
	...
	if (fgRxDsdBypass)
		vWriteByteHdmiGRL(TOP_AUD_MAP, 0x75316420);
	/* 0x13570246 */
	else
		vWriteByteHdmiGRL(TOP_AUD_MAP, 0x04230150);
	/* 0 FL;1 SL;2 CENT;3 FR;4 SR;5 LFE 0x32400510 */

	vWriteHdmiGRLMsk(AIP_SPDIF_CTRL, 0,
	I2S2DSD_EN);	/* rxtx bypass */
}
...
void vSetHDMIAudioIn(void)
{
	...
	if (_stAvdAVInfo.e_hdmi_aud_in == SV_I2S) {
		if ((_stAvdAVInfo.e_aud_code == AVD_DTS_HD) ||
			...
			vSetHdmiI2SChNum(
				_stAvdAVInfo.ui1_aud_out_ch_number, 1);
		} else {
			vSetHdmiI2SDataFmt(_stAvdAVInfo.e_I2sFmt);
...
{
	if (bRst) {
		vWriteHdmiGRLMsk(AIP_TXCTRL, RST4AUDIO |
			RST4AUDIO_FIFO | RST4AUDIO_ACR,
				 RST4AUDIO | RST4AUDIO_FIFO |
				 RST4AUDIO_ACR);
	} else {
		vWriteHdmiGRLMsk(AIP_TXCTRL, 0, RST4AUDIO |
			RST4AUDIO_FIFO | RST4AUDIO_ACR);
	}
}
			 ...
			 unsigned char bdeepmode)
{
	...
	if (_HdmiSinkAvCap.ui2_edid_chksum_and_audio_sup &
		...
		/* HDCP is OK and UI not set MUTE  */
		if (_stAvdAVInfo.bMuteHdmiAudio == FALSE)
			UnMuteHDMIAudio();
	}
}
	...
	unsigned char ui1colorspace)
{
	...
	(ui1colorspace == HDMI_YCBCR_422_FULL)) {
		_bAviInfoFm[0] = 0x20;
	} else {
		_bAviInfoFm[0] = 0x00;
	}
	...
	if (_fgDolbyHdrEnable)
		_bAviInfoFm[0] = 0x0;
	/* vfor xvYCC or BT2020 */
	if ((_fgSendAVIXVYcc == TRUE) || (_fgBT2020Enable))
		_bAviInfoFm[1] = 0xc0;
	else
		_bAviInfoFm[1] = 0x0;
	...
	if (!bResolution_4K2K(ui1resindex) && ui1resindex < HDMI_VIDEO_RESOLUTION_NUM)
		_bAviInfoFm[3] =
		HDMI_VIDEO_ID_CODE[ui1resindex];	/* bData4 */
	...
	if (_fg14GameModeEnable &&
		_HdmiSinkAvCap.u1_sink_14gamemode_support &&
...
void vSendVendorSpecificInfoFrame(unsigned char ui1resindex)
{
	...
	if (fg3DRes == TRUE)
		...
		if (bVic != 0)
			if ((_fgDolbyHdrEnable && fgUseDolbyVSIF()) ||
				_fgLowLatencyDolbyVisionEnable)
				vHalSendVendorSpecificInfoFrame(0,
				0, 0xff, 0);
			else if (_fgDolbyHdrEnable &&
				(!fgUseDolbyVSIF()))
				vHalSendVendorSpecificInfoFrame(0,
				bVic, 0xff, 1);
			else
			...
			vHalSendVendorSpecificInfoFrame(0, 0, 0xff,
...
void vShowHpdRsenStatus(void)
{
	...
	if (bCheckPortStatus(HOTPLUG_MODE) == TRUE)
		HDMI_PLUG_LOG("HPD ON\n");
	else
		HDMI_PLUG_LOG("HPD OFF\n");

	if (bCheckPortStatus(PORD_MODE) == TRUE)
		HDMI_PLUG_LOG("RSEN ON\n");
	else
		HDMI_PLUG_LOG("RSEN OFF\n");

	HDMI_PLUG_LOG("port_status: 0x%x\n", port_status);
	for (i = 0; i < PORT_IRQ_CNT; i++)
		HDMI_PLUG_LOG("port_status_value[%d]:0x%x\n",
			i, port_status_value[i]);
	for (i = 0; i < PORT_EDGE_RECORD_CNT; i++)
		HDMI_PLUG_LOG("port_edge_cnt[%d]:%d\n",
			i, port_edge_cnt[i]);

	if (i4SharedInfo(SI_HDMI_RECEIVER_STATUS) == HDMI_PLUG_IN_ONLY)
		HDMI_PLUG_LOG(
		"SI_HDMI_RECEIVER_STATUS = HDMI_PLUG_IN_ONLY\n");
	else if (i4SharedInfo(SI_HDMI_RECEIVER_STATUS) ==
		HDMI_PLUG_IN_AND_SINK_POWER_ON)
		HDMI_PLUG_LOG(
		"SI_HDMI_RECEIVER_STATUS = HDMI_PLUG_IN_AND_SINK_POWER_ON\n");
...
void vShowOutputVideoResolution(void)
{
	if (_stAvdAVInfo.e_resolution < HDMI_VIDEO_RESOLUTION_NUM)
		...
		HDMI_RES_STR(_stAvdAVInfo.e_resolution));	/*  */
	else
...
void vShowColorSpace(void)
{
	if (_stAvdAVInfo.e_video_color_space == HDMI_RGB)
		...
		HDMI_PLUG_LOG(
	"[HDMI]HDMI output colorspace = HDMI_YCBCR_422\n");
	else if (_stAvdAVInfo.e_video_color_space == HDMI_YCBCR_420)
		HDMI_PLUG_LOG(
	"[HDMI]HDMI output colorspace = HDMI_YCBCR_420\n");
...
void vShowInforFrame(void)
{
	...
	HDMI_PLUG_LOG(
	"Data Byte (1~5) = 0x%x  0x%x  0x%x  0x%x  0x%x\n",
				_bAudInfoFm[0],
			  _bAudInfoFm[1], _bAudInfoFm[2],
			  _bAudInfoFm[3], _bAudInfoFm[4]);

	HDMI_PLUG_LOG("CC2~ CC0: 0x%x, %s\n", _bAudInfoFm[0] & 0x07,
		  AUD_CH_COUNT_STR(_bAudInfoFm[0] & 0x07));


	HDMI_PLUG_LOG("CT3~ CT0: 0x%x, %s\n",
		 (_bAudInfoFm[0] >> 4) & 0x0f,
		HDMI_AUD_CODING_TYPE_STR((_bAudInfoFm[0] >> 4) & 0x0f));


	HDMI_PLUG_LOG("SS1, SS0: 0x%x, %s\n", _bAudInfoFm[1] & 0x03,
		AUD_SAMPLE_SIZE_STR(_bAudInfoFm[1] & 0x03));

	HDMI_PLUG_LOG("SF2~ SF0: 0x%x, %s\n",
		(_bAudInfoFm[1] >> 2) & 0x07,
		AUD_FS_STR((_bAudInfoFm[1] >> 2) & 0x07));

	HDMI_PLUG_LOG("CA7~ CA0: 0x%x, %s\n", _bAudInfoFm[3] & 0xff,
		AUD_CH_MAP_STR(_bAudInfoFm[3] & 0xff));

	HDMI_PLUG_LOG("LSV3~LSV0: %d db\n", (_bAudInfoFm[4] >> 3) & 0x0f);

	HDMI_PLUG_LOG("DM_INH: 0x%x ,%s\n", (_bAudInfoFm[4] >> 7) & 0x01,
		AUD_DMINH_STR((_bAudInfoFm[4] >> 7) & 0x01));
	HDMI_PLUG_LOG
	...
	HDMI_PLUG_LOG(
		"Data Byte (1~5) = 0x%x  0x%x  0x%x  0x%x  0x%x\n",
		_bAviInfoFm[0],
		      _bAviInfoFm[1], _bAviInfoFm[2],
		      _bAviInfoFm[3], _bAviInfoFm[4]);

	HDMI_PLUG_LOG("S1,S0: 0x%x, %s\n", _bAviInfoFm[0] & 0x03,
		AVI_SCAN_STR(_bAviInfoFm[0] & 0x03));

	HDMI_PLUG_LOG("B1,S0: 0x%x, %s\n",
		(_bAviInfoFm[0] >> 2) & 0x03,
		AVI_BAR_STR((_bAviInfoFm[0] >> 2) & 0x03));

	HDMI_PLUG_LOG("A0: 0x%x, %s\n",
		(_bAviInfoFm[0] >> 4) & 0x01,
		AVI_ACTIVE_PRESENT_STR((_bAviInfoFm[0] >> 4) & 0x01));

	HDMI_PLUG_LOG("Y1,Y0: 0x%x, %s\n",
		(_bAviInfoFm[0] >> 5) & 0x03,
		AVI_RGB_YUV_STR((_bAviInfoFm[0] >> 5) & 0x03));

	HDMI_PLUG_LOG("R3~R0: 0x%x, %s\n", (_bAviInfoFm[1]) & 0x0f,
		AVI_ACTIVE_STR((_bAviInfoFm[1]) & 0x0f));

	HDMI_PLUG_LOG("M1,M0: 0x%x, %s\n",
		(_bAviInfoFm[1] >> 4) & 0x03,
		AVI_ASPECT_STR((_bAviInfoFm[1] >> 4) & 0x03));

	HDMI_PLUG_LOG("C1,C0: 0x%x, %s\n",
		(_bAviInfoFm[1] >> 6) & 0x03,
		AVI_COLORMETRY_STR((_bAviInfoFm[1] >> 6) & 0x03));

	HDMI_PLUG_LOG("SC1,SC0: 0x%x, %s\n",
		(_bAviInfoFm[2]) & 0x03,
		AVI_SCALE_STR((_bAviInfoFm[2]) & 0x03));

	HDMI_PLUG_LOG("Q1,Q0: 0x%x, %s\n",
		(_bAviInfoFm[2] >> 2) & 0x03,
		AVI_RGB_RANGE_STR((_bAviInfoFm[2] >> 2) & 0x03));

	HDMI_PLUG_LOG("EC2~EC0: 0x%x, %s\n",
		(_bAviInfoFm[2] >> 4) & 0x07,
		AVI_EXT_COLORMETRY_STR((_bAviInfoFm[2] >> 4) & 0x07));

	HDMI_PLUG_LOG("ITC: 0x%x, %s\n", (_bAviInfoFm[2] >> 7) & 0x01,
		AVI_IT_CONTENT_STR((_bAviInfoFm[2] >> 7) & 0x01));
...
"Data Byte (1~8)  = 0x%x  0x%x  0x%x  0x%x  0x%x  0x%x  0x%x  0x%x\n",
		      _bSpdInf[0], _bSpdInf[1], _bSpdInf[2],
		      _bSpdInf[3], _bSpdInf[4], _bSpdInf[5],
		      _bSpdInf[6], _bSpdInf[7]);
	HDMI_PLUG_LOG(
"Data Byte (9~16) = 0x%x  0x%x  0x%x  0x%x  0x%x  0x%x  0x%x  0x%x\n",
		      _bSpdInf[8], _bSpdInf[9], _bSpdInf[10],
		      _bSpdInf[11], _bSpdInf[12],
		      _bSpdInf[13], _bSpdInf[14], _bSpdInf[15]);
	HDMI_PLUG_LOG(
"Data Byte (17~24)= 0x%x  0x%x  0x%x  0x%x  0x%x  0x%x  0x%x  0x%x\n",
		      _bSpdInf[16], _bSpdInf[17], _bSpdInf[18],
		      _bSpdInf[19], _bSpdInf[20],
		      _bSpdInf[21], _bSpdInf[22], _bSpdInf[23]);
	HDMI_PLUG_LOG("Data Byte  25    = 0x%x\n", _bSpdInf[24]);
	HDMI_PLUG_LOG("Source Device information is %s\n",
		SPD_DEVICE_STR(_bSpdInf[24]));
	HDMI_PLUG_LOG
	    ("==================SPD inforFrame End ==============\n");
}
...
void vShowHdmiAudioStatus(void)
{
	...
	HDMI_PLUG_LOG("HDMI output Audio Fs = %s\n",
		HDMI_AUD_FS_STR(_stAvdAVInfo.e_hdmi_fs));
	HDMI_PLUG_LOG("HDMI MCLK =%d\n", _stAvdAVInfo.u1HdmiI2sMclk);
	HDMI_PLUG_LOG("HDMI output ACR N= %d, C_T_S = %d\n",
...
{
	vWriteHdmiGRLMsk(HDCP_TOP_CTRL, OTPAMUTEOVR_SET,
		OTPAMUTEOVR_SET | OTPADROPOVR_SET);
	vWriteHdmiGRLMsk(HDCP_TOP_CTRL, OTP2XAOVR_EN |
		OTP14AOVR_EN, OTP2XAOVR_EN | OTP14AOVR_EN);
}
...
void vPerformanceConf(unsigned int bMode,
	unsigned char u8BasicFreq,
	unsigned int bDeepColor)
{

		vWriteIoHdmiAnaMsk(
		HDMI_1_PLL_CFG_0,
		(HDMITXPLL_BP2[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITXPLL_BP2_SHIFT),
		RG_HDMITXPLL_BP2
		);
		vWriteIoHdmiAnaMsk(
		HDMI_1_PLL_CFG_2,
		(HDMITXPLL_BC[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITXPLL_BC_SHIFT),
		RG_HDMITXPLL_BC
		);
		vWriteIoHdmiAnaMsk(
		HDMI_1_PLL_CFG_2,
		(HDMITXPLL_IC[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITXPLL_IC_SHIFT),
		RG_HDMITXPLL_IC
		);
		vWriteIoHdmiAnaMsk(
		HDMI_1_PLL_CFG_2,
		(HDMITXPLL_BR[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITXPLL_BR_SHIFT),
		RG_HDMITXPLL_BR
		);
		vWriteIoHdmiAnaMsk(
		HDMI_1_PLL_CFG_2,
		(HDMITXPLL_IR[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITXPLL_IR_SHIFT),
		RG_HDMITXPLL_IR
		);
		vWriteIoHdmiAnaMsk(
		HDMI_1_PLL_CFG_2,
		(HDMITXPLL_BP[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITXPLL_BP_SHIFT),
		RG_HDMITXPLL_BP
		);
		vWriteIoHdmiAnaMsk(
		HDMI_1_PLL_CFG_0,
		(HDMITXPLL_IBAND_FIX_EN[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITXPLL_IBAND_FIX_EN_SHIFT),
		RG_HDMITXPLL_IBAND_FIX_EN
		);
		vWriteIoHdmiAnaMsk(
		HDMI_1_PLL_CFG_2,
		(HDMITXPLL_HIKVCO[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITXPLL_HIKVCO_SHIFT),
		RG_HDMITXPLL_HIKVCO
		);
}

void vPerformanceCalConf(void)
{
	/* calibration value */
	/* only use for software calibration */
	unsigned int cal1 = 0;
	unsigned int cal2 = 0;

	TX_DEF_LOG("[HDMI]%s start\n", __func__);
	cal1 = get_devinfo_with_index(84);
	TX_DEF_LOG("[HDMI]cal 0x11c10b98 = 0x%x\n", cal1);
	cal2 = get_devinfo_with_index(64);
	TX_DEF_LOG("[HDMI]cal 0x11c10190 = 0x%x\n", cal2);
	if (cal1) {
		TX_DEF_LOG("[HDMI]calibration software mode\n");
		vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_2,
		(1 << 7),
		(1 << 7));
	...
	RG_HDMITX21_DRV_IMP_CLK_EN1
		...
		HDMI_1_CFG_6,
		((cal2 >> 23 & 0x1f) <<
		RG_HDMITX21_INTR_CAL_SHIFT),
	RG_HDMITX21_INTR_CAL
	);
	}
	TX_DEF_LOG("[HDMI]%s done\n", __func__);
}

void vSetHDMITxPLL(unsigned int bResIndex,
	unsigned int bDeepColor,
	unsigned int bMode, unsigned int bRxTmdsRate)
{
	int ret = 0;
	unsigned char u8BasicFreq = 0;
	unsigned char u8SameValueIndex = 0;

	HDMI_PLL_LOG("bResIndex = %d, bDeepColor = %d\n",
	bResIndex, bDeepColor);
	HDMI_DRV_FUNC();

	if ((bMode == HDMI21_REPEATER_PASSTHROUGH) ||
		(bMode == HDMI21_REPEATER_BYPASS)) {

		if (bRxTmdsRate < (27000*4/4+27000*5/4)/2) {
			u8BasicFreq = HDMI21_27M;
			bDeepColor = HDMI_NO_DEEP_COLOR;
		} else if (
		bRxTmdsRate < (27000*5/4+27000*6/4)/2) {/* for 25.02M */
			u8BasicFreq = HDMI21_27M;
			bDeepColor = HDMI_DEEP_COLOR_10_BIT;
		} else if (bRxTmdsRate < (27000*6/4+27000*8/4)/2) {
			u8BasicFreq = HDMI21_27M;
			bDeepColor = HDMI_DEEP_COLOR_12_BIT;
		} else if (bRxTmdsRate < (27000*8/4+74175*4/4)/2) {
			u8BasicFreq = HDMI21_27M;
			bDeepColor = HDMI_DEEP_COLOR_16_BIT;
		} else if (bRxTmdsRate < (74175*4/4+74175*5/4)/2) {
			u8BasicFreq = HDMI21_74_175M;
			bDeepColor = HDMI_NO_DEEP_COLOR;
		} else if (bRxTmdsRate < (74175*5/4+74175*6/4)/2) {
			u8BasicFreq = HDMI21_74_175M;
			bDeepColor = HDMI_DEEP_COLOR_10_BIT;
		} else if (bRxTmdsRate < (74175*6/4+74175*8/4)/2) {
			u8BasicFreq = HDMI21_74_175M;
			bDeepColor = HDMI_DEEP_COLOR_12_BIT;
		} else if (bRxTmdsRate < (148350*4/4+148350*5/4)/2) {
			u8BasicFreq = HDMI21_148_35M;
			bDeepColor = HDMI_NO_DEEP_COLOR;
		} else if (bRxTmdsRate < (148350*5/4+148350*6/4)/2) {
			u8BasicFreq = HDMI21_148_35M;
			bDeepColor = HDMI_DEEP_COLOR_10_BIT;
		} else if (bRxTmdsRate < (148350*6/4+148350*8/4)/2) {
			u8BasicFreq = HDMI21_148_35M;
			bDeepColor = HDMI_DEEP_COLOR_12_BIT;
		} else if (bRxTmdsRate <  (296700*4/4+296700*5/4)/2) {
			u8BasicFreq = HDMI21_296_7M;
			bDeepColor = HDMI_NO_DEEP_COLOR;
		} else if (bRxTmdsRate <  (296700*5/4+296700*6/4)/2) {
			u8BasicFreq = HDMI21_296_7M;
			bDeepColor = HDMI_DEEP_COLOR_10_BIT;
		} else if (bRxTmdsRate <  (296700*6/4+296700*8/4)/2) {
			u8BasicFreq = HDMI21_296_7M;
			bDeepColor = HDMI_DEEP_COLOR_12_BIT;
		} else {
			u8BasicFreq = HDMI21_296_7M;
		...
		HDMI_CTL_3,
		(
(reg_osdtvd_rx_div_config_PASSTHROUGH[u8BasicFreq][bDeepColor-1] - 1)
		<<
		reg_osdtvd_rx_div_config_SHIFT),
		reg_osdtvd_rx_div_config
		);
		vWriteIoHdmiAnaMsk(
		HDMI_CTL_3,
		(0 <<
		reg_hdmitx_ref_rxck_sel_SHIFT),
		reg_hdmitx_ref_rxck_sel
		);
		vWriteIoHdmiAnaMsk(
		HDMI_CTL_3,
		(1 <<
		reg_hdmitx_ref_xtal_sel_SHIFT),
		reg_hdmitx_ref_xtal_sel
		);

	} else if (bMode == HDMI21_SOURCE_TVDPLL) {
		...
		case HDMI_VIDEO_1920x1080p_29Hz:
			u8BasicFreq = HDMI21_74_25M; /* 74.25M */
			break;
		...
		case HDMI_VIDEO_1920x1080p3d_23Hz:
			u8BasicFreq = HDMI21_148_5M; /* 148.5M */
			break;
		...
		HDMI_CTL_3,
		(
	reg_hdmitx_ref_tvd_osd_sel_TVDPLL[u8BasicFreq][bDeepColor-1] <<
		reg_hdmitx_ref_tvd_osd_sel_SHIFT),
		reg_hdmitx_ref_tvd_osd_sel
		);
		vWriteIoHdmiAnaMsk(
		HDMI_CTL_3,
		(
	reg_osdtvd_div_config_TVDPLL[u8BasicFreq][bDeepColor-1] <<
		reg_osdtvd_div_config_SHIFT),
		reg_osdtvd_div_config
		);
		vWriteIoHdmiAnaMsk(
		HDMI_CTL_3,
		(HDMI_CTL_3_8[u8BasicFreq][bDeepColor-1] <<
		reg_HDMI_CTL_3_8_SHIFT),
		reg_HDMI_CTL_3_8
		);
		vWriteIoHdmiAnaMsk(
		HDMI_CTL_3,
	...
	} else if (bMode == HDMI21_SOURCE_26M) {
		//ret = clk_set_parent(vdout_hd_sel, hdmitx_pxl_clk);
		if (ret)
			HDMI_DRV_LOG("[TX]Failed to set vdout_hd_sel\n");
		//ret = clk_set_parent(vdout_sd_sel, hdmitx_pxl_clk_d6);
		if (ret)
			HDMI_DRV_LOG("[TX]Failed to set vdout_sd_sel\n");
		...
		case HDMI_VIDEO_1920x1080p_23Hz:
		case HDMI_VIDEO_1920x1080p_29Hz:
			u8BasicFreq = HDMI21_74_175M; /* 74.175M */
			break;
		case HDMI_VIDEO_1280x720p_60Hz:
		case HDMI_VIDEO_1280x720p_50Hz:
		case HDMI_VIDEO_1920x1080i_60Hz:
		...
		case HDMI_VIDEO_1920x1080p_59_94Hz:
		case HDMI_VIDEO_1920x1080p3d_23Hz:
			u8BasicFreq = HDMI21_148_35M; /* 148.35M */
			break;
		case HDMI_VIDEO_1920x1080p_60Hz:
		case HDMI_VIDEO_1920x1080p_50Hz:
		case HDMI_VIDEO_1280x720p3d_60Hz:/* 59.4*2=118.8M pixel clock */
		...
		case HDMI_VIDEO_3840x2160P_23_976HZ:
		case HDMI_VIDEO_3840x2160P_29_97HZ:
			u8BasicFreq = HDMI21_296_7M; /* 296.7M */
			break;
		case HDMI_VIDEO_3840x2160P_24HZ:
		case HDMI_VIDEO_3840x2160P_25HZ:
		case HDMI_VIDEO_3840x2160P_30HZ:
		...
		case HDMI_VIDEO_3840x2160P_59_94HZ:
		case HDMI_VIDEO_4096x2160P_59_94HZ:
			u8BasicFreq = HDMI21_296_7M; /* 594M */
			if (
			!(_stAvdAVInfo.e_video_color_space == HDMI_YCBCR_420))
				bDeepColor = HDMI_DEEP_COLOR_16_BIT;
			break;
	...
	/* tx performance config */
	vPerformanceConf(bMode, u8BasicFreq, bDeepColor);

	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_10,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_BIAS_PE_BG_VREF_SEL_SHIFT),
	RG_HDMITX21_BIAS_PE_BG_VREF_SEL
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_10,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_BIAS_PE_VREF_SELB_SHIFT),
	RG_HDMITX21_BIAS_PE_VREF_SELB
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_10,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_BG_LPF_EN_SHIFT),
	RG_HDMITX21_BG_LPF_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_9,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_SLDO_VREF_SEL_SHIFT),
	RG_HDMITX21_SLDO_VREF_SEL
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_10,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_VREF_SEL_SHIFT),
	RG_HDMITX21_VREF_SEL
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_3,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_SLDOLPF_EN_SHIFT),
	RG_HDMITX21_SLDOLPF_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_10,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_VREF_GEN2_REFSEL_SHIFT),
	RG_HDMITX21_VREF_GEN2_REFSEL
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_6,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
	...
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_6,
		(HDMITX21_TX_POSDIV[u8BasicFreq][bDeepColor-1] <<
	...
	vWriteIoHdmiAnaMsk(
		HDMI_1_PLL_CFG_2,
		(1 <<
		RG_HDMITXPLL_PWD_SHIFT),
	RG_HDMITXPLL_PWD
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_6,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_TX_POSDIV_EN_SHIFT),
	RG_HDMITX21_TX_POSDIV_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_6,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_FRL_EN_SHIFT),
	RG_HDMITX21_FRL_EN
	);
	/* need to set according to freq and deepcolor */
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_9,
		(HDMITX21_POSDIV_DIV3_CTRL[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITX21_POSDIV_DIV3_CTRL_SHIFT),
	RG_HDMITX21_POSDIV_DIV3_CTRL
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_PLL_CFG_4,
		(HDMITXPLL_POSDIV[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITXPLL_POSDIV_SHIFT),
	RG_HDMITXPLL_POSDIV
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_PLL_CFG_4,
		(HDMITXPLL_DIV_CTRL[u8BasicFreq][bDeepColor-1] <<
	...
	vWriteIoHdmiAnaMsk(
		HDMI_1_PLL_CFG_4,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITXPLL_PREDIV_SHIFT),
	RG_HDMITXPLL_PREDIV
	);
	/* set pcw start */
	if (bMode == HDMI21_SOURCE_26M) {
		vWriteIoHdmiAnaMsk(
			HDMI_1_PLL_CFG_4,
			(HDMITXPLL_FBKDIV_high_26M[u8BasicFreq][bDeepColor-1] <<
			RG_HDMITXPLL_FBKDIV_high_SHIFT),
		RG_HDMITXPLL_FBKDIV_high
		);
		vWriteIoHdmiAnaMsk(
			HDMI_1_PLL_CFG_3,
			(HDMITXPLL_FBKDIV_low_26M[u8BasicFreq][bDeepColor-1] <<
			RG_HDMITXPLL_FBKDIV_low_SHIFT),
		RG_HDMITXPLL_FBKDIV_low
		);
	}
	if (bMode == HDMI21_SOURCE_TVDPLL) {
		vWriteIoHdmiAnaMsk(
			HDMI_1_PLL_CFG_4,
			(
	HDMITXPLL_FBKDIV_high_TVDPLL[u8BasicFreq][bDeepColor-1] <<
			RG_HDMITXPLL_FBKDIV_high_SHIFT),
		RG_HDMITXPLL_FBKDIV_high
		);
		vWriteIoHdmiAnaMsk(
			HDMI_1_PLL_CFG_3,
			(
		HDMITXPLL_FBKDIV_low_TVDPLL[u8BasicFreq][bDeepColor-1] <<
			RG_HDMITXPLL_FBKDIV_low_SHIFT),
		RG_HDMITXPLL_FBKDIV_low
		);
	}
	if (bMode == HDMI21_REPEATER_PASSTHROUGH) {
		vWriteIoHdmiAnaMsk(
			HDMI_1_PLL_CFG_4,
			(
	HDMITXPLL_FBKDIV_high_PASSTHORUGH[u8BasicFreq][bDeepColor-1] <<
			RG_HDMITXPLL_FBKDIV_high_SHIFT),
		RG_HDMITXPLL_FBKDIV_high
		);
		vWriteIoHdmiAnaMsk(
			HDMI_1_PLL_CFG_3,
			(
	HDMITXPLL_FBKDIV_low_PASSTHROUGH[u8BasicFreq][bDeepColor-1] <<
			RG_HDMITXPLL_FBKDIV_low_SHIFT),
		RG_HDMITXPLL_FBKDIV_low
		);
	}
	/* set pcw end */
	/* end of setting according to freq and deepcolor*/

	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_0,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_SER_EN_SHIFT),
	RG_HDMITX21_SER_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_6,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_D0_DRV_OP_EN_SHIFT),
	RG_HDMITX21_D0_DRV_OP_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_6,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_D1_DRV_OP_EN_SHIFT),
	RG_HDMITX21_D1_DRV_OP_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_6,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_D2_DRV_OP_EN_SHIFT),
	RG_HDMITX21_D2_DRV_OP_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_6,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_CK_DRV_OP_EN_SHIFT),
	RG_HDMITX21_CK_DRV_OP_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_6,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_FRL_D0_EN_SHIFT),
	RG_HDMITX21_FRL_D0_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_6,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_FRL_D1_EN_SHIFT),
	RG_HDMITX21_FRL_D1_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_6,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_FRL_D2_EN_SHIFT),
	RG_HDMITX21_FRL_D2_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_6,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_FRL_CK_EN_SHIFT),
	RG_HDMITX21_FRL_CK_EN
	);
/* setting according to Freq and deepcolor */

	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_1,
		(HDMITX21_DRV_IBIAS_D0[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITX21_DRV_IBIAS_D0_SHIFT),
	RG_HDMITX21_DRV_IBIAS_D0
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_1,
		(HDMITX21_DRV_IBIAS_D1[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITX21_DRV_IBIAS_D1_SHIFT),
	RG_HDMITX21_DRV_IBIAS_D1
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_1,
		(HDMITX21_DRV_IBIAS_D2[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITX21_DRV_IBIAS_D2_SHIFT),
	RG_HDMITX21_DRV_IBIAS_D2
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_0,
		(HDMITX21_DRV_IBIAS_CLK[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITX21_DRV_IBIAS_CLK_SHIFT),
	RG_HDMITX21_DRV_IBIAS_CLK
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_0,
		(HDMITX21_DRV_IMP_EN[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITX21_DRV_IMP_EN_SHIFT),
	RG_HDMITX21_DRV_IMP_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_2,
		(HDMITX21_DRV_IMP_D0_EN1[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITX21_DRV_IMP_D0_EN1_SHIFT),
	RG_HDMITX21_DRV_IMP_D0_EN1
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_2,
		(HDMITX21_DRV_IMP_D1_EN1[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITX21_DRV_IMP_D1_EN1_SHIFT),
	RG_HDMITX21_DRV_IMP_D1_EN1
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_2,
		(HDMITX21_DRV_IMP_D2_EN1[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITX21_DRV_IMP_D2_EN1_SHIFT),
	RG_HDMITX21_DRV_IMP_D2_EN1
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_2,
		(HDMITX21_DRV_IMP_CLK_EN1[u8BasicFreq][bDeepColor-1] <<
		RG_HDMITX21_DRV_IMP_CLK_EN1_SHIFT),
	RG_HDMITX21_DRV_IMP_CLK_EN1
	);
...
/*-----------------*/
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_10,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_BG_PWD_SHIFT),
	RG_HDMITX21_BG_PWD
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_6,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_BIAS_EN_SHIFT),
	RG_HDMITX21_BIAS_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_3,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_CKLDO_EN_SHIFT),
	RG_HDMITX21_CKLDO_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_CFG_3,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		RG_HDMITX21_SLDO_EN_SHIFT),
	RG_HDMITX21_SLDO_EN
	);
	vWriteIoHdmiAnaMsk(
		HDMI_1_PLL_CFG_4,
		(HDMITX21_PLL_SET_SAME_VALUE[u8SameValueIndex++] <<
		DA_HDMITXPLL_PWR_ON_SHIFT),
	DA_HDMITXPLL_PWR_ON
	);
...
void vChangeVpll(unsigned int bRes, unsigned int bdeepmode)
{
	...
	vSetHDMITxPLL(bRes, bClockRate, 1, 0);	/* set PLL */
}
...
{
	vWriteHdmiGRLMsk(AIP_CTRL, AUD_SEL_OWRT |
		NO_MCLK_CTSGEN_SEL | CTS_REQ_EN,
			 AUD_SEL_OWRT | NO_MCLK_CTSGEN_SEL | MCLK_EN |
			 CTS_REQ_EN);
	vWriteHdmiGRLMsk(AIP_TPI_CTRL, TPI_AUDIO_LOOKUP_DIS,
		TPI_AUDIO_LOOKUP_EN);
}

void vSetHdmi2I2SDataFmt(unsigned int bLength)
{
	vWriteHdmiGRLMsk(AIP_I2S_CTRL, bLength <<
		I2S_IN_LENGTH_SHIFT, I2S_IN_LENGTH);
}
...
{
	vWriteHdmiGRLMsk(AIP_I2S_CTRL, bFifoMap, FIFO3_MAP |
		FIFO2_MAP | FIFO1_MAP | FIFO0_MAP);
}
...
void vSetHdmiI2SChNum(unsigned char bChNum, unsigned char bChMapping)
{
	...
	vSetHdmi2I2SfifoMap((MAP_SD3 << 6) | (MAP_SD2 << 4) |
	(MAP_SD1 << 2) | (MAP_SD0 << 0));
...
void vSetHdmiSpdifConfig(void)
{
	...
	vWriteHdmiGRLMsk(AIP_SPDIF_CTRL, 0x4 <<
		MAX_1UI_WRITE_SHIFT, MAX_1UI_WRITE);
	vWriteHdmiGRLMsk(AIP_SPDIF_CTRL, 0x9 <<
			    ...
			    unsigned char bData5)
{
	...
	vWriteByteHdmiGRL(TOP_AIF_HEADER, (AUDIO_LEN << 16) +
		(AUDIO_VERS << 8) + AUDIO_TYPE);
...
void vSendAudioInfoFrame(void)
{
	...
	vHalSendAudioInfoFrame(_bAudInfoFm[0], _bAudInfoFm[1],
		_bAudInfoFm[3], _bAudInfoFm[4]);
	...
	unsigned char bPix, unsigned char bDeepMode)
{
	...
	vWriteByteHdmiGRL(AIP_N_VAL, (bData1[4] << 16) +
		(bData1[5] << 8) + (bData1[6] << 0));
	vWriteByteHdmiGRL(AIP_CTS_SVAL,
			  (bData1[0] << 24) + (bData1[1] << 16) +
			  (bData1[2] << 8) +
			  (bData1[3] << 0));
	_u4NValue = u4NTemp;
...
void vHalSendAVIInfoFrame(unsigned char *pr_bData)
{
	...
	vWriteByteHdmiGRL(TOP_AVI_HEADER, (AVI_LEN << 16) +
		(AVI_VERS << 8) + (AVI_TYPE << 0));
	...
	vWriteHdmiGRLMsk(TOP_INFO_EN, AVI_EN_WR | AVI_EN,
		AVI_EN_WR | AVI_EN);
...
{
	unsigned char bHfvsInfoFm[5];
	bool allmenable = 0;

	allmenable = _fgAllmEnable &
		_HdmiSinkAvCap.u1_sink_allm_support;
	bHfvsInfoFm[0] = 0xD8;//IEEE
	bHfvsInfoFm[1] = 0x5D;
	bHfvsInfoFm[2] = 0xC4;
	bHfvsInfoFm[3] = 0x01;//Version
	if (allmenable)
		bHfvsInfoFm[4] = 0x02;
	else
		bHfvsInfoFm[4] = 0x0;
...
void vHalSendVrrEMP(bool fgEnable, unsigned char *pr_bData)
{
	...
	u4Data = bReadByteHdmiGRL(TOP_INFO_EN) & HDMI2_GAMUT_EN;

	vWriteHdmiGRLMsk(TOP_INFO_EN, 0, GAMUT_EN_WR | HDMI2_GAMUT_EN);
	vWriteHdmiGRLMsk(TOP_INFO_RPT, 0, GAMUT_RPT_EN);

	vWriteByteHdmiGRL(TOP_GAMUT_HEADER, (0x0 << 16) +
		(0xC0 << 8) + (0x7F << 0));
	vWriteByteHdmiGRL(TOP_GAMUT_PKT00,
			  (*(pr_bData+3) << 24) +
			  (*(pr_bData+2) << 16) + (*(pr_bData+1) << 8) +
			  (*pr_bData << 0));
	vWriteByteHdmiGRL(TOP_GAMUT_PKT01,
			  (*(pr_bData+6) << 16) + (*(pr_bData+5) << 8) +
			  (*(pr_bData+4) << 0));
	vWriteByteHdmiGRL(TOP_GAMUT_PKT02,
			  (*(pr_bData+10) << 24) +
			  (*(pr_bData+9) << 16) + (*(pr_bData+8) << 8) +
			  (*(pr_bData+7) << 0));
	vWriteByteHdmiGRL(TOP_GAMUT_PKT03, 0);
	vWriteByteHdmiGRL(TOP_GAMUT_PKT04, 0);
	vWriteByteHdmiGRL(TOP_GAMUT_PKT05, 0);
	vWriteByteHdmiGRL(TOP_GAMUT_PKT06, 0);
	vWriteByteHdmiGRL(TOP_GAMUT_PKT07, 0);
	if (_fgVrrEnable || u4Data) {
		vWriteHdmiGRLMsk(TOP_INFO_RPT, GAMUT_RPT_EN, GAMUT_RPT_EN);
		vWriteHdmiGRLMsk(TOP_INFO_EN, GAMUT_EN_WR | HDMI2_GAMUT_EN,
		GAMUT_EN_WR | HDMI2_GAMUT_EN);
	}
}
...
void vSendVrrEMP(void)
{
	...
	bVrrEMPPacket[2] = 0x01;
	bVrrEMPPacket[3] = 0x00;
	bVrrEMPPacket[4] = 0x01;
	bVrrEMPPacket[5] = 0x00;
	bVrrEMPPacket[6] = 0x04;
	if (_fgVrrEnable)
		bVrrEMPPacket[7] = 0x01;
	else
		bVrrEMPPacket[7] = 0x00;

	if (_fgMConstEnable)
		bVrrEMPPacket[7] |= (0x1 << 1);

	bVrrEMPPacket[8] = HDMI_VRR[_stAvdAVInfo.e_resolution][1];
	bVrrEMPPacket[9] = 0x00;
	bVrrEMPPacket[10] = HDMI_VRR[_stAvdAVInfo.e_resolution][3];
	vHalSendVrrEMP(_fgVrrEnable, &bVrrEMPPacket[0]);
}
...
void vHalSendVendorSpecificInfoFrame(
	unsigned char fg3DRes,
	unsigned char bVIC,
				     ...
				     unsigned char fgDolbyHdrEnable)
{
	...
	if (fgDolbyHdrEnable)
		bVS_CHSUM =
		    VS_VERS + VS_TYPE + VS_DOLBYVISION_LEN + bPB1 +
		    bPB2 + bPB3 + bPB4 + bPB5;
	else
		bVS_CHSUM = VS_VERS + VS_TYPE + VS_LEN + bPB1 +
		bPB2 + bPB3 + bPB4 + bPB5;
	...
	if (fgDolbyHdrEnable)
		vWriteByteHdmiGRL(TOP_VSIF_HEADER,
				  (VS_DOLBYVISION_LEN << 16) +
				  (VS_VERS << 8) + VS_TYPE);
	else
		vWriteByteHdmiGRL(TOP_VSIF_HEADER, (VS_LEN << 16) +
		(VS_VERS << 8) + VS_TYPE);

	vWriteByteHdmiGRL(TOP_VSIF_PKT00, (bPB3 << 24) + (bPB2 << 16) +
		(bPB1 << 8) + bVS_CHSUM);
	...
	if ((fg3DRes != 0) || (bVIC != 0) || (fgDolbyHdrEnable != 0)) {
		...
		vWriteHdmiGRLMsk(TOP_INFO_EN, VSIF_EN | VSIF_EN_WR, VSIF_EN |
			VSIF_EN_WR);
	}
}
...
void vSend_AVUNMUTE(void)
{
	...
	vWriteHdmiGRLMsk(TOP_INFO_EN, CP_EN | CP_EN_WR, CP_EN |
		CP_EN_WR);
}
...
void vSendTMDSConfiguration(unsigned char enscramble)
{
	...
	fgDDCDataWrite(RX_REG_SCRAMBLE >> 1, RX_REG_TMDS_CONFIG, 1,
		&enscramble);
}
...
unsigned char bOver340M(void)
{
	...
	if (fgFMTis4k2k_6G(_stAvdAVInfo.e_resolution) &&
		(_stAvdAVInfo.e_video_color_space == HDMI_YCBCR_420)
...
void v4k6G_set_clock(void)
{
	...
	if (bOver340M() == TRUE)
		vWriteIoHdmiAnaMsk(HDMI20_CLK_CFG,
		(0x2 << reg_txc_div_SHIFT), reg_txc_div);
	else
		vWriteIoHdmiAnaMsk(HDMI20_CLK_CFG,
		(0x0 << reg_txc_div_SHIFT), reg_txc_div);
}

void vSetRGB2HdmiYUV709(bool bOn)
{
	if (bOn == TRUE)
		vWriteRGB2HDMIMsk(HDMI_RGB2HDMI_64,
		YCBCR2RGB_709_ORG, YCBCR2RGB_3X3_BY_COEFFICIENTS);
	else
		vWriteRGB2HDMIMsk(HDMI_RGB2HDMI_64, 0,
...
void vSetRGBYCbCrDelay(char bRDelay, char bGDelay,
	char bBDelay, char bYDelay, char bCbDelay,
		       char bCrDelay)
{
	vWriteRGB2HDMI(HDMI_RGB2HDMI_4O,
		    ((bRDelay & 0x07)) | ((bGDelay & 0x07) << 4) |
		    ((bBDelay & 0x07) << 8) |
		    ((bYDelay & 0x07) << 12) | ((bCbDelay & 0x07) << 16) |
		    ((bCrDelay & 0x07) <<
			20));
}

void vSetHDMIVideoPixelRepeat(char bColorSpace,
	bool fgPixRep, bool fgYuv422Delay)
{
	int ui4Data;
	int ui4DataDelay = 0;
...
void vHDMIVideoOutput(char ui1Res, char ui1ColorSpace)
{
	...
	HDMI_PLUG_LOG(
	"%s ui1Res=%d,bColorSpace=%d,ui1ColorSpace=%d\n",
	__func__,
	ui1Res,
	...
	if (ui1ColorSpace == HDMI_RGB_FULL) {
		vWriteRGB2HDMIMsk(HDMI_RGB2HDMI_60, YCBCR2RGB_3X3_ON,
			YCBCR2RGB_3X3_ON);
		/* Y offset 16 */
		if (_fgBT2020Enable) {
		...
		vWriteRGB2HDMIMsk(HDMI_RGB2HDMI_60,
			YCBCR2RGB_3X3_ON, YCBCR2RGB_3X3_ON);
		/* Y offset 16 */
		if (_fgBT2020Enable) {
			vWriteRGB2HDMI(HDMI_RGB2HDMI_64, 0x70eb0100);
			vWriteRGB2HDMI(HDMI_RGB2HDMI_6C, 0x0C000400);
		...
		vWriteRGB2HDMIMsk(HDMI_RGB2HDMI_60, 0, YCBCR2RGB_3X3_ON);
		/* Y offset 16 */
		vWriteRGB2HDMIMsk(HDMI_RGB2HDMI_64,
		YCBCR2RGB_601_ORG,
			YCBCR2RGB_3X3_BY_COEFFICIENTS);
		/* limit to 16 ~ 235 */
		if (_fgDolbyHdrEnable)
			vHalSetHdmiLimitRange(FALSE,
			0xfeff, 0x100);	/* 16bit */
		else
			vHalSetHdmiLimitRange(TRUE,
			0xfeff, 0x100);	/* 16bit */
	}

	if ((ui1Res == HDMI_VIDEO_1920x1080p_30Hz) ||
		(ui1Res == HDMI_VIDEO_1920x1080p_25Hz)
	    || (ui1Res == HDMI_VIDEO_1920x1080p_24Hz) ||
	    (ui1Res == HDMI_VIDEO_1920x1080p_23Hz)
	    || (ui1Res == HDMI_VIDEO_1920x1080p_29Hz) ||
	    (ui1Res == HDMI_VIDEO_1920x1080p_60Hz)
	    || (ui1Res == HDMI_VIDEO_1920x1080p_50Hz) ||
	    (ui1Res == HDMI_VIDEO_1920x1080p3d_24Hz)
	    || (ui1Res == HDMI_VIDEO_1920x1080p3d_23Hz) ||
	    (ui1Res == HDMI_VIDEO_1920x1080p_59_94Hz))
		vSetRGBYCbCrDelay(0, 0, 0, 0, 0, 0);
	else if ((ui1Res == HDMI_VIDEO_1920x1080i_60Hz) ||
		(ui1Res == HDMI_VIDEO_1920x1080i_50Hz))
		vSetRGBYCbCrDelay(0, 0, 0, 1, 0, 1);
	else
		vSetRGBYCbCrDelay(0, 0, 0, 1, 1, 1);
}

void vHDMIVOutMuteBG(char ui1Res, char ui1ColorSpace)
{
	char bColorSpace;
...
void vHDMIVideoOutputVsync(char ui1Res, char ui1ColorSpace)
{
	bool fgPixRep, fgYuv422Delay;
	char bColorSpace;
...
bool fgTVisHDMI(void)
{
	...
	if ((i4SharedInfo(SI_EDID_VSDB_EXIST) == TRUE) &&
		(i4SharedInfo(SI_HDMI_RECEIVER_STATUS) != HDMI_PLUG_OUT))
		return TRUE;
	else
		return FALSE;
}
...
void vSetHDMIDataEnable(unsigned int bResIndex)
{
	/* Set Vsync start, hsync width, v_polar, h_polar */
	if (bResIndex < MAX_RES) {
		vWriteRGB2HDMI(HDMI_RGB_TIME0,
			HDMI_SCL_HDMISYNC[bResIndex][0]);
		/* Write hdmi data enable */
		vWriteRGB2HDMIMsk(HDMI_RGB_TIME1,
		HDMI_DATA_ENABLE[bResIndex][2], 0x9FFF1FFF);
		/* 0xABC~0xABF */
		vWriteRGB2HDMIMsk(HDMI_RGB_TIME2,
		HDMI_DATA_ENABLE[bResIndex][1], 0x7FFFFFF);
		/* 0xAC0~0xAC3 */
		vWriteRGB2HDMIMsk(HDMI_RGB_TIME3,
		HDMI_DATA_ENABLE[bResIndex][0], 0x7FFFFFF);
		/* 0xAC4~0xAC7 */
	}
}
...
{
	/* Set Vsync start, hsync width, v_polar, h_polar */
	vWriteRGB2HDMIMsk(HDMI_RGB_TIME0, (88 << 16) | (10 << 0),
	0xffffffff);
	/* Write hdmi data enable */
	vWriteRGB2HDMIMsk(HDMI_RGB_TIME1, ((88 + 296 + 1) << 16) |
	(88 + 296 + 3840), 0x1FFF1FFF);
	/* 0xABC~0xABF */
	vWriteRGB2HDMIMsk(HDMI_RGB_TIME2, ((10 + 72 + 1) << 16) |
	(10 + 72 + 2160), 0x7FFFFFF);
	/* 0xAC0~0xAC3 */
	vWriteRGB2HDMIMsk(HDMI_RGB_TIME3, ((10 + 72 + 1) << 16) |
	(10 + 72 + 2160), 0x7FFFFFF);
	/* 0xAC4~0xAC7 */
}
...
void vSetHDMI4K2K4096DataEnable_60Hz(void)
{
	...
	0xffffffff);
	/* Write hdmi data enable */
	vWriteRGB2HDMIMsk(HDMI_RGB_TIME1, ((88 + 128 + 1) << 16) |
	(88 + 128 + 4096), 0x1FFF1FFF);
	/* 0xABC~0xABF */
	vWriteRGB2HDMIMsk(HDMI_RGB_TIME2, ((10 + 72 + 1) << 16) |
	(10 + 72 + 2160), 0x7FFFFFF);
	/* 0xAC0~0xAC3 */
...
void vSetHDMISyncDelay(unsigned int bResIndex)
{
	if (bResIndex < MAX_RES)
...
void vHDMIResetGenReg(void)
{
	...
	HDMI_PLUG_LOG("%s = %d, %lums\n",
		__func__,
		_stAvdAVInfo.e_resolution,
		      jiffies * 10);

	vHDMIVideoOutput(_stAvdAVInfo.e_resolution,
		_stAvdAVInfo.e_video_color_space);
	...
	if ((_stAvdAVInfo.e_video_color_space == HDMI_YCBCR_444) ||
		...
		|| (_stAvdAVInfo.e_video_color_space == HDMI_XV_YCC) ||
		(_stAvdAVInfo.e_video_color_space == HDMI_YCBCR_420)
	...
	if (1)//fgFMTis4k2k(_stAvdAVInfo.e_resolution))
		vSetHDMISyncDelay(bResTableIndx);
...
void vTxSignalOnOff(unsigned char bOn)
{
	...
	if (bOn) {
		...
		udelay(100);
		vWriteIoHdmiAnaMsk(HDMI_1_CFG_6, 0, 0x1001ff00);
		vWriteIoHdmiAnaMsk(HDMI_1_CFG_0, 0, RG_HDMITX21_SER_EN);

		vWriteIoHdmiAnaMsk(HDMI_1_CFG_1, 0, 0xffff3000);
		vWriteIoHdmiAnaMsk(HDMI_1_CFG_0, 0, RG_HDMITX21_DRV_IBIAS_CLK);

		vWriteIoHdmiAnaMsk(HDMI_1_CFG_0, 0, RG_HDMITX21_DRV_IMP_EN);
		vWriteIoHdmiAnaMsk(HDMI_1_CFG_2, 0, 0xffffff00);

		vWriteIoHdmiAnaMsk(HDMI_1_CFG_10, 0, RG_HDMITX21_BG_PWD);
		vWriteIoHdmiAnaMsk(HDMI_1_CFG_6, 0, RG_HDMITX21_BIAS_EN);
		vWriteIoHdmiAnaMsk(HDMI_1_CFG_3, 0, RG_HDMITX21_CKLDO_EN);
...
void vChgHDMIVideoResolution(void)
{
	...
	vHDMIAVMute();
	vSend_AVUNMUTE();
	vWriteHdmiGRLMsk(TOP_CFG01, NULL_PKT_VSYNC_HIGH_EN,
		NULL_PKT_VSYNC_HIGH_EN | NULL_PKT_EN);

	if (bOver340M() == TRUE) {
		vSendTMDSConfiguration(SCRAMBLING_ENABLE |
			TMDS_BIT_CLOCK_RATION);
		HAL_Delay_us(100);
		vWriteHdmiGRLMsk(TOP_CFG00, SCR_ON |
			HDMI2_ON, SCR_ON | HDMI2_ON);
	} else {
	...
	vWriteHdmiGRLMsk(TOP_OUT00, 0x2 << 4 | TX_BIT_INV_EN,
		Q2_SEL | Q0_SEL | TX_BIT_INV_EN);
	HDMI_PLUG_LOG("[Kara]hdmi polarity swap done\n");
#endif
	/* vMutevideoAudio(0); */
}
...
unsigned char bCheckStatus(unsigned char bMode)
{
	...
	if ((STATUS_HTPLG & bMode) == STATUS_HTPLG)
		bStatus = IS_HDMI_HTPLG() ? (bStatus | STATUS_HTPLG) :
		(bStatus & (~STATUS_HTPLG));
...
void vHalSendStaticHdrInfoFrame(char bEnable,
	char *pr_bData)
{
	...
	if (bEnable == HDR_PACKET_ACTIVE) {
		...
		vWriteByteHdmiGRL(TOP_GEN4_PKT00,
				  ...
				  (bHDR_CHSUM << 0));
		HDMI_HDR_LOG(
			" 1 data0=0x%x, data1=0x%x, data2=0x%x, data3=0x%x\n",
				  (bHDR_CHSUM << 0),
				  ((*(pr_bData + 0)) << 8),
				  (*(pr_bData + 1) << 16),
				  ((*(pr_bData + 2)) << 24));
		...
		vWriteByteHdmiGRL(TOP_GEN4_PKT02,
				  ...
				  ((*(pr_bData + 6)) << 0));
		HDMI_HDR_LOG(
			" 3 data0=0x%x, data1=0x%x, data2=0x%x, data3=0x%x\n",
				  ((*(pr_bData + 6)) << 0),
				  ((*(pr_bData + 7)) << 8),
				  ((*(pr_bData + 8)) << 16),
				  ((*(pr_bData + 9)) << 24));
		...
		vWriteByteHdmiGRL(TOP_GEN4_PKT04,
				  ...
				  ((*(pr_bData + 13)) << 0));
		HDMI_HDR_LOG(
			" 5 data0=0x%x, data1=0x%x, data2=0x%x, data3=0x%x\n",
				  ((*(pr_bData + 13)) << 0),
				  ((*(pr_bData + 14)) << 8),
				  (*(pr_bData + 15) << 16),
				  ((*(pr_bData + 16)) << 24));
		...
		vWriteByteHdmiGRL(TOP_GEN4_PKT06,
				  ...
				  ((*(pr_bData + 20)) << 0));
		HDMI_HDR_LOG(
			" 7 data0=0x%x, data1=0x%x, data2=0x%x, data3=0x%x\n",
				  ((*(pr_bData + 20)) << 0),
				  ((*(pr_bData + 21)) << 8),
				  (*(pr_bData + 22) << 16),
				  ((*(pr_bData + 23)) << 24));
		...
		vWriteHdmiGRLMsk(TOP_INFO_EN, GEN4_EN |
...
{
	vHalSendStaticHdrInfoFrame(_bStaticHdrStatus,
		_bHdrMetadataBuff);
}
...
void vHdrEnable(bool fgEnable)
{
	if (_u4HdrDebugDisableType & HDR_DEBUG_DISABLE_HDR)
		return;
	HDMI_PLUG_LOG(
	" fgEnable = %d, _bStaticHdrStatus =%d,  _bHdrType=%d\n",
	fgEnable,
...
void vHalEnablePacket(struct PACKET_HW_T hw, bool en)
{
	if (en) {
		vWriteHdmiGRLMsk(hw.addr_rep_en,
			hw.mask_rep_en, hw.mask_rep_en);
		vWriteHdmiGRLMsk(hw.addr_wr_en,
			hw.mask_wr_en, hw.mask_wr_en);
	} else {
...
void vHalSendPacket(struct PACKET_HW_T hw,
	unsigned char hb[3], unsigned char pb[28])
{
	unsigned char i;

	vHalEnablePacket(hw, false);
	vWriteByteHdmiGRL(hw.addr_header, (hb[2] << 16) +
		(hb[1] << 8) + (hb[0] << 0));
	for (i = 0; i < 4; i++) {
	...
	unsigned char *sequence_index, char *first, char *last)
{
	*(hb + 0) = DYNAMIC_HDR_EMP_TYPE;
	if (*size <= EMP_SIZE_FIRST) {
		...
		*last = 1;
		*sequence_index = 0;
	} else if ((EMP_SIZE_FIRST +
	(*sequence_index) * EMP_SIZE_MAX) < *size) {
		if (*sequence_index == 0)
			*first = 1;
		else
			*first = 0;
		*last = 0;
	} else if ((EMP_SIZE_FIRST + (*sequence_index) *
	EMP_SIZE_MAX) >= *size) {
		*first = 0;
		*last = 1;
	}
...
void vHalSendDynamicHdrEMPs(char bEnable,
...
void vHalSendHdr10PlusVSIF(char bEnable,
	union VID_HDR10_PLUS_METADATA_UNION_T *pr_bData)
{
	unsigned char i;
	unsigned char HB[3] = {0};
	...
	unsigned char size =
		(unsigned char)(pr_bData->hdr10p_metadata_info
		.ui4_Hdr10PlusSize & 0xff);
	unsigned char *meta =
		(unsigned char *)(unsigned long)pr_bData->hdr10p_metadata_info
		.ui4_Hdr10PlusAddr;
...
void vHdr10PlusEnable(bool fgEnable)
{
	...
	if (fgEnable) {
		HdrDelayAllOffImmediately();
		for (pkthw_index = 0; pkthw_index < GEN_PKT_HW_NUM;
		pkthw_index++)
...
void vHdr10PlusVSIF_ZeroPacket(void)
{
	...
	memset(&hdr_metadata, 0, sizeof(struct VID_PLA_HDR_METADATA_INFO_T));
...
void Hdr10pVsifPacketHandler(struct work_struct *data)
{
	if (_bHdrType == VID_PLA_DR_TYPE_HDR10_PLUS_VSIF) {
		vHalSendDolbyVSIF(FALSE, 0, 0, 0, 0);
	} else {
		HDMI_HDR_LOG("[delay]Hdr10pVsif Packet keep off\n");
	}
}
	...
	unsigned int forcedHdrType, int dolbyOpFmt)
{
	...
	if (fgEnable) {
		...
		_bHdrType = VID_PLA_DR_TYPE_HDR10_PLUS_VSIF;
		queue_delayed_work(hdmi_wq, &hdr10p_delay_work, msecs_to_jiffies(500));
	} else {
		if ((forcedHdrType > 1) && (dolbyOpFmt == 1)) {
			/* if VS10 is enabled, seamless off*/
			Hdr10pVsifOffImmediately();
		} else {
			_bStaticHdrStatus = HDR_PACKET_ZERO;
			vSendStaticHdrInfoFrame();
...
void vBT2020Enable(bool fgEnable)
{
	...
	HDMI_PLUG_LOG(" _fgBT2020Enable =%d DoVi off:%d\n",
		fgEnable, _fgVoutInVsync);
...
void vTrySendDolbyVSIF(enum HDMI_VIDEO_RESOLUTION res)
{
...
unsigned int DelayFromFPS(enum HDMI_VIDEO_RESOLUTION res)
{
	unsigned int temp = 90;

	if ((res == HDMI_VIDEO_1920x1080p_24Hz) ||
		(res == HDMI_VIDEO_1920x1080p_23Hz) ||
		(res == HDMI_VIDEO_1920x1080p3d_24Hz) ||
		(res == HDMI_VIDEO_1920x1080p3d_23Hz) ||
		(res == HDMI_VIDEO_3840x2160P_23_976HZ) ||
		(res == HDMI_VIDEO_3840x2160P_24HZ) ||
		(res == HDMI_VIDEO_4096x2160P_24HZ)) {
		temp = 90; /* 2vsync */
	} else if ((res == HDMI_VIDEO_1920x1080p_25Hz) ||
		(res == HDMI_VIDEO_3840x2160P_25HZ)) {
		temp = 80; /* 2vsync */
	} else if ((res == HDMI_VIDEO_1920x1080p_30Hz) ||
		(res == HDMI_VIDEO_1920x1080p_29Hz) ||
		(res == HDMI_VIDEO_3840x2160P_29_97HZ) ||
		(res == HDMI_VIDEO_3840x2160P_30HZ)) {
		temp = 70; /* 2vsync */
	} else if ((res == HDMI_VIDEO_720x480i_60Hz) ||
		(res == HDMI_VIDEO_720x576i_50Hz) ||
		(res == HDMI_VIDEO_720x480p_60Hz) ||
		(res == HDMI_VIDEO_720x576p_50Hz) ||
		(res == HDMI_VIDEO_1280x720p_60Hz) ||
		(res == HDMI_VIDEO_1280x720p_50Hz) ||
		(res == HDMI_VIDEO_1920x1080i_60Hz) ||
		...
		(res == HDMI_VIDEO_1920x1080i3d_60Hz) ||
		(res == HDMI_VIDEO_1920x1080i3d_50Hz) ||
		(res == HDMI_VIDEO_3840x2160P_60HZ) ||
		(res == HDMI_VIDEO_3840x2160P_50HZ) ||
		(res == HDMI_VIDEO_4096x2160P_60HZ) ||
		(res == HDMI_VIDEO_4096x2160P_50HZ) ||
		(res == HDMI_VIDEO_1280x720p_59_94Hz) ||
		(res == HDMI_VIDEO_1920x1080p_59_94Hz) ||
		(res == HDMI_VIDEO_3840x2160P_59_94HZ) ||
		(res == HDMI_VIDEO_4096x2160P_59_94HZ)) {
		temp = 40; /* 2vsync */
	}
	return temp;
}
...
void mtk_hdmi_dolby_work_handle(struct work_struct *work)
{
	...
	vHDMIVideoOutput(_stAvdAVInfo.e_resolution,
		_stAvdAVInfo.e_video_color_space);
	_fgDuringDolbyOff = FALSE;
}

unsigned int dv_start_line;
...
void vDoviHdrEnable(bool fgEnable)
{
	...
	dv_start_line = hdmi_vdout_read(0x28)  & 0xFFF;
...
void hdmi_vsync_handle(void)
{
	if (hdmi_hotplugstate == HDMI_STATE_HOT_PLUGIN_AND_POWER_ON) {
		if (_fgVoutInVsync) {
			dv_vsync_line = hdmi_vdout_read(0x28) & 0xFFF;
			vHDMIVideoOutputVsync(_stAvdAVInfo.e_resolution,
			_stAvdAVInfo.e_video_color_space);
			TX_DEF_LOG("v:%d,%d,%d\n",
				dv_start_line,
				dv_end_line,
...
void vLowLatencyDoviEnable(bool fgEnable)
{
	...
	if (fgEnable) {
		HdrDelayAllOffImmediately();
		vBT2020Enable(TRUE);
		vHalSendDolbyVSIF(TRUE, TRUE, TRUE,
			_fgBackltCtrlMDPresent, _u4EffTmaxPQ);
		vSendVendorSpecificInfoFrame(_stAvdAVInfo.e_resolution);
...
void vHalVrrEnable(bool fgEnable)
{
	...
	bData = bData & 0xFF0;
	if (fgEnable == 1) {
		bData |= (HDMI_VRR[_stAvdAVInfo.e_resolution][2] << 12);
		bData |= (RG_VRR_EN | RG_VSYNC_CAPTURE | RG_VRR_VSYNC_SW_SEL);
	}
	vWriteByteHdmiGRL(HDMI_VRR_CFG, bData);
}

void vVrrEnable(bool fgEnable)
{
	_fgVrrEnable = fgEnable;
	HDMI_HDR_LOG(
	"[HDR][VRR]%s = %d\n", __func__, _fgVrrEnable);
	vSendAVIInfoFrame(_stAvdAVInfo.e_resolution,
		_stAvdAVInfo.e_video_color_space);
	vSendVrrEMP();
	vHalVrrEnable(fgEnable);
}

void vHalSendVTEM(unsigned char *pr_bData)
{
	unsigned int u4Data;
	...
	vWriteByteHdmiGRL(TOP_GAMUT_PKT06, 0);
	vWriteByteHdmiGRL(TOP_GAMUT_PKT07, 0);
	if ((_fgQMSEnable || u4Data) &&
		((_HdmiSinkAvCap.u1_sink_qms_en == 1) ||
		(_HdmiSinkAvCap.u1_sink_cinemavrr == 1))) {
		vWriteHdmiGRLMsk(TOP_INFO_RPT,
			GAMUT_RPT_EN,
			GAMUT_RPT_EN);
		vWriteHdmiGRLMsk(TOP_INFO_EN,
			GAMUT_EN_WR | HDMI2_GAMUT_EN,
			GAMUT_EN_WR | HDMI2_GAMUT_EN);
	}
}

void vSendQMSVTEM(unsigned char _bQMSTFR, bool _fgQMSMConst)
{
	unsigned char bVrrEMPPacket[11];
	unsigned char ui1ResIdx;

	memset(&bVrrEMPPacket, 0, sizeof(bVrrEMPPacket));
	bVrrEMPPacket[0] = 0x86;
	bVrrEMPPacket[1] = 0x00;
	bVrrEMPPacket[2] = 0x01;
	bVrrEMPPacket[3] = 0x00;
	bVrrEMPPacket[4] = 0x01;
	...
	/* MD0~3 */
	if (_fgQMSEnable) {
		ui1ResIdx = _stAvdAVInfo.e_resolution;
		if (ui1ResIdx >= MAX_RES) {
			TX_DEF_LOG("unknown qms res:(0x%x)", ui1ResIdx);
			return;
		}

		bVrrEMPPacket[7] |= (0x1 << 2); //QMS_EN
		if (_fgQMSMConst)
			bVrrEMPPacket[7] |= (0x1 << 1);
		bVrrEMPPacket[8] =
			HDMI_QMS[ui1ResIdx][1];
		bVrrEMPPacket[9] =
			(HDMI_QMS[ui1ResIdx][3] >> 8) & 0x03;
		bVrrEMPPacket[9] |= (_bQMSTFR << 3);
		bVrrEMPPacket[10] =
			HDMI_QMS[ui1ResIdx][3] & 0xFF;
	}
	TX_DEF_LOG("%s %d %d %d\n", __func__, _fgQMSEnable, _bQMSTFR, _fgQMSMConst);
	vHalSendVTEM(&bVrrEMPPacket[0]);
}

void vSendCinemaVTEM(bool _fgMConst)
{
	unsigned char bVrrEMPPacket[11];
	unsigned char ui1ResIdx;
	...
	if (_fgQMSEnable) {
		ui1ResIdx = _stAvdAVInfo.e_resolution;
		if (ui1ResIdx >= MAX_RES) {
			TX_DEF_LOG("unknown cinema res:(0x%x)", ui1ResIdx);
			return;
		}

		bVrrEMPPacket[7] = 1; //VRR_EN
		if (_fgMConst)
			bVrrEMPPacket[7] |= (0x1 << 1); //M_CONST
		bVrrEMPPacket[8] =
			HDMI_QMS[ui1ResIdx][1];
		bVrrEMPPacket[9] =
			(HDMI_QMS[ui1ResIdx][3] >> 8) & 0x03;
	...
	TX_DEF_LOG("%s %d %d\n", __func__, _fgQMSEnable, _fgMConst);
	vHalSendVTEM(&bVrrEMPPacket[0]);
}

void vHalQMSEnable(bool fgEnable)
{
	unsigned int bData = 0;
	...
	bData = bReadByteHdmiGRL(HDMI_VRR_CFG);
	bData = bData & 0xFF0;
	if ((fgEnable == 1) && (_HdmiSinkAvCap.u1_sink_qms_en == 1)) {
		bData |=
			(HDMI_QMS[_stAvdAVInfo.e_resolution][2] << 12);
		bData |=
			(RG_VRR_EN | RG_VSYNC_CAPTURE | RG_VRR_VSYNC_SW_SEL);
	}
	vWriteByteHdmiGRL(HDMI_VRR_CFG, bData);
}

void vQMSEnable(bool en)
{
	if (_stAvdAVInfo.e_resolution >= MAX_RES) {
		TX_DEF_LOG("unknown res:(0x%x)", _stAvdAVInfo.e_resolution);
		return;
	...
	TX_DEF_LOG("%s: from %d to %d (%d,0x%x)(%d,%d)\n",
		__func__,
		_fgQMSEnable, en,
		HDMI_QMS[_stAvdAVInfo.e_resolution][4],
		_stAvdAVInfo.e_resolution,
		_HdmiSinkAvCap.u1_sink_qms_en,
		_HdmiSinkAvCap.u1_sink_cinemavrr);

	_fgQMSEnable = en;
	if (_HdmiSinkAvCap.u1_sink_qms_en == 1)
		vSendQMSVTEM(HDMI_QMS[_stAvdAVInfo.e_resolution][4], TRUE);
	else if (_HdmiSinkAvCap.u1_sink_cinemavrr == 1)
		vSendCinemaVTEM(TRUE);
	else
		vSendCinemaVTEM(FALSE);
	vHalQMSEnable(en);
}
...
void vQMSCB(bool en)
{
	...
	disp_hw_mgr_send_event(DISP_EVENT_VRR, &en);
#endif
}

unsigned int QMSStatus(void)
{
	if (_fgQMSEnable && (_HdmiSinkAvCap.u1_sink_qms_en == 1))
		return 2;
	else if (_fgQMSEnable && (_HdmiSinkAvCap.u1_sink_cinemavrr == 1))
		return 1;
	return 0;
}

/* if return value > 0, support QMS or cinema VRR  */
/* sel=2: check QMS, =1:check cinema  */
unsigned char QMSEDID(unsigned char sel)
{
	unsigned char qms_vrrmin = 0;

	/* check QMS */
	if (_HdmiSinkAvCap.u1_sink_qms_en == 1) {
		if (_HdmiSinkAvCap.u1_sink_qms_tfr_min == 1)
			qms_vrrmin = 24;
		else {
			if  (_HdmiSinkAvCap.u4_sink_vrr_min == 0)
				qms_vrrmin = 48;
			else
				qms_vrrmin = _HdmiSinkAvCap.u4_sink_vrr_min;
		}
		if (sel == 2)
			return qms_vrrmin;
	}
	...
	/* check cinema */
	if (sel == 1)
		return _HdmiSinkAvCap.u1_sink_cinemavrr;

	return 0;
}

void vQMSSetting(bool en, unsigned char hdmitfr, bool fgMConst)
{
	if (_stAvdAVInfo.e_resolution >= MAX_RES) {
		TX_DEF_LOG("vQMSSetting unknown res:(0x%x)", _stAvdAVInfo.e_resolution);
		return;
	}

	TX_DEF_LOG("%s (%d %d) (%d %d) %d (%d %d)\n", __func__,
		en, _fgQMSEnable,
		hdmitfr, HDMI_QMS[_stAvdAVInfo.e_resolution][4],
		fgMConst,
		_HdmiSinkAvCap.u1_sink_qms_en, _HdmiSinkAvCap.u1_sink_cinemavrr);

	_fgQMSEnable = en;
	qms_tfr = hdmitfr;
	if (_HdmiSinkAvCap.u1_sink_qms_en == 1)
		vSendQMSVTEM(hdmitfr, fgMConst);
	else if (_HdmiSinkAvCap.u1_sink_cinemavrr == 1)
		vSendCinemaVTEM(fgMConst);
	else
		vSendCinemaVTEM(FALSE);
	vHalQMSEnable(en);
}

void vMConstEnable(bool fgEnable)
{
	_fgMConstEnable = fgEnable;
	HDMI_HDR_LOG(
	"[HDR][VRR]%s = %d\n", __func__, _fgMConstEnable);
	vSendVrrEMP();
}
...
{
	_fgAllmEnable = fgEnable;
	TX_DEF_LOG(
	"[HDR][ALLM] _fgAllmEnable = %d\n", _fgAllmEnable);
	vSendHFVendorSpecificInfoFrame();
}

void v14GameModeEnable(bool fgEnable)
{
	_fg14GameModeEnable = fgEnable;
	TX_DEF_LOG(
	"[HDR][ALLM] _fg14GameModeEnable = %d\n", _fg14GameModeEnable);
	vSendAVIInfoFrame(_stAvdAVInfo.e_resolution,
		_stAvdAVInfo.e_video_color_space);
}

void vAllmStatus(void)
{
	unsigned int hfinfo1 = 0;
	unsigned int hfinfo2 = 0;

	if (_fgAllmEnable &
		_HdmiSinkAvCap.u1_sink_allm_support) {
		TX_DEF_LOG("HDMI2.1_ALLM_ENABLED\n");
		TX_DEF_LOG("HDMI1.x_GAME_MODE_DISABLED\n");
		hfinfo1 = bReadByteHdmiGRL(TOP_MPEG_PKT00);
		hfinfo2 = bReadByteHdmiGRL(TOP_MPEG_PKT01);
		TX_DEF_LOG("[allm]HF_VSIF 1: 0x%x\n",
				(hfinfo1 >> 8) & 0xff);
		TX_DEF_LOG("[allm]HF_VSIF 2: 0x%x\n",
				(hfinfo1 >> 16) & 0xff);
		TX_DEF_LOG("[allm]HF_VSIF 3: 0x%x\n",
				(hfinfo1 >> 24) & 0xff);
		TX_DEF_LOG("[allm]HF_VSIF 4: 0x%x\n",
				hfinfo2 & 0xff);
		TX_DEF_LOG("[allm]HF_VSIF 5: 0x%x\n",
				(hfinfo2 >> 8) & 0xff);
	} else if (_fg14GameModeEnable &&
		_HdmiSinkAvCap.u1_sink_14gamemode_support &&
		(!_HdmiSinkAvCap.u1_sink_allm_support)) {
		TX_DEF_LOG("HDMI1.x_GAME_MODE_ENABLED\n");
		TX_DEF_LOG("HDMI2.1_ALLM_DISABLED\n");
		TX_DEF_LOG("[allm]AVI_IF 1: 0x%x\n",
				_bAviInfoFm[0]);
		TX_DEF_LOG("[allm]AVI_IF 2: 0x%x\n",
				_bAviInfoFm[1]);
		TX_DEF_LOG("[allm]AVI_IF 3: 0x%x\n",
				_bAviInfoFm[2]);
		TX_DEF_LOG("[allm]AVI_IF 4: 0x%x\n",
				_bAviInfoFm[3]);
		TX_DEF_LOG("[allm]AVI_IF 5: 0x%x\n",
				_bAviInfoFm[4]);
	} else
		TX_DEF_LOG("HDMI1.x_LATENCY_MODE_UNKNOWN\n");
}
	...
	struct VID_PLA_HDR_METADATA_INFO_T hdr_metadata)
{
	...
	== VID_PLA_DR_TYPE_DOVI_LOWLATENCY) {
		if ((_fgBackltCtrlMDPresent ==
			 hdr_metadata
		.metadata_info
		.dovi_lowlatency_metadata.fgBackltCtrlMdPresent)
			&& (_u4EffTmaxPQ ==
			 hdr_metadata
			.metadata_info
			.dovi_lowlatency_metadata.ui4_EffTmaxPQ)) {
			fgMetadataSame = TRUE;
		} else {
			_fgBackltCtrlMDPresent  =
				 hdr_metadata
			.metadata_info.dovi_lowlatency_metadata
			.fgBackltCtrlMdPresent;
			if (_fgBackltCtrlMDPresent)
				_u4EffTmaxPQ =
				hdr_metadata
			.metadata_info.dovi_lowlatency_metadata.ui4_EffTmaxPQ;
			else
				_u4EffTmaxPQ = 0;
	...
	VID_PLA_DR_TYPE_DOVI_VSEM) {
		...
		RG_HDMITX21_DRV_EN) {
			...
			TX_DEF_LOG("%s, delay emp dure to tmds off, %lu\n",
				__func__,
...
{
	enum VID_PLA_DR_TYPE_T status = 0;
	int len;

	switch (_bHdrType) {
	case VID_PLA_DR_TYPE_SDR:
		status = VID_PLA_DR_TYPE_SDR;
		len = sprintf(str, "%s", "SDR");
		if (len <= 0)
	...
	case VID_PLA_DR_TYPE_DOVI_LOWLATENCY:
		...
		len = sprintf(str, "%s", "DoVi-Lowlatency");
		if (len <= 0)
			TX_DEF_LOG("%d %s sprintf len err, %d\n",
			__LINE__, __func__, len);
		break;
	case VID_PLA_DR_TYPE_HDR10:
		...
		if (_bStaticHdrType == GAMMA_HLG) {
			len = sprintf(str, "%s", "HDR10-GAMMA_HLG");
			if (len <= 0)
				TX_DEF_LOG("%d %s sprintf len err, %d\n",
				__LINE__, __func__, len);
		} else if (_bStaticHdrType == GAMMA_ST2084) {
			len = sprintf(str, "%s", "HDR10-GAMMA_ST2084");
			if (len <= 0)
				TX_DEF_LOG("%d %s sprintf len err, %d\n",
				__LINE__, __func__, len);
		} else {
			len = sprintf(str, "%s", "HDR10-others");
			if (len <= 0)
				TX_DEF_LOG("%d %s sprintf len err, %d\n",
				__LINE__, __func__, len);
		}
	...
	case VID_PLA_DR_TYPE_HDR10_PLUS:
		...
		len = sprintf(str, "%s", "HDR10Plus-EMP");
		if (len <= 0)
			TX_DEF_LOG("%d %s sprintf len err, %d\n",
			__LINE__, __func__, len);
		break;
	case VID_PLA_DR_TYPE_HDR10_PLUS_VSIF:
		...
		if (hdr10p_vsif_application_version == 0x0) {
			len = sprintf(str, "%s", "HDR10Plus-V0-VSIF");
			if (len <= 0)
				TX_DEF_LOG("%d %s sprintf len err, %d\n",
				__LINE__, __func__, len);
		} else if (hdr10p_vsif_application_version == 0x1) {
			len = sprintf(str, "%s", "HDR10Plus-V1-VSIF");
			if (len <= 0)
				TX_DEF_LOG("%d %s sprintf len err, %d\n",
				__LINE__, __func__, len);
		} else {
			len = sprintf(str, "%s",
			"HDR10Plus-VSIF with wrong application version");
			if (len <= 0)
				TX_DEF_LOG("%d %s sprintf len err, %d\n",
				__LINE__, __func__, len);
		}
		break;
	default:
		len = sprintf(str, "%s", "Error HDR type");
		if (len <= 0)
			TX_DEF_LOG("%d %s sprintf len err, %d\n",
			__LINE__, __func__, len);
...
{
	HDMI_PLUG_LOG("_fgVrrEnable = %d\n", _fgVrrEnable);
	HDMI_PLUG_LOG("_fgMConstEnable = %d\n", _fgMConstEnable);
	HDMI_PLUG_LOG("_fgAllmEnable = %d\n", _fgAllmEnable);
	HDMI_PLUG_LOG("low_latency_io_mode = %d\n", low_latency_io_mode);
	HDMI_PLUG_LOG("low_latency_disp_en = %d\n", low_latency_disp_en);
}

void vshow_audio_status(void)
{
	HDMI_AUDIO_LOG(
		"0x400 = 0x%x; 0x404 = 0x%x; 0x408 = 0x%x\n",
		bReadByteHdmiGRL(AIP_CTRL),
		bReadByteHdmiGRL(AIP_N_VAL),
		bReadByteHdmiGRL(AIP_CTS_SVAL));
	HDMI_AUDIO_LOG(
		"0x414 = 0x%x; 0x418 = 0x%x; 0x424 = 0x%x\n",
		bReadByteHdmiGRL(AIP_I2S_CHST0),
		bReadByteHdmiGRL(AIP_I2S_CHST1),
		bReadByteHdmiGRL(AIP_TXCTRL));
	HDMI_AUDIO_LOG("0x430 = 0x%x; 0x434 = 0x%x\n",
...
void vcommon_status(char *str)
{
	...
	if (_stAvdAVInfo.e_resolution < HDMI_VIDEO_RESOLUTION_NUM &&
		...
		len = sprintf(str, "%s\n%s\n%s\n\n",
		HDMI_RES_STR(_stAvdAVInfo.e_resolution),
	HDMI_DEEP_COLOR_STR(_stAvdAVInfo.e_deep_color_bit),
		HDMI_COLOR_SPACE_STR(_stAvdAVInfo.e_video_color_space));
		if (len <= 0)
			TX_DEF_LOG("%d %s sprintf len err, %d\n",
			__LINE__, __func__, len);
	}
...
unsigned int hdmi_clock_read(unsigned char sel)
{
	...
	if (sel == 0) {
		...
		vWriteHdmiGRLMsk(HDMI_PLLMETER_TRIGGER, 0,
			HDMI_PLL_FREQ_TRGGIER);
		vWriteHdmiGRLMsk(HDMI_PLLMETER,
			HDMI_PLLMETER_ENABLE, HDMI_PLLMETER_ENABLE);
	} else if (sel == 1)
		temp = bReadByteHdmiGRL(HDMI_PLLMETER) >> 16;
	else if (sel == 2)
		vWriteHdmiGRLMsk(HDMI_PLLMETER_TRIGGER,
		HDMI_PLL_FREQ_TRGGIER, HDMI_PLL_FREQ_TRGGIER);

	return temp;
}

void hdmi_480p_pattern(void)
{
	vWriteHdmiGRLMsk(TOP_CFG00, ABIST_VIDEO_FORMAT_720x480P,
		ABIST_VIDEO_FORMAT_MASKBIT);
	//vWriteHdmiGRLMsk(TOP_CFG00, ABIST_DATA_FORMAT_0x11,
	//	ABIST_DATA_FORMAT_0x11);
	vWriteHdmiGRLMsk(TOP_CFG00, 0,	ABIST_VSYNC_POL_HIGH);
	vWriteHdmiGRLMsk(TOP_CFG00, 0,	ABIST_HSYNC_POL_HIGH);
	vWriteHdmiGRLMsk(TOP_CFG00, (1 << 30), (1 << 30));
	vWriteHdmiGRLMsk(TOP_CFG00, ABIST_ENABLE, ABIST_ENABLE);
}

void hdmi_1080p_pattern(void)
{
	vWriteHdmiGRLMsk(TOP_CFG00, ABIST_VIDEO_FORMAT_1080P60,
		ABIST_VIDEO_FORMAT_MASKBIT);
	//vWriteHdmiGRLMsk(TOP_CFG00, ABIST_DATA_FORMAT_0x11,
	//	ABIST_DATA_FORMAT_0x11);
	vWriteHdmiGRLMsk(TOP_CFG00, ABIST_VSYNC_POL_HIGH, ABIST_VSYNC_POL_HIGH);
	vWriteHdmiGRLMsk(TOP_CFG00, ABIST_HSYNC_POL_HIGH, ABIST_HSYNC_POL_HIGH);
	vWriteHdmiGRLMsk(TOP_CFG00, (1 << 30), (1 << 30));
	vWriteHdmiGRLMsk(TOP_CFG00, ABIST_ENABLE, ABIST_ENABLE);
}
