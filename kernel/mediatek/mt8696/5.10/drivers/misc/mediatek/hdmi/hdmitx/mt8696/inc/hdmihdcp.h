...
extern struct HDMI_AV_INFO_T *_prAvdAVInfo;
...
extern unsigned char HDMI_AKSV[5];
...
extern void vSetSharedInfo(unsigned int u4Index,
	unsigned int i4Value);
...
extern void notify_hpd_to_hdcp(unsigned char hpd);
