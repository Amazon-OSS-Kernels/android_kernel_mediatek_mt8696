...
enum FMT_SOF_TYPE {
	...
	FMT_SOF_6_M_HDR_FE_STA,		/*12*/
	FMT_SOF_6_M_HDR_FE_END,		/*13*/
...
void _fmt_set_vrr_trigger_start_line_and_vrr_mode
	(uint32_t trigger_start_line, bool vrr_mode_enable);
