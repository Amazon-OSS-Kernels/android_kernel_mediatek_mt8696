 ...
 ***********************************************************************/
/*for vdout fmt*/
#define VDOUT_FMT_REG_VRR_TRIGGER_ACTIVE 0x8c
...
#define VDOUT_FMT_REG_FMT_VTOTAL_EXT 0xD8
#define VDOUT_FMT_REG_FMT_VRR_TRIG_START_LINE 0xDC
...
#define DISP_FMT_REG_LINE_CNT_DEBUG 0xBC
...
#define DISP_FMT_REG_VTOTAL_HIGH 0x300

/*for sof fmt*/
#define DISP_FMT_REG_GRP0_SHADOW_ENABLE 0x1f0
#define DISP_FMT_REG_GRP0_SHADOW_UPDATE 0x1f4
#define DISP_FMT_REG_GRP0_BASE_E0 0x1E0
#define DISP_FMT_REG_GRP0_BASE_E4 0x1E4
#define DISP_FMT_REG_GRP1_SHADOW_ENABLE 0x2f0
#define DISP_FMT_REG_GRP1_SHADOW_UPDATE 0x2f4
#define DISP_FMT_REG_GRP1_BASE_E0 0x2E0
#define DISP_FMT_REG_GRP1_BASE_E4 0x2E4
#define DISP_FMT_REG_0_M_VDO_MAIN_STA 0x100
#define DISP_FMT_REG_0_M_VDO_MAIN_END 0x104
#define DISP_FMT_REG_1_M_VDO_AUX_STA 0x108
#define DISP_FMT_REG_1_M_VDO_AUX_END 0x10c
#define DISP_FMT_REG_2_M_FE_FIFO_STA 0x110
#define DISP_FMT_REG_2_M_FE_FIFO_END 0x114
#define DISP_FMT_REG_3_STA 0x118
#define DISP_FMT_REG_3_END 0x11c
#define DISP_FMT_REG_4_M_FILM_GRAIN_1_STA 0x120
#define DISP_FMT_REG_4_M_FILM_GRAIN_1_END 0x124
#define DISP_FMT_REG_5_M_FILM_GRAIN_2_STA 0x128
#define DISP_FMT_REG_5_M_FILM_GRAIN_2_END 0x12C
#define DISP_FMT_REG_6_M_HDR_FE_STA 0x130
#define DISP_FMT_REG_6_M_HDR_FE_END 0x134
#define DISP_FMT_REG_7_S_VDO_MAIN_STA 0x138
#define DISP_FMT_REG_7_S_VDO_MAIN_END 0x13C
#define DISP_FMT_REG_8_S_VDO_AUX_STA 0x140
#define DISP_FMT_REG_8_S_VDO_AUX_END 0x144
#define DISP_FMT_REG_9_S_FE_FIFO_STA 0x148
#define DISP_FMT_REG_9_S_FE_FIFO_END 0x14C
#define DISP_FMT_REG_10_S_FILM_GRAIN_0_STA 0x150
#define DISP_FMT_REG_10_S_FILM_GRAIN_0_END 0x154
#define DISP_FMT_REG_11_S_FILM_GRAIN_1_STA 0x158
#define DISP_FMT_REG_11_S_FILM_GRAIN_1_END 0x15C
#define DISP_FMT_REG_12_S_FILM_GRAIN_2_STA 0x160
#define DISP_FMT_REG_12_S_FILM_GRAIN_2_END 0x164
#define DISP_FMT_REG_13_S_HDR_FE_STA 0x168
#define DISP_FMT_REG_13_S_HDR_FE_END 0x16C
#define DISP_FMT_REG_14_UHD_OSD_STA 0x170
#define DISP_FMT_REG_14_UHD_OSD_END 0x174
#define DISP_FMT_REG_15_UHD_FE_FIFO_STA 0x178
#define DISP_FMT_REG_15_UHD_FE_FIFO_END 0x17C
#define DISP_FMT_REG_16_UHD_HDR_FE_STA 0x200
#define DISP_FMT_REG_16_UHD_HDR_FE_END 0x204
#define DISP_FMT_REG_17_FHD_OSD_STA 0x208
#define DISP_FMT_REG_17_FHD_OSD_END 0x20C
#define DISP_FMT_REG_18_FHD_FE_FIFO_STA 0x210
#define DISP_FMT_REG_18_FHD_FE_FIFO_END 0x214
#define DISP_FMT_REG_19_FHD_HDR_FE_STA 0x218
#define DISP_FMT_REG_19_FHD_HDR_FE_END 0x21C
#define DISP_FMT_REG_20_DISP_MIX_STA 0x220
#define DISP_FMT_REG_20_DISP_MIX_END 0x224
#define DISP_FMT_REG_21_HDR_BE_STA 0x228
#define DISP_FMT_REG_21_HDR_BE_END 0x22C
#define DISP_FMT_REG_22_BE_FIFO_STA 0x230
#define DISP_FMT_REG_22_BE_FIFO_END 0x234
#define DISP_FMT_REG_23_DISP_MUNULOAD_STA 0x238
#define DISP_FMT_REG_23_DISP_MUNULOAD_END 0x23C
#define DISP_FMT_REG_24_MMSYS_MUNULOAD_STA 0x240
#define DISP_FMT_REG_24_MMSYS_MUNULOAD_END 0x244
#define DISP_FMT_REG_25_VIDEO_MARK_STA 0x248
#define DISP_FMT_REG_25_VIDEO_MARK_END 0x24C
#define DISP_FMT_REG_26_R2R_STA 0x250
#define DISP_FMT_REG_26_R2R_END 0x254
#define DISP_FMT_REG_27_M_FILM_GRAIN_3_STA 0x258
#define DISP_FMT_REG_27_M_FILM_GRAIN_3_END 0x25C
#define DISP_FMT_REG_28_M_FILM_GRAIN_4_STA 0x260
#define DISP_FMT_REG_28_M_FILM_GRAIN_4_END 0x264
#define DISP_FMT_REG_29_S_FILM_GRAIN_3_STA 0x268
#define DISP_FMT_REG_29_S_FILM_GRAIN_3_END 0x26C
#define DISP_FMT_REG_30_S_FILM_GRAIN_4_STA 0x270
#define DISP_FMT_REG_30_S_FILM_GRAIN_4_END 0x274
#define DISP_FMT_REG_FMT_SOF_31_STA 0x278
#define DISP_FMT_REG_FMT_SOF_31_END 0x27C
...
struct disp_fmt_field_t {
	...
	/* horizontal shift of output hsync relative to input vsync */
	uint32_t u4ASYNC_HSYN_DELAY : 12;
uint32_t: 4;
	/* vertical shift of output vsync relative to input vsync */
	uint32_t u4ASYNC_VSYN_DELAY : 12;
	uint32_t fgASYNC_ADJ_FORWARD : 1;
uint32_t: 3;

	/* DWORD - 044 */
	/* Horizontal Active Zone */
	/* Pixel position of the end of horizontal active area */
	uint32_t u4ASYNC_VDO_HACTEND : 13;
uint32_t: 3;
	/* Pixel position of the beginning of horizontal active area */
	uint32_t u4ASYNC_VDO_HACTBGN : 13;
uint32_t: 2;
	/* HD/SD scale up to 4K ASYNC mode enable*/
	uint32_t fgASYNC_MODE_EN : 1;
...
uint32_t: 5;
	...
	uint32_t
		fgHD_ON : 1; /* [14] 1:HD mode(1080i/720p),0:SD mode(480/576) */
...
uint32_t: 3;
	...
	/* [31:30] TV mode selection 00 NTSC 01 PAL_N 10 PAL_M 11 PAL_BDGHI */
	uint32_t u1TVMODE : 2;
...
uint32_t: 14;
	...
	/* 2'b00:2, 2'b01:4, 2'b10:6, 2'b11:8 */
	uint32_t POST_SCL_PRE_DATA_NEXT_LUMA_Y_OPTION : 1;
...
uint32_t: 2;
	...
	uint32_t V_TOTAL_EXT : 20;
uint32_t: 11;
	uint32_t V_TOTAL_EXT_USE_NEW : 1;

	/* DWORD - 0DC */
	uint32_t VRR_TRIGGER_STATRT_LINE : 20;
uint32_t: 11;
	uint32_t VRR_MODE : 1;
