...
/* #define vWriteP2I(dAddr, dVal)  */
/*WriteREG32(((uint64_t)(P2I_SYS_BASE+dAddr)), dVal) */
/* #define dReadP2I(dAddr)        ReadREG32(((uint64_t)(P2I_SYS_BASE+dAddr))) */
/* #define vWriteP2IMsk(dAddr, dVal, dMsk) vWriteP2I((dAddr), */
/*(dReadP2I(dAddr) & (~(dMsk))) | ((dVal) & (dMsk))) */

#define P2I_ERR(fmt, arg...)  pr_info("[P2I] error:"fmt, ##arg)
#define P2I_WARN(fmt, arg...)  pr_info("[P2I]:"fmt, ##arg)
