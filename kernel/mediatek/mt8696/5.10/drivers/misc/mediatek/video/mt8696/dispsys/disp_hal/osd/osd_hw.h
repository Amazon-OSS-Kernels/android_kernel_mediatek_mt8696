...
#define OSD_CORE_REG_NUM 63
#define OSD_CORE_COMMON_REG_NUM 4
...
#define IO_OSD_WRITE32(base, offset, value)                                    \
	OSD_HAL_WRITE32((base) + (offset), (value))
...
struct OSD_BASE_FIELD_T {
	...
	UINT32 fgFrameStartEvent : 1;
	UINT32 fgFrameEndEvent : 1;
	UINT32 fgActiveStartEvent : 1;
	UINT32 fgActiveEndEvent : 1;
	...
	UINT32 rg_screen_de_sel : 1;
	UINT32 u4HsWidthMain : 9;
	UINT32 fgBigTiming:1;

	/* DWORD - 010 OSD_FMT_10 */
	UINT32 u4ScrnHStartOsd : 10;
	UINT32:6;
	UINT32:10;
	UINT32:6;
	...
	UINT32 u4OsdVStart : 12;
	UINT32:4;
	UINT32 u4OsdHStart : 12;
	UINT32:4;
	...
	UINT32 u4Value0ColorCh0 : 8;
	UINT32 u4Value0ColorCh1 : 8;
	UINT32 u4Value0ColorCh2 : 8;
	UINT32 u4Value0ColorCh3 : 8;

	/* DWORD - 03C OSD_FMT_3C */
	UINT32 u4Value1ColorCh0 : 8;
	UINT32 u4Value1ColorCh1 : 8;
	UINT32 u4Value1ColorCh2 : 8;
	UINT32 u4Value1ColorCh3 : 8;
	...
	UINT32 osd_enable_shadow_update : 1;
	UINT32 osd_big_timing_update : 1;
	UINT32 osd_pvric_update : 1;
	UINT32 osd_burst8_update : 1;
	UINT32:24;
	...
	UINT32 u4OsdCheckSum : 32;

	/* DWORD - 084 OSD_FMT_84 */
	UINT32 u4OsdScCheckSum : 32;
	...
	UINT32 rg_frame_end_h : 13;
	UINT32:3;
	UINT32 rg_frame_end_v : 16;

	/*DWORD - 0D0 OSD_FMT_D0 */
	UINT32:8;
	UINT32 rg_de_cnt_sel : 1;
	UINT32:18;
...
struct OSD_PLA_CORE_FIELD_T {
	...
	UINT32 u4FbdcHeaderStartAddr : 32;
	/* DWORD - 0C4  OSD_PLA_0C4*/
	UINT32 u4FbdcHeaderSrcPitch : 16;
	UINT32 u4FbdcHeaderStartAddrLsb : 1;
	UINT32 u4FbdcHeaderSrcPitchLsb : 1;
	UINT32:14;
	...
	UINT32 u4SyncThres_H :20;
	/* DWORD - 0e8  OSD_PLA_0E8*/
	UINT32:32;
	/* DWORD - 0ec  OSD_PLA_0EC*/
	UINT32:32;

	/* DWORD - 0f0  OSD_PLA_0f0*/
	UINT32:32;
	/* DWORD - 0f4  OSD_PLA_0f4*/
	UINT32:32;
	/* DWORD - 0f8  OSD_PLA_0f8*/
	UINT32:32;
	/* DWORD - 0fc  OSD_PLA_0fc*/
	UINT32:32;
};

struct OSD_PLA_CORE_AUTO_FLP_FIELD_T {
...
struct OSD_PLA_CORE_PLT_FIELD_T {
	UINT32 u4PLT01 : 32;
	UINT32 u4PLT02 : 32;
	UINT32 u4PLT03 : 32;
	UINT32 u4PLT04 : 32;
...
union OSD_BASE_UNION_T {
	...
	struct OSD_BASE_FIELD_T rField;
};

union OSD_PLA_CORE_UNION_T {
	UINT32 au4Reg[OSD_CORE_REG_NUM];
	struct OSD_PLA_CORE_FIELD_T rField;
};

union OSD_PLA_CORE_AUTO_FLP_UNION_T {
	UINT32 au4Reg[13];
	struct OSD_PLA_CORE_AUTO_FLP_FIELD_T rField;
};

union OSD_PLA_CORE_PLT_UNION_T {
	UINT32 au4Reg[16];
	struct OSD_PLA_CORE_PLT_FIELD_T rField;
};

union OSD_SC_UNION_T {
	UINT32 au4Reg[OSD_SC_REG_NUM];
	struct OSD_SC_FIELD_T rField;
};

union OSD_RGN_UNION_T {
	UINT32 au4Reg[12];
	struct OSD_RGN_FIELD_T rField;
};
...
extern INT32 _OSD_BASE_GetOsdPrgs(unsigned int u4Plane, UINT32 *pu4Value);
extern INT32 _OSD_BASE_SetOsdFrameEndEvent(
	unsigned int u4Plane,
	UINT32 u4Value);
extern INT32 _OSD_BASE_GetOsdFrameEndEvent(
	unsigned int u4Plane,
	UINT32 *pu4Value);
extern INT32 _OSD_BASE_SetOsdActiveEndEvent(
	unsigned int u4Plane,
	UINT32 u4Value);
extern INT32 _OSD_BASE_GetOsdActiveEndEvent(
	unsigned int u4Plane,
	UINT32 *pu4Value);
...
extern INT32 _OSD_BASE_GetScrnHStartOsd(unsigned int u4Plane,
					 UINT32 *pu4Value);

/* 18h Main FMT V-Timing Configuration Register #1 */
extern INT32 _OSD_BASE_GetScrnVStartBotMain(unsigned int u4Plane,
					    UINT32 *pu4Value);
extern INT32 _OSD_BASE_GetScrnVStartTopMain(unsigned int u4Plane,
					    UINT32 *pu4Value);
...
/* 24h OSD Window Position Configuration Register  */
extern INT32 _OSD_BASE_GetOsdVStart(unsigned int u4Plane, UINT32 *pu4Value);
extern INT32 _OSD_BASE_GetOsdHStart(unsigned int u4Plane, UINT32 *pu4Value);

/* 38h Pvric src data set black value color */
extern INT32 _OSD_BASE_SetPvricValue0ColorCh3(
	unsigned int u4Plane, UINT32 u4Value);
extern INT32 _OSD_BASE_GetPvricValue0ColorCh3(
	unsigned int u4Plane, UINT32 u4Value);
...
extern INT32 _OSD_BASE_SetOsdPrgs(unsigned int u4Plane, UINT32 u4Value);
...
extern INT32 _OSD_BASE_SetBigTiming(unsigned int u4Plane, bool u4Value);
extern INT32 _OSD_BASE_GetBigTiming(unsigned int u4Plane, bool *pu4Value);

/* 10h FMT H-Timing Configuration Register#1 */
extern INT32 _OSD_BASE_SetScrnHStartOsd(unsigned int u4Plane, UINT32 u4Value);

/* 18h Main FMT V-Timing Configuration Register #1 */
extern INT32 _OSD_BASE_SetScrnVStartBotMain(unsigned int u4Plane,
					    UINT32 u4Value);
extern INT32 _OSD_BASE_SetScrnVStartTopMain(unsigned int u4Plane,
					    UINT32 u4Value);
/* 1Ch Main FMT Timing Configuration Register #2 */
...
/* 24h OSD Window Position Configuration Register  */
extern INT32 _OSD_BASE_SetOsdVStart(unsigned int u4Plane, UINT32 u4Value);
extern INT32 _OSD_BASE_SetOsdHStart(unsigned int u4Plane, UINT32 u4Value);
...
extern INT32 _OSD_BASE_GetOsdChkSum(unsigned int u4Plane, UINT32 *pu4Value);
extern INT32 _OSD_BASE_GetOsdScChkSum(unsigned int u4Plane, UINT32 *pu4Value);
extern INT32 _OSD_BASE_SetFrameEndEventValueV(
	unsigned int u4Plane, UINT32 u4Value);

extern INT32 _OSD_BASE_GetFrameEndEventValueV
	(unsigned int u4Plane, UINT32 *pu4Value);

extern INT32 _OSD_BASE_SetFrameEndEventValueH(
	unsigned int u4Plane, UINT32 u4Value);

extern INT32 _OSD_BASE_GetFrameEndEventValueH
	(unsigned int u4Plane, UINT32 *pu4Value);
extern void osd_plane_set_burst8_update(
	unsigned int u4Plane, UINT32 u4Value);
extern int osd_plane_get_burst8_update(
	unsigned int u4Plane, UINT32 *pu4Value);
extern void osd_plane_set_pvric_update(
	unsigned int u4Plane, UINT32 u4Value);
extern int osd_plane_get_pvric_update(
	unsigned int u4Plane, UINT32 *pu4Value);
extern void osd_base_set_big_timing_update(
	unsigned int u4Plane, UINT32 u4Value);
extern int osd_base_get_big_timing_update(
	unsigned int u4Plane, UINT32 *pu4Value);
extern void osd_plane_set_faker_header_update(
	unsigned int u4Plane, UINT32 u4Value);
extern int osd_plane_get_faker_header_update(
	unsigned int u4Plane, UINT32 *pu4Value);
...
extern void _OSD_PLA_GET_REG_BASE(
	uintptr_t *osd_pln_base_reg,
	phys_addr_t *osd_pln_base_reg_pa);
...
extern INT32 _OSD_PLA_Update(UINT32 u4Plane, struct cmdq_pkt *pkt);
extern INT32 osd_pla_non_shadow_update(UINT32 u4Plane);
extern INT32 osd_plane_update_extend(
				UINT32 u4Plane,
				struct cmdq_pkt *pkt);
extern INT32 osd_plane_update_faker_header(
	UINT32 u4Plane, struct cmdq_pkt *pkt);
extern INT32 osd_plane_update_pvric(
	UINT32 u4Plane, struct cmdq_pkt *pkt);
extern INT32 osd_plane_update_index(
	UINT32 u4Plane,
	struct cmdq_pkt *pkt,
	UINT32 u4Idx);
...
extern INT32 _OSD_PLA_SetPreMulti(UINT32 u4Plane, UINT32 u4Value);
extern INT32 _OSD_PLA_GetPreMulti(UINT32 u4Plane, UINT32 *pu4Value);
...
extern void osd_plane_set_sync_threshold_update(unsigned int u4Plane,
						UINT32 u4Value);
extern int osd_plane_get_sync_threshold_update(unsigned int u4Plane,
					       UINT32 *pu4Value);
extern int osd_pla_set_auto_ultra(UINT32 u4Plane, UINT32 u4Value);

extern int osd_pla_set_fbdc_header_start_addr(UINT32 u4Plane, UINT32 u4Value);
extern int osd_pla_set_fbdc_header_src_pitch(UINT32 u4Plane, UINT32 u4Value);

/* scaler register relative functions */
extern void _OSD_SC_GET_REG_BASE(
...
extern INT32 _OSD_SC_UpdateHwReg(
				UINT32 u4Scaler,
				struct cmdq_pkt *pkt);
extern INT32 _OSD_SC_Update(UINT32 u4Scaler, struct cmdq_pkt *pkt);
...
extern INT32 _OSD_RGN_SetFbdcEnable(
	UINT32 u4Region, uint32_t index, UINT32 u4Value);
extern INT32 _OSD_RGN_GetFbdcEnable(
	UINT32 u4Region, uint32_t index, UINT32 *pu4Value);
extern INT32 _OSD_RGN_SetPixelFormat(
	UINT32 u4Region, uint32_t index, UINT32 u4Value);
extern INT32 _OSD_RGN_GetPixelFormat(UINT32 u4Region, uint32_t index,
			       UINT32 *pu4Value);

extern INT32 _OSD_RGN_SetNextRegion(UINT32 u4Region, uint32_t index,
				    UINT32 u4Value);
extern INT32 _OSD_RGN_SetFifoEx(UINT32 u4Region, uint32_t index,
				UINT32 u4Value);
extern INT32 _OSD_RGN_SetNextEnable(UINT32 u4Region, uint32_t index,
				    UINT32 u4Value);
extern INT32 _OSD_RGN_SetColorMode(UINT32 u4Region, uint32_t index,
				   UINT32 u4Value);
extern INT32 _OSD_RGN_SetDataAddr(UINT32 u4Region, uint32_t index,
				  UINT32 u4Value);
...
extern INT32 _OSD_RGN_SetLineSize8(UINT32 u4Region, uint32_t index,
				   UINT32 u4Value);
...
extern INT32 _OSD_RGN_SetInputWidth(UINT32 u4Region, uint32_t index,
				    UINT32 u4Value);
extern INT32 _OSD_RGN_SetInputHeight(UINT32 u4Region, uint32_t index,
				     UINT32 u4Value);
extern INT32 _OSD_RGN_SetLineSize(UINT32 u4Region, uint32_t index,
				  UINT32 u4Value);
...
extern INT32 _OSD_RGN_SetOutputHeight(UINT32 u4Region, uint32_t index,
				      UINT32 u4Value);
extern INT32 _OSD_RGN_SetOutputPosY(UINT32 u4Region, uint32_t index,
				    UINT32 u4Value);
extern INT32 _OSD_RGN_SetOutputWidth(UINT32 u4Region, uint32_t index,
				     UINT32 u4Value);
extern INT32 _OSD_RGN_SetOutputPosX(UINT32 u4Region, uint32_t index,
				    UINT32 u4Value);
extern INT32 _OSD_RGN_SetDataAddrHI(UINT32 u4Region, uint32_t index,
				    UINT32 u4Value);
extern INT32 _OSD_RGN_SetColorKeyEnable(UINT32 u4Region, uint32_t index,
					UINT32 u4Value);
extern INT32 _OSD_RGN_SetColorKey(UINT32 u4Region, uint32_t index,
				  UINT32 u4Value);
extern INT32 _OSD_RGN_SetFrameMode(UINT32 u4Region, uint32_t index,
				   UINT32 u4Value);
extern INT32 _OSD_RGN_SetAutoMode(UINT32 u4Region, uint32_t index,
				  UINT32 u4Value);
extern INT32 _OSD_RGN_SetTopField(UINT32 u4Region, uint32_t index,
				  UINT32 u4Value);
extern INT32 _OSD_RGN_SetBlendMode(UINT32 u4Region, uint32_t index,
				   UINT32 u4Value);
extern INT32 _OSD_RGN_SetSelectByteEn(UINT32 u4Region, uint32_t index,
				      UINT32 u4Value);
extern INT32 _OSD_RGN_SetMixSel(UINT32 u4Region, uint32_t index,
				UINT32 u4Value);

extern INT32 _OSD_RGN_GetNextRegion(UINT32 u4Region, uint32_t index,
				    UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetFifoEx(UINT32 u4Region, uint32_t index,
				UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetNextEnable(UINT32 u4Region, uint32_t index,
				    UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetColorMode(UINT32 u4Region, uint32_t index,
				   UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetDataAddr(UINT32 u4Region, uint32_t index,
				  UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetAlpha(UINT32 u4Region, uint32_t index,
			       UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetHClip(UINT32 u4Region, uint32_t index,
			       UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetVClip(UINT32 u4Region, uint32_t index,
			       UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetLineSize8(UINT32 u4Region, uint32_t index,
				   UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetVbSel(UINT32 u4Region, uint32_t index,
			       UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetUgSel(UINT32 u4Region, uint32_t index,
			       UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetYrSel(UINT32 u4Region, uint32_t index,
			       UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetASel(UINT32 u4Region, uint32_t index,
			      UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetInputWidth(UINT32 u4Region, uint32_t index,
				    UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetInputHeight(UINT32 u4Region, uint32_t index,
				     UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetLineSize(UINT32 u4Region, uint32_t index,
				  UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetHStep(UINT32 u4Region, uint32_t index,
			       UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetVStep(UINT32 u4Region, uint32_t index,
			       UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetOutputHeight(UINT32 u4Region, uint32_t index,
				      UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetOutputPosY(UINT32 u4Region, uint32_t index,
				    UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetOutputWidth(UINT32 u4Region, uint32_t index,
				     UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetOutputPosX(UINT32 u4Region, uint32_t index,
				    UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetColorKeyEnable(UINT32 u4Region, uint32_t index,
					UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetColorKey(UINT32 u4Region, uint32_t index,
				  UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetFrameMode(UINT32 u4Region, uint32_t index,
				   UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetAutoMode(UINT32 u4Region, uint32_t index,
				  UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetTopField(UINT32 u4Region, uint32_t index,
				  UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetBlendMode(UINT32 u4Region, uint32_t index,
				   UINT32 *pu4Value);
extern INT32 _OSD_RGN_GetSelectByteEn(UINT32 u4Region, uint32_t index,
				      UINT32 *pu4Value);

extern union OSD_RGN_UNION_T *OSD_RGN_GetAdd(UINT32 u4Region);
extern INT32 _OSD_RGN_GetAddress(UINT32 u4Region, uint32_t index,
				 UINT32 *pu4Addr);
extern INT32 _OSD_RGN_GetColorMode(UINT32 u4Region, uint32_t index,
				   UINT32 *pu4Value);
...
extern int osd_pla_set_faker_header_register(UINT32 u4Plane,
