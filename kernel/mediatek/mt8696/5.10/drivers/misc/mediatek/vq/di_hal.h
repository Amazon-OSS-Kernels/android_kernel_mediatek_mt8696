...
struct di_info {
	uintptr_t mmsys_config_reg_base;	/* 0x14000000 */
	uintptr_t vdout_sys_reg_base;		/* 0x14001500 */
	uintptr_t disp_top_reg_base;		/* 0x15000000 */
	uintptr_t dispfmt_reg_base;		/* 0x1500e000 */
	uintptr_t vdo_reg_base;			/* 0x1500e000 */
	uintptr_t wch_reg_base;			/* 0x1500f000 */
