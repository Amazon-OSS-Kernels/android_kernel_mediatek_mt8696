...
#define mtk_vq_fmt_is_420(fmt) \
	((fmt == MTK_VQ_YUV420BLK) || (fmt == MTK_VQ_YUV420SCL))
#define mtk_vq_fmt_is_422(fmt) \
	((fmt == MTK_VQ_YUV422BLK) || (fmt == MTK_VQ_YUV422SCL))
...
/*
 *  struct mtk_vq_pix_max - picture pixel size limits in various IP
 *  configurations
...
/*
 *  struct mtk_vq_pix_min - picture pixel size limits in various IP
 *  configurations
 *
