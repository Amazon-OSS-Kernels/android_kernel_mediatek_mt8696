...
//#define imx709o_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u16(__VA_ARGS__)
#define imx709o_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)


/***************Modify Following Strings for Debug**********************/
#define PFX "imx709o_camera_sensor"
#define LOG_1 LOG_INF("IMX709O,MIPI 4LANE\n")
/****************************Modify end**************************/
...
//static kal_uint16 imx709o_table_write_cmos_sensor(ctx, kal_uint16 *para, kal_uint32 len);

static kal_uint16 imx709o_LRC_setting[LRC_SIZE*2];
static kal_uint16 imx709o_QSC_setting[QSC_SIZE*2];
static kal_uint8 qsc_flag, lrc_flag;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX709O_SENSOR_ID,
	.checksum_value = 0x8ac2d94a,

	.pre = { /*reg_B2 3280x2464@30*/
		.pclk = 571200000,
		.linelength = 7400,
		.framelength = 2568,
		.startx = 0,
	...
	.custom1 = { /*reg C2 3280*1856@30FPS */
		.pclk = 432000000,
		.linelength = 7400,
		.framelength = 1944,
		.startx = 0,
		...
		.grabwindow_height = 1856,
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 206800000,
		.max_framerate = 300, /* 30fps */
	},

	.custom2 = { /*reg_B2 3280x2464@30*/
		.pclk = 571200000,
		.linelength = 7400,
		.framelength = 2568,
		.startx = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{6560, 4928, 0, 608, 6560, 3712, 3280, 1856,
	0,   0, 3280, 1856,  0,  0, 3280, 1856}, /* custom1  reg_C2*/
	{6560, 4928, 0,   0, 6560, 4928, 3280, 2464,
	0,   0, 3280, 2464,  0,  0, 3280, 2464}, /* custom2  reg_B2*/
	{6560, 4928, 0,  16, 6560, 4896, 6560, 4896,
	16,   0, 6528, 4896,  0,  0, 6528, 4896}, /* custom3  reg_A5*/
	{6560, 4928, 0, 608, 6560, 3712, 3280, 1856,
	8,   0, 3264, 1856,  0,  0, 3264, 1856}, /* custom4  reg_I3*/
	{6560, 4928, 0,  16, 6560, 4896, 3280, 2448,
	8,   0, 3264, 2448,  0,  0, 3264, 2448}, /* custom5 reg_B3*/
};
...
static kal_uint16 gain2reg(struct subdrv_ctx *ctx, const kal_uint16 gain)
{
	...
	if (ctx->current_scenario_id == IMGSENSOR_MODE_CUSTOM3)
...
static kal_uint16 imx709o_rmsc_ip_setting[] = {
	//RMSC_IP_reg_210628
	0xD400, 0x00,
	0xD401, 0x00,
	0xD402, 0x00,
...
static kal_uint16 imx709o_init_setting[] = {
	//stream off
	0x0100, 0x00,
...
static kal_uint16 imx709o_preview_setting[] = {
...
/*reg_B1_3 3264x2448@45fps*/
static kal_uint16 imx709o_capture_setting[] = {
...
static kal_uint16 imx709o_normal_video_setting[] = {
...
static kal_uint16 imx709o_hs_video_setting[] = {
...
/*reg_G-2 3264x1856@60ps*/
static kal_uint16 imx709o_slim_video_setting[] = {
...
static kal_uint16 imx709o_custom1_setting[] = {
...
static kal_uint16 imx709o_custom2_setting[] = {
...
static kal_uint16 imx709o_custom3_setting[] = {
	//MIPI output setting
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
static kal_uint16 imx709o_custom4_setting[] = {
//reg_I3
...
static kal_uint16 imx709o_custom5_setting[] = {
	//MIPI output setting
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	LOG_INF("%s start\n", __func__);
	imx709o_table_write_cmos_sensor(ctx, imx709o_init_setting,
		sizeof(imx709o_init_setting)/sizeof(kal_uint16));
	imx709o_table_write_cmos_sensor(ctx, imx709o_rmsc_ip_setting,
		sizeof(imx709o_rmsc_ip_setting)/sizeof(kal_uint16));
...
{
	LOG_INF("%s start\n", __func__);
	imx709o_table_write_cmos_sensor(ctx, imx709o_preview_setting,
		sizeof(imx709o_preview_setting)/sizeof(kal_uint16));
	LOG_INF("%s end\n", __func__);
} /* preview_setting */
...
{
	LOG_INF("%s start\n", __func__);
	imx709o_table_write_cmos_sensor(ctx, imx709o_capture_setting,
		sizeof(imx709o_capture_setting)/sizeof(kal_uint16));
	LOG_INF("%s end\n", __func__);
}
...
{
	LOG_INF("%s start\n", __func__);
	imx709o_table_write_cmos_sensor(ctx, imx709o_normal_video_setting,
		sizeof(imx709o_normal_video_setting)/sizeof(kal_uint16));
	LOG_INF("%s end\n", __func__);
}
...
{
	LOG_INF("%s start\n", __func__);
	imx709o_table_write_cmos_sensor(ctx, imx709o_hs_video_setting,
		sizeof(imx709o_hs_video_setting)/sizeof(kal_uint16));
	LOG_INF("%s end\n", __func__);
}
...
{
	LOG_INF("%s start\n", __func__);
	imx709o_table_write_cmos_sensor(ctx, imx709o_slim_video_setting,
		sizeof(imx709o_slim_video_setting)/sizeof(kal_uint16));
	LOG_INF("%s end\n", __func__);
}
...
static void custom1_setting(struct subdrv_ctx *ctx)
{
	LOG_INF("%s start\n", __func__);
	/*************MIPI output setting************/
	imx709o_table_write_cmos_sensor(ctx, imx709o_custom1_setting,
		sizeof(imx709o_custom1_setting)/sizeof(kal_uint16));
	LOG_INF("%s end\n", __func__);
}
...
static void custom2_setting(struct subdrv_ctx *ctx)
{
	LOG_INF("%s start\n", __func__);
	/*************MIPI output setting************/
	imx709o_table_write_cmos_sensor(ctx, imx709o_custom2_setting,
		sizeof(imx709o_custom2_setting)/sizeof(kal_uint16));
	LOG_INF("%s end\n", __func__);
}
...
static void custom3_setting(struct subdrv_ctx *ctx)
{
	LOG_INF("%s start\n", __func__);
	/*************MIPI output setting************/
	imx709o_table_write_cmos_sensor(ctx, imx709o_custom3_setting,
		sizeof(imx709o_custom3_setting)/sizeof(kal_uint16));
	if (0) {//Eeprom_1ByteDataRead(0x1418, 0xA8) == 1) {
...
static void custom4_setting(struct subdrv_ctx *ctx)
{
	LOG_INF("%s start\n", __func__);
	/*************MIPI output setting************/
	imx709o_table_write_cmos_sensor(ctx, imx709o_custom4_setting,
		sizeof(imx709o_custom4_setting)/sizeof(kal_uint16));
	 LOG_INF("%s end\n", __func__);
}
...
static void custom5_setting(struct subdrv_ctx *ctx)
{
	LOG_INF("%s start\n", __func__);
	/*************MIPI output setting************/
	imx709o_table_write_cmos_sensor(ctx, imx709o_custom5_setting,
		sizeof(imx709o_custom5_setting)/sizeof(kal_uint16));
	 LOG_INF("%s end\n", __func__);
}
#endif
...
static void hdr_write_double_shutter(struct subdrv_ctx *ctx, kal_uint16 le, kal_uint16 se)
{
	...
	//			((read_cmos_sensor_8(ctx, 0x0340) &0xff) << 8) |
	//			(read_cmos_sensor_8(ctx, 0x0341) &0xff) );
	...
	/*
	 * le_b = ((read_cmos_sensor_8(ctx, 0x0202) & 0xff) << 8) |
	 * (read_cmos_sensor_8(ctx, 0x0203) & 0xff);
	 * se_b = ((read_cmos_sensor_8(ctx, 0x0224) & 0xff) << 8) |
	 * (read_cmos_sensor_8(ctx, 0x0225) & 0xff);
...
static void hdr_write_double_gain(struct subdrv_ctx *ctx, kal_uint16 lgain, kal_uint16 sgain)
{
	...
	/*
	 *	lg_b = ((read_cmos_sensor_8(ctx, 0x0204) & 0xff) << 8) |
	 *		(read_cmos_sensor_8(ctx, 0x0205) & 0xff);
	 *	sg_b = ((read_cmos_sensor_8(ctx, 0x0216) & 0xff) << 8) |
	 *		(read_cmos_sensor_8(ctx, 0x0217) & 0xff);
 ...
 *	{
 *		kal_uint8 qsc_is_valid = Eeprom_1ByteDataRead(0x1418, IMX709O_EEPROM_SLAVE_ADDRESS);
 *		LOG_INF("%s start write_sensor_QSC, qsc_is_valid:%d, qsc_flag:%d\n",
 *			__func__, qsc_is_valid, qsc_flag);
 *		if (qsc_is_valid == 1 && !qsc_flag) {
 *			imx709o_table_write_cmos_sensor(ctx, imx709o_QSC_setting,
 *				sizeof(imx709o_QSC_setting) / sizeof(kal_uint16));
 *			qsc_flag = 1;
 *		}
 *		LOG_INF("%s end\n", __func__);
 *	}
 ...
 *	{
 *		kal_uint8 lrc_is_valid = Eeprom_1ByteDataRead(0x162e, IMX709O_EEPROM_SLAVE_ADDRESS);
 *		LOG_INF("%s start write_sensor_LRC, lrc_is_valid:%d, lrc_flag:%d",
 *				__func__, lrc_is_valid, lrc_flag);
 *		if (lrc_is_valid == 1 && !lrc_flag) {
 *			imx709o_table_write_cmos_sensor(ctx, imx709o_LRC_setting,
 *				sizeof(imx709o_LRC_setting) / sizeof(kal_uint16));
 *			lrc_flag = 1;
 *		}
 *		LOG_INF("%s end\n", __func__);
 *	}
...
static int get_imgsensor_id(struct subdrv_ctx *ctx, UINT32 *sensor_id)
{
	 ...
	 */
	LOG_INF("imx709o Enter %s.", __func__);
			...
			*sensor_id = ((read_cmos_sensor_8(ctx, 0x0016) << 8)
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				*sensor_id = imgsensor_info.sensor_id;
				...
				if (first_read) {
					//read_module_data();
					read_imx709o_LRC(ctx, imx709o_LRC_setting);
					read_imx709o_QSC(ctx, imx709o_QSC_setting);
...
static kal_uint16 imx709o_feedback_awbgain[] = {
	0x0b90, 0x00,
	0x0b91, 0x01,
	0x0b92, 0x00,
	0x0b93, 0x01,
...
static void feedback_awbgain(struct subdrv_ctx *ctx, kal_uint32 r_gain, kal_uint32 b_gain)
{
	...
	imx709o_feedback_awbgain[1] = r_gain_int;
	imx709o_feedback_awbgain[3] = (
		((r_gain*100) / 512) - (r_gain_int * 100)) * 2;
	imx709o_feedback_awbgain[5] = b_gain_int;
	imx709o_feedback_awbgain[7] = (
		((b_gain * 100) / 512) - (b_gain_int * 100)) * 2;
	imx709o_table_write_cmos_sensor(ctx, imx709o_feedback_awbgain,
		sizeof(imx709o_feedback_awbgain)/sizeof(kal_uint16));
}
				...
				MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if (ctx->current_fps != imgsensor_info.cap.max_framerate) {
		LOG_INF("Warning! cur_fps %d isn't support, use cap's : %d\n",
				ctx->current_fps,
		...
		enum SENSOR_SCENARIO_ID_ENUM scenario_id, MUINT32 framerate)
{
	...
	case SENSOR_SCENARIO_ID_NORMAL_CAPTURE:
		if (ctx->current_fps != imgsensor_info.cap.max_framerate)
			LOG_INF(
				"Warning: cur_fps %d is not support, use cap's: %d\n",
...
const struct subdrv_entry imx709o_mipi_raw_entry = {
	.name = "imx709o_mipi_raw",
	.id = IMX709O_SENSOR_ID,
	.pw_seq = pw_seq,
