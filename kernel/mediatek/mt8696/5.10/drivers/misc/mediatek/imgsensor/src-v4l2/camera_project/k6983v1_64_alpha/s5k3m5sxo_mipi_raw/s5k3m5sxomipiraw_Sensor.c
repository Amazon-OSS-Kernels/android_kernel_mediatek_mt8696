...
#define PFX "S5K3M5SXO_camera_sensor"
#define LOG_INF(format, args...) pr_debug(PFX "[%s] " format, __func__, ##args)

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3M5SXO_SENSOR_ID,
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_MODULE_INFO:
		*feature_return_para_32++ = (s5k3m5sxo_common_data[1] << 24) |
						(s5k3m5sxo_common_data[0] << 16) |
						(s5k3m5sxo_common_data[3] << 8) |
						(s5k3m5sxo_common_data[2] & 0xFF);
		*feature_return_para_32 = (s5k3m5sxo_common_data[5] << 24) |
					  (s5k3m5sxo_common_data[4] << 16) |
					  (s5k3m5sxo_common_data[7] << 8) |
					  (s5k3m5sxo_common_data[6] & 0xFF);
		*feature_para_len = 8;
		LOG_INF("s5k3m5sxo GET_MODULE_CamInfo:%d %d\n",
			*feature_para_len, *feature_data_32);
		break;

	case SENSOR_FEATURE_GET_MODULE_SN:
		*feature_return_para_32++ = (s5k3m5sxo_common_data[11] << 24) |
						(s5k3m5sxo_common_data[10] << 16) |
						(s5k3m5sxo_common_data[9] << 8) |
						(s5k3m5sxo_common_data[8] & 0xFF);
		*feature_para_len = 4;
		LOG_INF("s5k3m5sxo GET_MODULE_SN:%d %d\n", *feature_para_len,
			*feature_data_32);
		break;
...
const struct subdrv_entry s5k3m5sxo_mipi_raw_entry = {
	.name = "s5k3m5sxo_mipi_raw",
	.id = S5K3M5SXO_SENSOR_ID,
	.pw_seq = pw_seq,
