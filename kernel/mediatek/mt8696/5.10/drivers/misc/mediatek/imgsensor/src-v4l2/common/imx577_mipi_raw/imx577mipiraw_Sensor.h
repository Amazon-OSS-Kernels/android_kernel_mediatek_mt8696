 ...
 *
 ****************************************************************************/
#ifndef _IMX577MIPIRAW_SENSOR_H
#define _IMX577MIPIRAW_SENSOR_H
...
struct imgsensor_struct {
	...
	kal_uint16 hdr_long_again;
	kal_uint16 hdr_long_dgain;
	kal_uint16 hdr_short_again;
	kal_uint16 hdr_short_dgain;

	kal_uint16 hdr_LE;
	kal_uint16 hdr_SE;
	kal_uint16 hdr_offset;
