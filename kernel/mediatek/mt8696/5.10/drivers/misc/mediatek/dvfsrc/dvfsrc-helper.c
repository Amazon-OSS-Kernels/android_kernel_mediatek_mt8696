...
static int mtk_dvfsrc_debug_setting(struct mtk_dvfsrc *dvfsrc)
{
	...
	dvfsrc->vcore_power =
		regulator_get_optional(dvfsrc->dev, "dvfsrc-vcore");
...
static struct dvfsrc_opp dvfsrc_opp_mt8696_lp4[] = {
	{0, 0, 0, 0},
	{0, 1, 0, 0},
};

static struct dvfsrc_opp_desc dvfsrc_opp_mt8696_desc[] = {
	MT_DVFSRC_OPP(1, 2, dvfsrc_opp_mt8696_lp4),
};

static const struct dvfsrc_debug_data mt8696_data = {
	.version = 0x8696,
	.config = &mt8696_dvfsrc_config,
