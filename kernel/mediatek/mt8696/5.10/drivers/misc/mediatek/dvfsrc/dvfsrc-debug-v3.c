...
static const int mt8696_regs[] = {
	...
	[DVFSRC_SW_REQ1] = 0x510,
	[DVFSRC_INT] = 0xC8,
	[DVFSRC_INT_EN] = 0xCC,
	[DVFSRC_SW_BW_0] = 0x514,
	[DVFSRC_ISP_HRT] = 0x20C,
	[DVFSRC_DEBUG_STA_0] = 0x29C,
	[DVFSRC_VCORE_REQUEST] = 0x80,
	[DVFSRC_CURRENT_LEVEL] = 0x4A4,
...
#else
	dvfs_time_us = (time_1 - time_2);
	do_div(dvfs_time_us, 13);
#endif
...
const struct dvfsrc_config mt8696_dvfsrc_config = {
	.ip_verion = 3, /*mt6983 series*/
	.regs = mt8696_regs,
	.dump_record = dvfsrc_dump_record,
	.dump_reg = dvfsrc_dump_reg,
