...
#include <mt8696_spm_reg.h>
#include <mt8696_pwr_ctrl.h>
#include <lpm_timer.h>
#include <mtk_lpm_sysfs.h>
#include "mt8696_lpm_compat.h"

#define MT8696_LOG_DEFAULT_MS		5000
...
const char *mt8696_wakesrc_str[32] = {
	[0] = "R12_PCM_TIMER",
	[1] = "R12_TWAM_IRQ_B",
	[2] = "R12_KP_IRQ_B",
	[3] = "R12_APWDT_EVENT_B",
...
static struct lpm_spm_wake_status mt8696_wakesrc;

static struct lpm_log_helper mt8696_log_help = {
	.wakesrc = &mt8696_wakesrc,
	.cur = 0,
	.prev = 0,
};
...
{
	struct lpm_log_helper *help = &mt8696_log_help;
...
static void mt8696_suspend_show_detailed_wakeup_reason(
	struct lpm_spm_wake_status *wakesta)
{
}


static void mt8696_suspend_spm_rsc_req_check(
	struct lpm_spm_wake_status *wakesta)
{
...
static int lpm_show_message(int type, const char *prefix, void *data)
{
	...
	struct lpm_spm_wake_status *wakesrc = mt8696_log_help.wakesrc;
	int i;
	...
	if (type == LPM_ISSUER_SUSPEND) {
		pr_info("[name:spm&][SPM] %s", log_buf);
		mt8696_suspend_show_detailed_wakeup_reason(wakesrc);
		mt8696_suspend_spm_rsc_req_check(wakesrc);
...
static struct lpm_dbg_plat_ops mt8696_dbg_ops = {
...
int mt8696_dbg_ops_register(void)
{
	int ret;

	ret = lpm_dbg_plat_ops_register(&mt8696_dbg_ops);
