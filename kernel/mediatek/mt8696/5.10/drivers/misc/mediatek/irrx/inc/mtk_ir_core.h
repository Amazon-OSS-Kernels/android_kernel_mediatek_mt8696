...
extern u32 mtk_ir_core_getmode(void);
...
extern void mtk_ir_mouse_switch(enum MTK_IR_DEVICE_MODE devmode);
#if IS_ENABLED(CONFIG_MTK_IRRX_MOUSE_DRAG)
extern enum MTK_IR_MOUSE_MODE mtk_ir_drag_mouse_get_device_mode(void);
extern void mtk_ir_drag_mouse_set_device_mode(enum MTK_IR_MOUSE_MODE devmode);
extern int mtk_ir_drag_mouse_proc_key(u32 scancode,
		struct mtk_ir_context *p_mtk_rc_core);
extern void mtk_ir_drag_mouse_switch(struct input_dev *p_devmouse,
