...
#define MTK_IR_SUPPORT_MOUSE_INPUT      1
#define MTK_IR_MOUSE_NEC_SWITCH_CODE    0x54
#define MTK_IR_MOUSE_NEC_WHEEL_UP 0x50	/* Green key */
#define MTK_IR_MOUSE_NEC_WHEEL_DOWN 0x16  /* Yellow key */
#if IS_ENABLED(CONFIG_MTK_IRRX_MOUSE_DRAG)
#define MTK_IR_MOUSE_DRAG_MODE_DEFAULT	MTK_IR_AS_NORMAL_MOUSE
#define MTK_IR_NEC_DRAG_MOUSE_SWITCH_CODE 0x12	/*  Red key */
#endif
