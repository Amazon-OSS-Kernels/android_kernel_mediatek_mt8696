...
static ssize_t
usb_charge_type_show(struct kobject *kobj, struct kobj_attribute *kattr, char *buf)
{
...
static struct kobj_attribute usb_charge_type_attrubute =
	__ATTR(usb_charge_type, 0444, usb_charge_type_show, NULL);


static struct attribute *amazon_attrs[] = {
	&usb_charge_type_attrubute.attr,
	NULL,
};
