...
{
/*
 * vt keyboard is not used in Fire TV products.
 * kbd_connect will call uhid_open during Fire TV Remote probe.
 * This uhid_open will mislead BT Stack to think the event hub is ready.
 */
