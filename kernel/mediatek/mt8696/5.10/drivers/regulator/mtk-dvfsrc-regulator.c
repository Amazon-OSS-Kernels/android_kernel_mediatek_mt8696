...
static const unsigned int mt8696_voltages[] = {
	800000,
};

static struct dvfsrc_regulator mt8696_regulators[] = {
	MT_DVFSRC_REGULAR("dvfsrc-vcore", VCORE,
			  mt8696_voltages),
};

static const struct dvfsrc_regulator_init_data regulator_mt8696_data = {
	.size = ARRAY_SIZE(mt8696_regulators),
	.regulator_info = &mt8696_regulators[0],
};
