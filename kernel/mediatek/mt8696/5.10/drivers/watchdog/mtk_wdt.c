...
#include <dt-bindings/reset-controller/mt8696-resets.h>
...
static const struct mtk_wdt_data mt8696_data = {
	.rst_num = MT8696_TOPRGU_SW_RST_NUM,
};
...
static const struct of_device_id mtk_wdt_dt_ids[] = {
	...
	{ .compatible = "mediatek,mt8696-rgu", .data = &mt8696_data },
	{ /* sentinel */ }
};
