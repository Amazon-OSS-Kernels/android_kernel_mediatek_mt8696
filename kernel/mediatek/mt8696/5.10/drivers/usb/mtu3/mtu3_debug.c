...
static struct mtu3_usbreg_set ssusb_usb3_mac_csr[] = {
	{ 0x1400, "TS_CONFIG", 32, NULL },
	{ 0x1404, "PIPE", 32, NULL },
	{ 0x140C, "LTSSM_PARAMETER", 32, NULL },
	{ 0x1410, "LTSSM_CTRL", 32, NULL },
	{ 0x1414, "LTSSM_INFO", 32, NULL },
	{ 0x141C, "USB3_CONFIG", 32, NULL },
	{ 0x1420, "NORMAL_TXDEEMPH_10G_GEN1", 32, NULL },
	{ 0x1424, "NORMAL_TXDEEMPH_10G_GEN2", 32, NULL },
	{ 0x1428, "COMPLIANCE_CP5_CP7_TXDEEMPH_10G", 32, NULL },
	{ 0x142C, "COMPLIANCE_CP6_CP8_TXDEEMPH_10G", 32, NULL },
	{ 0x1430, "COMPLIANCE_CP13_TXDEEMPH_10G", 32, NULL },
	{ 0x1434, "COMPLIANCE_CP14_TXDEEMPH_10G", 32, NULL },
	{ 0x1438, "COMPLIANCE_CP15_TXDEEMPH_10G", 32, NULL },
	{ 0x143C, "COMPLIANCE_CP16_TXDEEMPH_10G", 32, NULL },
	{ 0x144C, "COMPLIANCE_CP12", 32, NULL },
	{ 0x1450, "USB3_U1_STATE_INFO", 32, NULL },
	{ 0x1454, "USB3_U2_STATE_INFO", 32, NULL },
	{ 0x147C, "UX_LFPS_TIMING_PARAMETER", 32, NULL },
	{ 0x1480, "U1_LFPS_TIMING_PARAMETER_2", 32, NULL },
	{ 0x1484, "U2_LB_LFPS_TIMING_PARAMETER_1", 32, NULL },
	{ 0x1488, "U2_LB_LFPS_TIMING_PARAMETER_2", 32, NULL },
	{ 0x148C, "U3_LFPS_TIMING_PARAMETER_1", 32, NULL },
	{ 0x1490, "U3_LFPS_TIMING_PARAMETER_2", 32, NULL },
	{ 0x1494, "PING_LFPS_TIMING_PARAMETER", 32, NULL },
	{ 0x1498, "POLLING_LFPS_TIMING_PARAMETER_1", 32, NULL },
	{ 0x149C, "POLLING_LFPS_TIMING_PARAMETER_2", 32, NULL },
	{ 0x14A0, "UX_EXIT_LFPS_TIMING_PARAMETER", 32, NULL },
	{ 0x14A4, "P3_TIMING_PARAMETER", 32, NULL },
	{ 0x14A8, "WARM_RESET_TIMING_PARAMETER", 32, NULL },
	{ 0x14AC, "UX_EXIT_TIMING_PARAMETER", 32, NULL },
	{ 0x14B0, "REF_CK_PARAMETER", 32, NULL },
	{ 0x14C0, "GEN2_U1_LFPS_TIMING_PARAMETER", 32, NULL },
	{ 0x14C4, "GEN2_PING_LFPS_TIMING_PARAMETER", 32, NULL },
	{ 0x14C8, "GEN2_UX_EXIT_TIMING_PARAMETER", 32, NULL },
	{ 0x14CC, "GEN2_TX_SCD", 32, NULL },
	{ 0x14D0, "GEN2_TX_LBPM_1", 32, NULL },
	{ 0x14D4, "GEN2_TX_LBPM_2", 32, NULL },
	{ 0x14D8, "GEN2_RX_SCD_1", 32, NULL },
	{ 0x14DC, "GEN2_RX_SCD_2", 32, NULL },
	{ 0x14E0, "GEN2_RX_LBPM_1", 32, NULL },
	{ 0x14E4, "GEN2_RX_LBPM_2", 32, NULL },
	{ 0x14E8, "GEN2_RX_LBPM_3", 32, NULL },
	{ 0x14EC, "GEN2_POLLING_SCDLFPS_TIME", 32, NULL },
	{ 0x150C, "LTSSM_TIMING_PARAMETER_1", 32, NULL },
	{ 0x1510, "LTSSM_TIMING_PARAMETER_2", 32, NULL },
	{ 0x1514, "LTSSM_TIMING_PARAMETER_3", 32, NULL },
	{ 0x1518, "LTSSM_TIMING_PARAMETER_4", 32, NULL },
	{ 0x151C, "LTSSM_TIMING_PARAMETER_5", 32, NULL },
	{ 0x1520, "LTSSM_RXDETECT_CTRL", 32, NULL },
	{ 0x1524, "PIPE_RXDATA_ERR_VALUE", 32, NULL },
	{ 0x1528, "PIPE_RXDATA_ERR_INTR_ENABLE", 32, NULL },
	{ 0x152C, "PIPE_RXDATA_ERR_INTR", 32, NULL },
	{ 0x1530, "PIPE_LATCH_SELECT", 32, NULL },
	{ 0x1534, "LINK_STATE_MACHINE", 32, NULL },
	{ 0x1538, "MAC_FAST_SIMULATION", 32, NULL },
	{ 0x153C, "LTSSM_INTR_ENABLE", 32, NULL },
	{ 0x1540, "LTSSM_INTR", 32, NULL },
	{ 0x1548, "SKP_CNT", 32, NULL },
	{ 0x154C, "SS_SPEED", 32, NULL },
	{ 0x1550, "GEN1_POLLING_FLAG", 32, NULL },
	{ 0x1554, "GEN2_POLLING_FLAG", 32, NULL },
	{ 0x1558, "SPECIAL_CNT", 32, NULL },
	{ 0x155C, "POLLING_CP_CTRL", 32, NULL },
	{ 0x1560, "FORCE_PIPE_TX_DATA", 32, NULL },
	{ 0x1564, "FORCE_PIPE_TX_DATA_CTRL", 32, NULL },
	{ 0x1568, "FORCE_PIPE_TX_CTRL", 32, NULL },
	{ 0x156C, "FORCE_PIPE_TX_ALL", 32, NULL },
	{ 0x1570, "USB3_USB2_SWITCH_CTRL", 32, NULL },
	{ 0x1574, "PIPE_2ND_RXDATA_ERR_VALUE", 32, NULL },
	{ 0x1578, "SPECIAL_CNT_2ND", 32, NULL },
	{ 0, NULL, 0, NULL }
...
static struct mtu3_usbreg_set ssusb_usb3_sys_csr[] = {
	{ 0x1600, "LINK_HP_TIMER", 32, NULL },
	{ 0x1604, "LINK_CMD_TIMER", 32, NULL },
	{ 0x1608, "LINK_PM_TIMER", 32, NULL },
	{ 0x160C, "LINK_UX_INACT_TIMER", 32, NULL },
	{ 0x1610, "LINK_POWER_CONTROL", 32, NULL },
	{ 0x1614, "LINK_ERR_COUNT", 32, NULL },
	{ 0x1618, "LTSSM_TRANSITION", 32, NULL },
	{ 0x1620, "LINK_RETRY_CTRL", 32, NULL },
	{ 0x1624, "SYS_FAST_SIMULATIION", 32, NULL },
	{ 0x1628, "LINK_CAPABILITY_CTRL", 32, NULL },
	{ 0x162C, "LINK_DEBUG_INFO", 32, NULL },
	{ 0x1630, "LINK_TYPE_CTRL", 32, NULL },
	{ 0x1640, "USB3_U1_REJECT", 32, NULL },
	{ 0x1644, "USB3_U2_REJECT", 32, NULL },
	{ 0x1680, "RESPONSER_LDM", 32, NULL },
	{ 0x1690, "DEV_NOTIF_0", 32, NULL },
	{ 0x1694, "DEV_NOTIF_1", 32, NULL },
	{ 0x1698, "VENDOR_DEV_TEST", 32, NULL },
	{ 0x169C, "VENDOR_DEF_DATA_LOW", 32, NULL },
	{ 0x16A0, "VENDOR_DEF_DATA_HIGH", 32, NULL },
	{ 0x16A4, "HOST_SET_PORT_CTRL", 32, NULL },
	{ 0x16AC, "LINK_CAP_CONTROL", 32, NULL },
	{ 0x16B0, "PORT_CONF_TIMEOUT", 32, NULL },
	{ 0x16B4, "TIMING_PULSE_CTRL", 32, NULL },
	{ 0x16B8, "ISO_TIMESTAMP", 32, NULL },
	{ 0x16C0, "RECEIVE_PKT_INTR_EN", 32, NULL },
	{ 0x16C4, "RECEIVE_PKT_INTR", 32, NULL },
	{ 0x16C8, "CRC_ERR_INTR_EN", 32, NULL },
	{ 0x16CC, "CRC_ERR_INTR", 32, NULL },
	{ 0x16D0, "PORT_STATUS_INTR_EN", 32, NULL },
	{ 0x16D4, "PORT_STATUS_INTR", 32, NULL },
	{ 0x16D8, "RECOVERY_COUNT", 32, NULL },
	{ 0x16DC, "DUT_TEST", 32, NULL },
	{ 0x16E0, "RECOV_EN", 32, NULL },
	{ 0, NULL, 0, NULL }
};
