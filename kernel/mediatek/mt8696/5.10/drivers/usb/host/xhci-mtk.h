...
struct xhci_hcd_mtk {
	...
	u32 u2port_power[USB_MAXCHILDREN];
	u32 u3port_power[USB_SS_MAXPORTS];
	u32 uwk_vers;
...
#else
static inline int mtk_xhci_init_debugfs(struct xhci_hcd *xhci)
{
	return 0;
}
static inline void mtk_xhci_exit_debugfs(struct xhci_hcd *xhci)
{
}
#endif
#else
static inline int xhci_mtk_sch_init(struct xhci_hcd_mtk *mtk)
{
	return 0;
}
static inline void xhci_mtk_sch_exit(struct xhci_hcd_mtk *mtk)
{
}
static inline int xhci_mtk_add_ep(struct usb_hcd *hcd,
	struct usb_device *udev, struct usb_host_endpoint *ep)
{
	return 0;
}

static inline int xhci_mtk_drop_ep(struct usb_hcd *hcd,
	struct usb_device *udev, struct usb_host_endpoint *ep)
{
}
