...
const char *v4l2_ctrl_get_name(u32 id)
{
	...
	case V4L2_CID_MPEG_VIDEO_ENABLE_TSVC: return "encode TSVC";
	...
	case V4L2_CID_MPEG_MTK_ENCODE_MULTI_REF: return "encode multi ref";
	case V4L2_CID_MPEG_MTK_ENCODE_WPP_MODE: return "encode wpp";
	case V4L2_CID_MPEG_MTK_ENCODE_LOW_LATENCY_MODE: return "encode low latency";
	case V4L2_CID_MPEG_MTK_ENCODE_RC_MAX_QP: return "encode max qp";
	case V4L2_CID_MPEG_MTK_ENCODE_RC_MIN_QP: return "encode min qp";
	case V4L2_CID_MPEG_MTK_ENCODE_RC_I_P_QP_DELTA: return "encode qp delta";
	case V4L2_CID_MPEG_MTK_ENCODE_RC_QP_CONTROL_MODE: return "encode qp control mode";
	case V4L2_CID_MPEG_MTK_ENCODE_RC_FRAME_LEVEL_QP: return "encode frame level qp";
	case V4L2_CID_MPEG_MTK_ENCODE_TEMPORAL_LAYER_COUNT: return "encode temporal layer count";
	case V4L2_CID_MPEG_MTK_ENCODE_MAX_LTR_FRAMES: return "encode max ltr frames";
	default:
		return NULL;
	}
}
