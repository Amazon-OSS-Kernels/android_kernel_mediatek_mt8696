...
static struct mtk_base_afe *g_afe;
	...
	struct snd_soc_pcm_runtime **rbe, char *dai_name)
{
	...
	list_for_each_entry(dpcm, &fe->dpcm[stream].be_clients, list_be) {
		...
		if (!strcmp(asoc_rtd_to_cpu(rtd, 0)->name, dai_name)) {
			*rbe = be;
			return true;
		}
		i++;
...
static int mt8532_irq_engen_apll_sel(struct snd_pcm_substream *substream)
{
	...
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
	struct mt8532_afe_private *afe_priv = afe->platform_priv;
	const int dai_id = asoc_rtd_to_cpu(rtd, 0)->id;
	...
	if (!fe_data->slave_mode) {
		...
		case MT8532_AFE_MEMIF_DL11:
			if (mt8532_match_1st_be_cpu_dai(substream,
					&bertd, "ETDM1_OUT")) {
				afe = snd_soc_component_get_drvdata(
					component);
	...
	char *dai_name)
{
	...
	list_for_each_entry(dpcm_fe, &be->dpcm[stream].fe_clients, list_fe) {
		...
		list_for_each_entry(dpcm_be,
			...
			if (!strcmp(asoc_rtd_to_cpu(be, 0)->name, dai_name))
				return asoc_rtd_to_cpu(be, 0);
		}
	}
	...
	unsigned int rate, unsigned int bit_width)
{
	...
	default:
		/* use 48K Hz */
		ch_status_lsb |= (0x2 << 24);
		dev_dbg(afe->dev, "%s invalid rate %u\n", __func__, rate);
		break;
	}
...
static const struct snd_kcontrol_new mt8532_afe_o02_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I46 Switch", AFE_CONN2_1, 46-32, 1, 0),
};

static const struct snd_kcontrol_new mt8532_afe_o03_mix[] = {
	SOC_DAPM_SINGLE_AUTODISABLE("I03 Switch", AFE_CONN3, 3, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I47 Switch", AFE_CONN3_1, 47-32, 1, 0),
};
...
static const struct snd_kcontrol_new mt8532_afe_o04_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I48 Switch", AFE_CONN4_1, 48-32, 1, 0),
};
...
static const struct snd_kcontrol_new mt8532_afe_o12_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I56 Switch", AFE_CONN12_1, 56-32, 1, 0),
...
static const struct snd_kcontrol_new mt8532_afe_o13_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I57 Switch", AFE_CONN13_1, 57-32, 1, 0),
...
static const struct snd_kcontrol_new mt8532_afe_o14_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I58 Switch", AFE_CONN14_1, 58-32, 1, 0),
};
...
static const struct snd_kcontrol_new mt8532_afe_o15_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I59 Switch", AFE_CONN15_1, 59-32, 1, 0),
};
...
static const struct snd_kcontrol_new mt8532_afe_o16_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I60 Switch", AFE_CONN16_1, 60-32, 1, 0),
};
...
static const struct snd_kcontrol_new mt8532_afe_o17_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I61 Switch", AFE_CONN17_1, 61-32, 1, 0),
};
...
static const struct snd_kcontrol_new mt8532_afe_o36_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I70 Switch", AFE_CONN36_2, 70-64, 1, 0),
};
...
static const struct snd_kcontrol_new mt8532_afe_o37_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I71 Switch", AFE_CONN37_2, 71-64, 1, 0),
};
...
static const struct snd_soc_dapm_widget mt8532_afe_pcm_widgets[] = {
	...
	SND_SOC_DAPM_MIXER("O36", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o36_mix, ARRAY_SIZE(mt8532_afe_o36_mix)),//ul5
	SND_SOC_DAPM_MIXER("O37", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o37_mix, ARRAY_SIZE(mt8532_afe_o37_mix)),
	...
	SND_SOC_DAPM_MIXER("O2", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o02_mix, ARRAY_SIZE(mt8532_afe_o02_mix)), //ul9
	SND_SOC_DAPM_MIXER("O3", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o03_mix, ARRAY_SIZE(mt8532_afe_o03_mix)),
	SND_SOC_DAPM_MIXER("O4", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o04_mix, ARRAY_SIZE(mt8532_afe_o04_mix)), //ul9
	SND_SOC_DAPM_MIXER("O5", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o05_mix, ARRAY_SIZE(mt8532_afe_o05_mix)),
	SND_SOC_DAPM_MIXER("O6", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o06_mix, ARRAY_SIZE(mt8532_afe_o06_mix)), //ul9
	SND_SOC_DAPM_MIXER("O7", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o07_mix, ARRAY_SIZE(mt8532_afe_o07_mix)),
	SND_SOC_DAPM_MIXER("O8", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o08_mix, ARRAY_SIZE(mt8532_afe_o08_mix)), //ul9
	SND_SOC_DAPM_MIXER("O9", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o09_mix, ARRAY_SIZE(mt8532_afe_o09_mix)),
	SND_SOC_DAPM_MIXER("O10", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o10_mix, ARRAY_SIZE(mt8532_afe_o10_mix)), //ul9
	SND_SOC_DAPM_MIXER("O11", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o11_mix, ARRAY_SIZE(mt8532_afe_o11_mix)),
	SND_SOC_DAPM_MIXER("O12", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o12_mix, ARRAY_SIZE(mt8532_afe_o12_mix)), //ul9
	SND_SOC_DAPM_MIXER("O13", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o13_mix, ARRAY_SIZE(mt8532_afe_o13_mix)),
	SND_SOC_DAPM_MIXER("O14", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o14_mix, ARRAY_SIZE(mt8532_afe_o14_mix)), //ul9
	SND_SOC_DAPM_MIXER("O15", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o15_mix, ARRAY_SIZE(mt8532_afe_o15_mix)),
	SND_SOC_DAPM_MIXER("O16", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o16_mix, ARRAY_SIZE(mt8532_afe_o16_mix)), //ul9
	SND_SOC_DAPM_MIXER("O17", SND_SOC_NOPM, 0, 0,
		mt8532_afe_o17_mix, ARRAY_SIZE(mt8532_afe_o17_mix)),
...
static const struct snd_soc_dapm_route mt8532_afe_pcm_routes[] = {
	...
	{"O36", "I70 Switch", "VIRTUAL Capture"}, // dl2 -> ul5
	{"O37", "I71 Switch", "VIRTUAL Capture"},

	{"VIRTUAL Capture", NULL, "Virtual_UL_In"},

	{"I70", NULL, "DL2"},
	{"I71", NULL, "DL2"},

	{"VIRTUAL Playback", NULL, "I70"},
	{"VIRTUAL Playback", NULL, "I71"},

	{"Virtual_DL_Out", NULL, "VIRTUAL Playback"},
	...
	{"O2", "I46 Switch", "VIRTUAL Capture"}, //DLM -> UL9
	{"O3", "I47 Switch", "VIRTUAL Capture"},
	{"O4", "I48 Switch", "VIRTUAL Capture"},
	{"O5", "I49 Switch", "VIRTUAL Capture"},
	{"O6", "I50 Switch", "VIRTUAL Capture"},
	{"O7", "I51 Switch", "VIRTUAL Capture"},
	{"O8", "I52 Switch", "VIRTUAL Capture"},
	{"O9", "I53 Switch", "VIRTUAL Capture"},
	{"O10", "I54 Switch", "VIRTUAL Capture"},
	{"O11", "I55 Switch", "VIRTUAL Capture"},
	{"O12", "I56 Switch", "VIRTUAL Capture"},
	{"O13", "I57 Switch", "VIRTUAL Capture"},
	{"O14", "I58 Switch", "VIRTUAL Capture"},
	{"O15", "I59 Switch", "VIRTUAL Capture"},
	{"O16", "I60 Switch", "VIRTUAL Capture"},
	{"O17", "I61 Switch", "VIRTUAL Capture"},
	...
	{"VIRTUAL Playback", NULL, "I46"}, //dl8 > virtual playback
	{"VIRTUAL Playback", NULL, "I47"},
	{"VIRTUAL Playback", NULL, "I48"},
	{"VIRTUAL Playback", NULL, "I49"},
	{"VIRTUAL Playback", NULL, "I50"},
	{"VIRTUAL Playback", NULL, "I51"},
	{"VIRTUAL Playback", NULL, "I52"},
	{"VIRTUAL Playback", NULL, "I53"},
	{"VIRTUAL Playback", NULL, "I54"},
	{"VIRTUAL Playback", NULL, "I55"},
	{"VIRTUAL Playback", NULL, "I56"},
	{"VIRTUAL Playback", NULL, "I57"},
	{"VIRTUAL Playback", NULL, "I58"},
	{"VIRTUAL Playback", NULL, "I59"},
	{"VIRTUAL Playback", NULL, "I60"},
	{"VIRTUAL Playback", NULL, "I61"},
...
static int spdif_out_irq_handler(int irq, void *dev_id)
{
	...
	if ((val & AFE_IEC_BURST_INFO_READY_MASK) !=
		...
		dev_dbg(afe->dev, "%s burst info is not ready\n", __func__);
		return 0;
	}
	...
	struct platform_device *pdev)
{
	...
	for (i = 0; i < MT8532_AFE_TDMOUT_CONN_CFG_NUM; i++) {
		...
		snprintf(prop, sizeof(prop), "mediatek,etdm1-out-O_%zu-cfg",
			 i);
		ret = of_property_read_u32(np, prop, &temps[0]);
		if ((ret == 0) && (temps[0] <= MT8532_AFE_TDMOUT_CONN_I15))
...
static int mt8532_afe_pcm_probe(struct snd_soc_component *platform)
{
	int ret = 0;
	int i = 0;
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(platform);
	struct mt8532_afe_private *priv = afe->platform_priv;
...
const struct snd_soc_component_driver mt8532_afe_pcm_platform = {
	.name = AFE_PCM_NAME,
...
static int mt8532_afe_pcm_dev_probe(struct platform_device *pdev)
{
	...
	if (ret) {
		dev_dbg(afe->dev, "mt8532_afe_init_audio_clk fail\n");
		return ret;
	}
	dev_dbg(afe->dev, "%s %d\n", __func__, __LINE__);
	...
	if (!pm_runtime_enabled(dev)) {
		dev_dbg(afe->dev, "%s pm_runtime not enabled\n", __func__);
		ret = mt8532_afe_runtime_resume(dev);
		if (ret) {
			dev_dbg(afe->dev, "4444\n");
			goto err_pm_disable;
		}
	}
