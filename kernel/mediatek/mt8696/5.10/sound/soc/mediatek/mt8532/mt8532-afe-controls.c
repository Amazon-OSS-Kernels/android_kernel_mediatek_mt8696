...
static int mt8532_mmap_dl_scene_get(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *plat = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(plat);
...
static int mt8532_mmap_dl_scene_set(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *plat = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(plat);
...
static int mt8532_mmap_ul_scene_get(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *plat = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(plat);
...
static int mt8532_mmap_ul_scene_set(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *plat = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(plat);
...
static int mt8532_mmap_ion_get(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *plat = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(plat);
...
static int mt8532_mmap_ion_set(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *plat = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(plat);
...
static int mt8532_dl_mmap_fd_get(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *plat = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(plat);
...
static int mt8532_dl_mmap_fd_set(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	return 0;
}

static int mt8532_ul_mmap_fd_get(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *plat = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(plat);
...
static int mt8532_ul_mmap_fd_set(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	return 0;
}

static int mt8532_dl_mmap_memif_id_get(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *plat = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(plat);
...
static int mt8532_dl_mmap_memif_id_set(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *plat = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(plat);
	...
	if (memif_id <= MT8532_AFE_MEMIF_DL_END &&
		memif_id >= MT8532_AFE_MEMIF_DL_START)
		afe_priv->mmap_dl_memif_id = ucontrol->value.integer.value[0];

	return 0;
}

static int mt8532_ul_mmap_memif_id_get(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *plat = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(plat);
...
static int mt8532_ul_mmap_memif_id_set(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *plat = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(plat);
	...
	if (memif_id <= MT8532_AFE_MEMIF_UL_END &&
		memif_id >= MT8532_AFE_MEMIF_UL_START)
...
static const struct snd_kcontrol_new mt8532_afe_controls[] = {
	...
	SOC_SINGLE_EXT("mmap_play_scenario",
				...
				mt8532_mmap_dl_scene_get,
				mt8532_mmap_dl_scene_set),
	SOC_SINGLE_EXT("mmap_record_scenario",
				SND_SOC_NOPM, 0, 0x1, 0,
				mt8532_mmap_ul_scene_get,
				mt8532_mmap_ul_scene_set),
	...
	SOC_SINGLE_EXT("aaudio_dl_mmap_fd",
				...
				mt8532_dl_mmap_fd_get,
				mt8532_dl_mmap_fd_set),
	SOC_SINGLE_EXT("aaudio_ul_mmap_fd",
				SND_SOC_NOPM, 0, 0xffffffff, 0,
				mt8532_ul_mmap_fd_get,
				mt8532_ul_mmap_fd_set),
	SOC_SINGLE_EXT("aaudio_dl_mmap_memif_id",
				SND_SOC_NOPM, 0, 0xffffffff, 0,
				mt8532_dl_mmap_memif_id_get,
				mt8532_dl_mmap_memif_id_set),
	SOC_SINGLE_EXT("aaudio_ul_mmap_memif_id",
				SND_SOC_NOPM, 0, 0xffffffff, 0,
				mt8532_ul_mmap_memif_id_get,
				mt8532_ul_mmap_memif_id_set),
};
...
int mt8532_afe_add_controls(struct snd_soc_component *platform)
{
	...
	afe_priv->card = platform->card->snd_card;

	return snd_soc_add_component_controls(platform, mt8532_afe_controls,
