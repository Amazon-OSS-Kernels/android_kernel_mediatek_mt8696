...
struct gnt_memif_info gnt_memif_data[] = {
	{
		...
		.pbuf_size_shift = 16,		          //buffer size valid bit 16~31, should shif 16bit
				    ...
				    struct mtk_base_afe *afe, struct gnt_memif_info info)
{
    ...
    ///2. caculate dma remained buffer size
...
int mt8696_afe_add_controls(struct snd_soc_platform *platform)
{
	return snd_soc_add_platform_controls(platform, mt8696_afe_controls,
