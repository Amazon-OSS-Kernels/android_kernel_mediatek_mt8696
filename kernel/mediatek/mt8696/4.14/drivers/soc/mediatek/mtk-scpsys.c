...
/*
 * MT8696 power domain support
 */

static const struct scp_domain_data scp_domain_data_mt8696[] = {
	[MT8696_POWER_DOMAIN_VDEC_CORE0] = {
		.name = "vdec_core0",
		.sta_mask = BIT(0),
		.ctl_offs = 0x300,
		.sram_pdn_bits = GENMASK(8, 8),
	...
	[MT8696_POWER_DOMAIN_MMSYS_TOP] = {
		...
		.subsys_clk_prefix = "mm",
		.bp_table = {
			BUS_PROT(IFR_TYPE, 0x260, 0x264, 0, 0x228,
				BIT(1) | BIT(2),
				BIT(1) | BIT(2),
				BIT(1) | BIT(2)),
		},
	},
	[MT8696_POWER_DOMAIN_MMSYS_COMMON] = {
		.name = "mmsys_common",
		.sta_mask = BIT(3),
		.ctl_offs = 0x030c,
		.sram_pdn_bits = GENMASK(8, 8),
	...
	[MT8696_POWER_DOMAIN_OSD_UHD] = {
		.name = "osd_uhd",
		.sta_mask = BIT(4),
		.ctl_offs = 0x0310,
		.sram_pdn_bits = GENMASK(8, 8),
		.sram_pdn_ack_bits = GENMASK(12, 12),
		.subsys_clk_prefix = "osd",
	},
	[MT8696_POWER_DOMAIN_HDMITX] = {
		.name = "hdmitx",
		.sta_mask = BIT(5),
		.ctl_offs = 0x0314,
		.sram_pdn_bits = GENMASK(8, 8),
		.sram_pdn_ack_bits = GENMASK(12, 12),
		.basic_clk_name = {"hdmiapb"},
		.bp_table = {
			BUS_PROT(IFR_TYPE, 0xB84, 0xB88, 0, 0xB90,
				BIT(17) | BIT(18),
				BIT(17) | BIT(18),
				BIT(17) | BIT(18)),
		},
	},
	[MT8696_POWER_DOMAIN_HDMIRX] = {
		.name = "hdmirx",
		.sta_mask = BIT(6),
		.ctl_offs = 0x0318,
		.sram_pdn_bits = GENMASK(8, 8),
	...
	[MT8696_POWER_DOMAIN_DISP_COMMON] = {
		.name = "dsp_common",
		.sta_mask = BIT(9),
		.ctl_offs = 0x0324,
		.sram_pdn_bits = GENMASK(8, 8),
	...
	[MT8696_POWER_DOMAIN_MMCU] = {
		.name = "mmcu",
		.sta_mask = BIT(10),
		.ctl_offs = 0x0380,
		.sram_pdn_bits = GENMASK(8, 8),
		.sram_pdn_ack_bits = GENMASK(12, 12),
		.subsys_clk_prefix = "mmcu",
		.bp_table = {
			BUS_PROT(IFR_TYPE, 0x270, 0x274, 0, 0x258,
	...
	[MT8696_POWER_DOMAIN_AUDIO_ASRC] = {
		.name = "aud_asrc",
		.sta_mask = BIT(12),
		.ctl_offs = 0x0388,
		.sram_pdn_bits = GENMASK(8, 8),
		...
		.basic_clk_name = {"audio"},
		.bp_table = {
			BUS_PROT(IFR_TYPE, 0xBA4, 0xBA8, 0, 0xBB0,
				BIT(1), BIT(1), BIT(1)),
			BUS_PROT(IFR_TYPE, 0xB84, 0xB88, 0, 0xB90,
				BIT(28), BIT(28), BIT(28)),
		},
	},
	[MT8696_POWER_DOMAIN_SSUSB] = {
		.name = "ssusb",
		.sta_mask = BIT(15),
		.ctl_offs = 0x033C,
		.sram_pdn_bits = GENMASK(8, 8),
		...
		.bp_table = {
			BUS_PROT(IFR_TYPE, 0xBA4, 0xBA8, 0, 0xBB0,
				...
				BIT(2) | BIT(3) | BIT(5)),
			BUS_PROT(IFR_TYPE, 0xB84, 0xB88, 0, 0xB90,
				BIT(23), BIT(23), BIT(23)),
		},
		.caps = MTK_SCPD_ACTIVE_WAKEUP,
	},
	[MT8696_POWER_DOMAIN_ETHER_PCIE] = {
		.name = "ether",
		.sta_mask = BIT(16),
		.ctl_offs = 0x0340,
		.sram_pdn_bits = GENMASK(8, 8),
		.sram_pdn_ack_bits = GENMASK(12, 12),
		.basic_clk_name = {"ether"},
		.bp_table = {
			BUS_PROT(IFR_TYPE, 0xBA4, 0xBA8, 0, 0xBB0,
				BIT(0) | BIT(4),
				BIT(0) | BIT(4),
	...
	[MT8696_POWER_DOMAIN_HDMIRX_PHY] = {
		.name = "hdmirx_phy",
		.sta_mask = BIT(23),
		.ctl_offs = 0x0328,
		.sram_pdn_bits = 0,
		.sram_pdn_ack_bits = 0,
		.caps = MTK_SCPD_FWAIT_SRAM,
	},
	[MT8696_POWER_DOMAIN_VDEC_SOC] = {
		.name = "vdec_soc",
		.sta_mask = BIT(24),
		.ctl_offs = 0x35C,
		.sram_pdn_bits = GENMASK(8, 8),
...
static const struct scp_subdomain scp_subdomain_mt8696[] = {
	{MT8696_POWER_DOMAIN_VDEC_SOC, MT8696_POWER_DOMAIN_VDEC_CORE0},
	{MT8696_POWER_DOMAIN_MMSYS_TOP, MT8696_POWER_DOMAIN_MMSYS_COMMON},
	{MT8696_POWER_DOMAIN_MMSYS_TOP, MT8696_POWER_DOMAIN_OSD_UHD},
	{MT8696_POWER_DOMAIN_MMSYS_TOP, MT8696_POWER_DOMAIN_DISP_MAIN},
	{MT8696_POWER_DOMAIN_DISP_MAIN, MT8696_POWER_DOMAIN_DISP_SUB},
	{MT8696_POWER_DOMAIN_DISP_MAIN, MT8696_POWER_DOMAIN_DISP_COMMON},
	{MT8696_POWER_DOMAIN_MFG, MT8696_POWER_DOMAIN_MFG2},
	{MT8696_POWER_DOMAIN_MFG2, MT8696_POWER_DOMAIN_MFG3},
	{MT8696_POWER_DOMAIN_MMSYS_TOP, MT8696_POWER_DOMAIN_VDEC_SOC},
};
...
static const struct scp_soc_data mt8696_data = {
	.domains = scp_domain_data_mt8696,
	.num_domains = ARRAY_SIZE(scp_domain_data_mt8696),
	.subdomains = scp_subdomain_mt8696,
	.num_subdomains = ARRAY_SIZE(scp_subdomain_mt8696),
	.regs = {
		.pwr_sta_offs = 0x016C,
...
static const struct of_device_id of_scpsys_match_tbl[] = {
	{
		...
		.compatible = "mediatek,mt8696-scpsys",
		.data = &mt8696_data,
	}, {
		/* sentinel */
	}
