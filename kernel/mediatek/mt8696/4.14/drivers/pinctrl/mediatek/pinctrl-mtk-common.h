...
/**
 * struct mtk_pin_multi_base_drv_grp - Provide each pin driving info.
 * @pin: The pin number.
 * @offset: The offset of driving register for this pin.
 * @bit: The bit of driving register for this pin.
 * @grp: The group for this pin belongs to.
 * @ip_num: The ip num of driving register base addr for this pin.
 */
struct mtk_pin_multi_base_drv_grp {
	unsigned short pin;
	unsigned short offset;
	unsigned char bit;
	unsigned char grp;
...
#define MTK_PIN_MULTI_BASE_DRV_GRP(_pin, _offset, _bit, _grp, _ip_num)	\
	{	\
		.pin = _pin,	\
		.offset = _offset,	\
		.bit = _bit,	\
...
struct mtk_pinctrl_devdata {
	...
	const struct mtk_pin_multi_base_drv_grp	*pin_multi_base_drv_grp;
