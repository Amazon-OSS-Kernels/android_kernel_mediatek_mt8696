...
static struct mtu3_usbreg_set ssusb_sifslv_ippc[] = {
	{ 0x0000, "SSUSB_IP_PW_CTRL0",	 32, NULL },
	{ 0x0004, "SSUSB_IP_PW_CTRL1",	 32, NULL  },
	{ 0x0008, "SSUSB_IP_PW_CTRL2",	 32, NULL  },
	{ 0x000c, "SSUSB_IP_PW_CTRL3",	 32, NULL  },
	{ 0x0010, "SSUSB_IP_PW_STS1",	 32, NULL  },
	{ 0x0014, "SSUSB_IP_PW_STS2",	 32, NULL  },
	{ 0x0018, "SSUSB_OTG_STS",	 32, "SSUSB OTG STATUS" },
	{ 0x001c, "SSUSB_OTG_STS_CLR",	 32, "SSUSB OTG STATUS CLEAR" },
	{ 0x0020, "SSUSB_IP_MAC_CAP",	 32, NULL },
	{ 0x0024, "SSUSB_IP_XHCI_CAP",	 32, NULL },
	{ 0x0028, "SSUSB_IP_DEV_CAP",	 32, NULL },
	{ 0x002c, "SSUSB_OTG_INT_EN",	 32, "SSUSB OTG INTERRUPT Enable" },
	{ 0x0030, "SSUSB_U3_CTRL_0P",	 32, "SSUSB IP U3 Port 0 Control" },
	{ 0x0038, "SSUSB_U3_CTRL_1P",	 32, "SSUSB IP U3 Port 1 Control" },
	{ 0x0040, "SSUSB_U3_CTRL_2P",	 32, "SSUSB IP U3 Port 2 Control" },
	{ 0x0048, "SSUSB_U3_CTRL_3P",	 32, "SSUSB IP U3 Port 3 Control" },
	{ 0x0050, "SSUSB_U2_CTRL_0P",	 32, "SSUSB IP U2 Port 0 Control" },
	{ 0x0058, "SSUSB_U2_CTRL_1P",	 32, "SSUSB IP U2 Port 1 Control" },
	{ 0x0060, "SSUSB_U2_CTRL_2P",	 32, "SSUSB IP U2 Port 2 Control" },
	{ 0x0068, "SSUSB_U2_CTRL_3P",	 32, "SSUSB IP U2 Port 3 Control" },
	{ 0x0070, "SSUSB_U2_CTRL_4P",	 32, "SSUSB IP U2 Port 4 Control" },
	{ 0x0078, "SSUSB_U2_CTRL_5P",	 32, "SSUSB IP U2 Port 5 Control" },
	{ 0x007c, "SSUSB_U2_PHY_PLL",	 32, "SSUSB U2 PHY PLL Control" },
	{ 0x0080, "SSUSB_DMA_CTRL",	 32, "SSUSB DMA Control Register" },
	{ 0x0084, "SSUSB_MAC_CK_CTRL",	 32, "SSUSB MAC Clock Control" },
	{ 0x0088, "SSUSB_CSR_CK_CTRL",	 32, NULL },
	{ 0x008c, "SSUSB_REF_CK_CTRL",	 32, "SSUSB Reference Clock Control" },
	{ 0x0090, "SSUSB_XHCI_CK_CTRL",	 32, "SSUSB XHCI Clock Control" },
	{ 0x0094, "SSUSB_XHCI_RST_CTRL", 32, "SSUSB XHCI Reset Control" },
	{ 0x0098, "SSUSB_DEV_RST_CTRL",	 32, "SSUSB Device Reset Control" },
	{ 0x009c, "SSUSB_SYS_CK_CTRL",	 32, "SSUSB System Clock Control" },
	...
	{ 0x00d0, "SSUSB_FPGA_I2C_OUT_0P", 32, "SSUSB FPGA I2C 0P Output" },
	{ 0x00d4, "SSUSB_FPGA_I2C_IN_0P",  32, "SSUSB FPGA I2C 0P Input" },
	{ 0x00d8, "SSUSB_FPGA_I2C_OUT_1P", 32, "SSUSB FPGA I2C 1P Output" },
	{ 0x00dc, "SSUSB_FPGA_I2C_IN_1P",  32, "SSUSB FPGA I2C 1P Input" },
	{ 0x00e0, "SSUSB_FPGA_I2C_OUT_2P", 32, "SSUSB FPGA I2C 2P Output" },
	{ 0x00e4, "SSUSB_FPGA_I2C_IN_2P",  32, "SSUSB FPGA I2C 2P Input" },
	{ 0x00e8, "SSUSB_FPGA_I2C_OUT_3P", 32, "SSUSB FPGA I2C 3P Output" },
	{ 0x00ec, "SSUSB_FPGA_I2C_IN_3P",  32, "SSUSB FPGA I2C 3P Input" },
	{ 0x00f0, "SSUSB_FPGA_I2C_OUT_4P", 32, "SSUSB FPGA I2C 4P Output" },
	{ 0x00f4, "SSUSB_FPGA_I2C_IN_4P",  32, "SSUSB FPGA I2C 4P Input" },
	{ 0x00f8, "SSUSB_IP_SLV_TMOUT",	   32, "SSUSB IP SLAVE TIMEOUT" },
	{ 0, NULL, 0, NULL }
};

/*
 * Module name: ssusb_device_ssusb_dev Base address: (+11201000h)
 * Address	Name	Width		Register Function
 */
static struct mtu3_usbreg_set ssusb_device_ssusb_dev[] = {
	...
	{ 0x0C0, "EP0DMACTRL", 32, "EP0 DMA Control and FIFO Start Address" },
	...
	{ 0x0D0, "TXDMACTRL", 32, "Tx DMA Control and FIFO Start Address" },
	...
	{ 0x700, "QISAR0", 32, "QMU Interrupt Status & Acknowledgment Reg0" },
	{ 0x704, "QIER0", 32, "QMU Interrupt Enable Register 0" },
	{ 0x708, "QIESR0", 32, "QMU Interrupt Enable Set Register 0" },
	{ 0x70C, "QIECR0", 32, "QMU Interrupt Enable Clear Register 0" },
	{ 0x710, "QISAR1", 32, "QMU Interrupt Status and Acknowledgment" },
	...
	{ 0x740, "QEMIR", 32, "Queue Empty Indication Register" },
	{ 0x744, "QEMIER", 32, "Queue Empty Indication Enable Register" },
	{ 0x748, "QEMIESR", 32, "Queue Empty Indication Enable Set" },
	{ 0x74C, "QEMIECR", 32, "Queue Empty Indication Enable Clear" },
	{ 0x780, "TQERRIR0", 32, "TXQ Error Indication Register 0" },
	{ 0x784, "TQERRIER0", 32, "TXQ Error Indication Enable Reg0" },
	{ 0x788, "TQERRIESR0", 32, "TXQ Error Indication Enable Set Reg0" },
	{ 0x78C, "TQERRIECR0", 32, "TXQ Error Indication Enable Clear Reg0" },
	{ 0x7C0, "RQERRIR0", 32, "RXQ Error Indication Register 0" },
	{ 0x7C4, "RQERRIER0", 32, "RXQ Error Indication Enable Reg0" },
	{ 0x7C8, "RQERRIESR0", 32, "RXQ Error Indication Enable Set Reg0" },
	{ 0x7CC, "RQERRIECR0", 32, "RXQ Error Indication Enable Clear Reg0" },
	{ 0x7D0, "RQERRIR1", 32, "RXQ Error Indication Reg1" },
	{ 0x7D4, "RQERRIER1", 32, "RXQ Error Indication Enable Re1" },
	{ 0x7D8, "RQERRIESR1", 32, "RXQ Error Indication Enable Set Reg1" },
	{ 0x7DC, "RQERRIECR1", 32, "RXQ Error Indication Enable Clear Reg1" },
...
/*
 * Module name: ssusb_epctl_csr Base address: (+11201800h)
 * Address	Name	Width		Register Function
 */
static struct mtu3_usbreg_set ssusb_epctl_csr[] = {
	...
	{ 0x870, "USB2_ISOINEP_INCOMP_INTR_MD", 32, NULL },
	{ 0x874, "USB2_ISOOUTEP_INCOMP_ERR_MD", 32, NULL },
	{ 0x878, "ISO_UNDERRUN_INTR_MD", 32, NULL },
	{ 0x87C, "ISO_OVERRUN_INTR_MD", 32, NULL },
	{ 0x880, "USB2_RX_EP_DATAERR_INTR_MD", 32, NULL },
	{ 0x890, "EP_RST_OPT", 32, NULL },
	{ 0, NULL, 0, NULL }
};
...
static struct mtu3_usbreg_set ssusb_usb2_csr[] = {
	...
	{ 0x2454, "SSUSB_OTG_STATUS", 32, NULL },
	{ 0x2458, "SSUSB_OTG_STATUS_CLEAR", 32, NULL },
	{ 0x245C, "SSUSB_OTG_INTERRUPT_ENABLE", 32, NULL },
	{ 0x2460, "USB20_OPSTATE", 32, NULL },
	{ 0x2464, "USB20_SOF_INTERRUPT_FRAME_MASK", 32, NULL },
	{ 0, NULL, 0, NULL }
};


/*
 * Module name: ssusb_usb2_csr_1p Base address: (+11203600h)
 * Address	Name	Width		Register Function
 */
static struct mtu3_usbreg_set ssusb_usb2_csr_1p[] = {
	...
	{ 0x2654, "SSUSB_OTG_STATUS", 32, NULL },
	{ 0x2658, "SSUSB_OTG_STATUS_CLEAR", 32, NULL },
	{ 0x265C, "SSUSB_OTG_INTERRUPT_ENABLE", 32, NULL },
	{ 0x2660, "USB20_OPSTATE", 32, NULL },
	{ 0x2664, "USB20_SOF_INTERRUPT_FRAME_MASK", 32, NULL },
	{ 0, NULL, 0, NULL }
};

/*
 * Module name: ssusb_usb3_mac_csr Base address: (+0x11202400)
 * Address	Name	Width		Register Function
 */
static struct mtu3_usbreg_set ssusb_usb3_mac_csr[] = {
	{ 0x2400, "TS_CONFIG", 32, NULL },
	{ 0x2404, "PIPE", 32, NULL },
	{ 0x240C, "LTSSM_PARAMETER", 32, NULL },
	{ 0x2410, "LTSSM_CTRL", 32, NULL },
	{ 0x2414, "LTSSM_INFO", 32, NULL },
	{ 0x241C, "USB3_CONFIG", 32, NULL },
	{ 0x2420, "NORMAL_TXDEEMPH_10G_GEN1", 32, NULL },
	{ 0x2424, "NORMAL_TXDEEMPH_10G_GEN2", 32, NULL },
	{ 0x2428, "COMPLIANCE_CP5_CP7_TXDEEMPH_10G", 32, NULL },
	{ 0x242C, "COMPLIANCE_CP6_CP8_TXDEEMPH_10G", 32, NULL },
	{ 0x2430, "COMPLIANCE_CP13_TXDEEMPH_10G", 32, NULL },
	{ 0x2434, "COMPLIANCE_CP14_TXDEEMPH_10G", 32, NULL },
	{ 0x2438, "COMPLIANCE_CP15_TXDEEMPH_10G", 32, NULL },
	{ 0x243C, "COMPLIANCE_CP16_TXDEEMPH_10G", 32, NULL },
	{ 0x244C, "COMPLIANCE_CP12", 32, NULL },
	{ 0x2450, "USB3_U1_STATE_INFO", 32, NULL },
	{ 0x2454, "USB3_U2_STATE_INFO", 32, NULL },
	{ 0x247C, "UX_LFPS_TIMING_PARAMETER", 32, NULL },
	{ 0x2480, "U1_LFPS_TIMING_PARAMETER_2", 32, NULL },
	{ 0x2484, "U2_LB_LFPS_TIMING_PARAMETER_1", 32, NULL },
	{ 0x2488, "U2_LB_LFPS_TIMING_PARAMETER_2", 32, NULL },
	{ 0x248C, "U3_LFPS_TIMING_PARAMETER_1", 32, NULL },
	{ 0x2490, "U3_LFPS_TIMING_PARAMETER_2", 32, NULL },
	{ 0x2494, "PING_LFPS_TIMING_PARAMETER", 32, NULL },
	{ 0x2498, "POLLING_LFPS_TIMING_PARAMETER_1", 32, NULL },
	{ 0x249C, "POLLING_LFPS_TIMING_PARAMETER_2", 32, NULL },
	{ 0x24A0, "UX_EXIT_LFPS_TIMING_PARAMETER", 32, NULL },
	{ 0x24A4, "P3_TIMING_PARAMETER", 32, NULL },
	{ 0x24A8, "WARM_RESET_TIMING_PARAMETER", 32, NULL },
	{ 0x24AC, "UX_EXIT_TIMING_PARAMETER", 32, NULL },
	{ 0x24B0, "REF_CK_PARAMETER", 32, NULL },
	{ 0x24C0, "GEN2_U1_LFPS_TIMING_PARAMETER", 32, NULL },
	{ 0x24C4, "GEN2_PING_LFPS_TIMING_PARAMETER", 32, NULL },
	{ 0x24C8, "GEN2_UX_EXIT_TIMING_PARAMETER", 32, NULL },
	{ 0x24CC, "GEN2_TX_SCD", 32, NULL },
	{ 0x24D0, "GEN2_TX_LBPM_1", 32, NULL },
	{ 0x24D4, "GEN2_TX_LBPM_2", 32, NULL },
	{ 0x24D8, "GEN2_RX_SCD_1", 32, NULL },
	{ 0x24DC, "GEN2_RX_SCD_2", 32, NULL },
	{ 0x24E0, "GEN2_RX_LBPM_1", 32, NULL },
	{ 0x24E4, "GEN2_RX_LBPM_2", 32, NULL },
	{ 0x24E8, "GEN2_RX_LBPM_3", 32, NULL },
	{ 0x24EC, "GEN2_POLLING_SCDLFPS_TIME", 32, NULL },
	{ 0x250C, "LTSSM_TIMING_PARAMETER_1", 32, NULL },
	{ 0x2510, "LTSSM_TIMING_PARAMETER_2", 32, NULL },
	{ 0x2514, "LTSSM_TIMING_PARAMETER_3", 32, NULL },
	{ 0x2518, "LTSSM_TIMING_PARAMETER_4", 32, NULL },
	{ 0x251C, "LTSSM_TIMING_PARAMETER_5", 32, NULL },
	{ 0x2520, "LTSSM_RXDETECT_CTRL", 32, NULL },
	{ 0x2524, "PIPE_RXDATA_ERR_VALUE", 32, NULL },
	{ 0x2528, "PIPE_RXDATA_ERR_INTR_ENABLE", 32, NULL },
	{ 0x252C, "PIPE_RXDATA_ERR_INTR", 32, NULL },
	{ 0x2530, "PIPE_LATCH_SELECT", 32, NULL },
	{ 0x2534, "LINK_STATE_MACHINE", 32, NULL },
	{ 0x2538, "MAC_FAST_SIMULATION", 32, NULL },
	{ 0x253C, "LTSSM_INTR_ENABLE", 32, NULL },
	{ 0x2540, "LTSSM_INTR", 32, NULL },
	{ 0x2548, "SKP_CNT", 32, NULL },
	{ 0x254C, "SS_SPEED", 32, NULL },
	{ 0x2550, "GEN1_POLLING_FLAG", 32, NULL },
	{ 0x2554, "GEN2_POLLING_FLAG", 32, NULL },
	{ 0x2558, "SPECIAL_CNT", 32, NULL },
	{ 0x255C, "POLLING_CP_CTRL", 32, NULL },
	{ 0x2560, "FORCE_PIPE_TX_DATA", 32, NULL },
	{ 0x2564, "FORCE_PIPE_TX_DATA_CTRL", 32, NULL },
	{ 0x2568, "FORCE_PIPE_TX_CTRL", 32, NULL },
	{ 0x256C, "FORCE_PIPE_TX_ALL", 32, NULL },
	{ 0x2570, "USB3_USB2_SWITCH_CTRL", 32, NULL },
	{ 0x2574, "PIPE_2ND_RXDATA_ERR_VALUE", 32, NULL },
	{ 0x2578, "SPECIAL_CNT_2ND", 32, NULL },
	{ 0, NULL, 0, NULL }
...
/*
 * Module name: ssusb_usb3_sys_csr Base address: (+0x11202600)
 * Address	Name	Width		Register Function
 */
static struct mtu3_usbreg_set ssusb_usb3_sys_csr[] = {
	{ 0x2600, "LINK_HP_TIMER", 32, NULL },
	{ 0x2604, "LINK_CMD_TIMER", 32, NULL },
	{ 0x2608, "LINK_PM_TIMER", 32, NULL },
	{ 0x260C, "LINK_UX_INACT_TIMER", 32, NULL },
	{ 0x2610, "LINK_POWER_CONTROL", 32, NULL },
	{ 0x2614, "LINK_ERR_COUNT", 32, NULL },
	{ 0x2618, "LTSSM_TRANSITION", 32, NULL },
	{ 0x2620, "LINK_RETRY_CTRL", 32, NULL },
	{ 0x2624, "SYS_FAST_SIMULATIION", 32, NULL },
	{ 0x2628, "LINK_CAPABILITY_CTRL", 32, NULL },
	{ 0x262C, "LINK_DEBUG_INFO", 32, NULL },
	{ 0x2630, "LINK_TYPE_CTRL", 32, NULL },
	{ 0x2640, "USB3_U1_REJECT", 32, NULL },
	{ 0x2644, "USB3_U2_REJECT", 32, NULL },
	{ 0x2680, "RESPONSER_LDM", 32, NULL },
	{ 0x2690, "DEV_NOTIF_0", 32, NULL },
	{ 0x2694, "DEV_NOTIF_1", 32, NULL },
	{ 0x2698, "VENDOR_DEV_TEST", 32, NULL },
	{ 0x269C, "VENDOR_DEF_DATA_LOW", 32, NULL },
	{ 0x26A0, "VENDOR_DEF_DATA_HIGH", 32, NULL },
	{ 0x26A4, "HOST_SET_PORT_CTRL", 32, NULL },
	{ 0x26AC, "LINK_CAP_CONTROL", 32, NULL },
	{ 0x26B0, "PORT_CONF_TIMEOUT", 32, NULL },
	{ 0x26B4, "TIMING_PULSE_CTRL", 32, NULL },
	{ 0x26B8, "ISO_TIMESTAMP", 32, NULL },
	{ 0x26C0, "RECEIVE_PKT_INTR_EN", 32, NULL },
	{ 0x26C4, "RECEIVE_PKT_INTR", 32, NULL },
	{ 0x26C8, "CRC_ERR_INTR_EN", 32, NULL },
	{ 0x26CC, "CRC_ERR_INTR", 32, NULL },
	{ 0x26D0, "PORT_STATUS_INTR_EN", 32, NULL },
	{ 0x26D4, "PORT_STATUS_INTR", 32, NULL },
	{ 0x26D8, "RECOVERY_COUNT", 32, NULL },
	{ 0x26DC, "DUT_TEST", 32, NULL },
	{ 0x26E0, "RECOV_EN", 32, NULL },
	{ 0, NULL, 0, NULL }
};
					...
					unsigned int len, unsigned int value)
{
	...
	if (start_bit > 31 || len > 31 || (start_bit + len > 31))
		pr_err("[ssusb][RMW] Invalid Reg field range/length\n");
	else {
		field = ((1 << len) - 1) << start_bit;
		value &= (1 << len) - 1;
		pr_err("[ssusb][RMW]Original:0x%p (0x%x)\n",
		       address, readl(address));
		IO_SET_FIELD(address, field, value);
		pr_err("[ssusb][RMW]Modified:0x%p (0x%x)\n",
		       address, readl(address));
	}
}
					...
					unsigned int len, unsigned int value)
{
	...
	if (start_bit > 31 || len > 31 || (start_bit + len > 31))
		...
		pr_err("[ssusb][RMW]Reg:0x%p start_bit(%d)len(%d)(0x%x)\n",
...
static int mtk_ssusb_regdump_show(struct seq_file *s, void *unused)
{
	...
	seq_printf(s, "MTK SSUSB(ippc: 0x%p, mac: 0x%p)\n",
		   ibase, mbase);
	if (PTR_ERR(ibase)) {
		seq_puts(s,
			 "\nssusb_sifslv_ippc: [0x11203E00~0x11203F00)\n");
	...
	if (PTR_ERR(mbase)) {
		seq_puts(s,
			"\nssusb_device_ssusb_dev: [0x11201000~0x11202000)\n");
		...
		seq_puts(s,
			 "\nssusb_epctl_csr: [0x11201800 ~ 0x11201900)\n");
		...
		seq_puts(s,
			 "\nssusb_usb3_mac_csr: [0x11202400 ~ 0x11202600]\n");
		for (i = 0; i < ARRAY_SIZE(ssusb_usb3_mac_csr); i++) {
			usbxxreg = &ssusb_usb3_mac_csr[i];
			switch (usbxxreg->width) {
			case 8:
				seq_printf(s, "%-25s(0x%p): 0x%02X\n",
					   usbxxreg->name,
		...
		seq_puts(s,
			 "\nssusb_usb3_sys_csr: [0x11202600 ~ 0x11202700]\n");
		for (i = 0; i < ARRAY_SIZE(ssusb_usb3_sys_csr); i++) {
			usbxxreg = &ssusb_usb3_sys_csr[i];
			switch (usbxxreg->width) {
			case 8:
				seq_printf(s, "%-25s(0x%p): 0x%02X\n",
					   usbxxreg->name,
		...
		seq_puts(s, "\nssusb_usb2_csr: [0x11203400 ~ 0x11203450]\n");
		...
		seq_puts(s, "\nssusb_usb2_csr: [0x11203600 ~ 0x11270668]\n");
...
static int mtk_ssusb_debug_proc_show(struct seq_file *m, void *v)
{
	...
	seq_puts(m, "  write reg:  echo 1 0 [io] [value] > debug\n");
	seq_puts(m, "  read  reg:  echo 1 1 [io] > debug\n");
...
static ssize_t mtk_ssusb_debug_proc_write(struct file *file,
			const char *buf, size_t count, loff_t *data)
{
	...
	sscanf_num = sscanf(ssusb->cmd_buf, "%x %x %llx %x %x %x",
			    &cmd, &p1, &p2, &p3, &p4, &p5);
	if (sscanf_num < 1)
		return count;
	...
	if (cmd == 0)
		...
		if (p1 == 0) {
			reg_value = p3;
			pr_err("[ssusb][Write]Original:0x%p (0x%08X)\n",
					iomem, readl(iomem));

			writel(reg_value, iomem);

			pr_err("[ssusb][Write]Writed:0x%p (0x%08X)\n",
					iomem, readl(iomem));
		} else if (p1 == 1)
			pr_err("[ssusb][Read]Register:0x%p (0x%08X)\n",
					iomem, readl(iomem));
		else if (p1 == 2)
...
static int mtk_ssusb_extcon_proc_show(struct seq_file *s, void *v)
{
	...
	if (!ssusb->otg_switch.manual_drd_enabled) {
		extcon_usb = extcon_get_state(edev, EXTCON_USB);
		extcon_usb_host = extcon_get_state(edev, EXTCON_USB_HOST);
		seq_printf(s,
			   "OTG Current: USB-HOST(id): %s, USB(vBus): %s\n",
			   extcon_usb_host ? "L" : "H",
			   extcon_usb ? "H" : "L");
#if IS_ENABLED(CONFIG_DUAL_ROLE_USB_INTF)
		seq_printf(s, "       : DUAL_ROLE_PROP: %s\n",
			  (ssusb->dual_role_mode == MTU3_DR_FORCE_DEVICE)
			   ? "Device: MODE_UFP, PR_SNK, DR_DEVICE"
			    : (ssusb->dual_role_mode == MTU3_DR_FORCE_HOST)
			   ? "Host  : MODE_DFP, PR_SRC, DR_HOST"
...
int mtk_ssusb_init_debugfs(struct ssusb_mtk *ssusb)
{
	...
	file = debugfs_create_file("regdump", 0444, root, ssusb,
				   &mtk_ssusb_regdump_fops);
	if (!file) {
		ret = -ENOMEM;
		goto err1;
	}

	file = debugfs_create_file("debug", 0644, root, ssusb,
				   &mtk_ssusb_debug_proc_fops);
	if (!file) {
		ret = -ENOMEM;
		goto err1;
	}

	file = debugfs_create_file("extcon", 0644, root, ssusb,
				   &mtk_ssusb_extcon_proc_fops);
	if (!file) {
		ret = -ENOMEM;
		goto err1;
	}
