...
struct OFFSET_TABLE_T {
	struct POSITION_OFFSET_T rCsr;
	struct POSITION_OFFSET_T rOSD5;
	struct POSITION_OFFSET_T rOSD4;
	struct POSITION_OFFSET_T rOSD3;
	struct POSITION_OFFSET_T rOSD2;
	struct POSITION_OFFSET_T rOSD1;
	struct POSITION_OFFSET_T rVDP2;
	struct POSITION_OFFSET_T rVDP1;
};

struct OSD_OFFSET_TABLE_T {
	struct POSITION_OFFSET_T rOSD5;
	struct POSITION_OFFSET_T rOSD4;
	struct POSITION_OFFSET_T rOSD3;
	struct POSITION_OFFSET_T rOSD2;
	struct POSITION_OFFSET_T rOSD1;
	struct PATH_OFFSET_T rPath;
};

struct OSD_SCALE_INFO {
	UINT32 u4Enable;
	UINT32 u4SrcW;
	UINT32 u4SrcH;
	UINT32 u4DstW;
...
extern struct OFFSET_TABLE_T rLocationOffset[];
