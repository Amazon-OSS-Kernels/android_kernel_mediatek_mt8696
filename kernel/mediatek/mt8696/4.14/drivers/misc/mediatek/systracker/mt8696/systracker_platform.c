...
{
#if 1	//for 8532
	p1 = ioremap(0x10001B84, 0x4);	//for 8532

	/* use RV33 reg base for our test */
	mm_area1 = ioremap(0x338008, 0x4);

#else
	p1 = ioremap(0x10001260, 0x4);

	/* use MFG reg base for our test */
