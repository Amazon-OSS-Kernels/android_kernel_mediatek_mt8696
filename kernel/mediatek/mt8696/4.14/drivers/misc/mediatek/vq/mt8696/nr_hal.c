...
static void nr_hal_set_swap_mode(void __iomem *reg_base,
	unsigned char u1SwapMode)
{
	unsigned int u4Value;
...
{
    /* 2D NR setting */
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_37,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_SM_CO1MO) << 24,
		MESSSFT_SMOOTH_CO1MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_37,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_SM_CO1MO) << 16,
	...
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_38,
		...
		MESSTHL_MESS_CO1MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_37,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_EDGE_CO1MO) << 8,
		MESSSFT_EDGE_CO1MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_37,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_EDGE_CO1MO) << 0,
		MESSTHL_EDGE_CO1MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_39,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_SM_CO1ST) << 24,
		MESSSFT_SMOOTH_CO1ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_39,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_SM_CO1ST) << 16,
	...
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3A,
		...
		MESSTHL_MESS_CO1ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_39,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_EDGE_CO1ST) << 8,
		MESSSFT_EDGE_CO1ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_39,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_EDGE_CO1ST) << 0,
		MESSTHL_EDGE_CO1ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_SM_CO1) << 8,
		BLDLV_SM_CO1);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MESS_CO1) << 4,
		BLDLV_MESS_CO1);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_EDGE_CO1) << 0,
		BLDLV_EDGE_CO1);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3B,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_SM_CO2MO) << 24,
		MESSSFT_SMOOTH_CO2MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3B,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_SM_CO2MO) << 16,
	...
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3C,
		...
		MESSTHL_MESS_CO2MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3B,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_EDGE_CO2MO) << 8,
		MESSSFT_EDGE_CO2MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3B,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_EDGE_CO2MO) << 0,
		MESSTHL_EDGE_CO2MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3D,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_SM_CO2ST) << 24,
		MESSSFT_SMOOTH_CO2ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3D,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_SM_CO2ST) << 16,
	...
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3E,
		...
		MESSTHL_MESS_CO2ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3D,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_EDGE_CO2ST) << 8,
		MESSSFT_EDGE_CO2ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3D,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_EDGE_CO2ST) << 0,
		MESSTHL_EDGE_CO2ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_SM_CO2) << 24,
		BLDLV_SM_CO2);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MESS_CO2) << 20,
		BLDLV_MESS_CO2);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_EDGE_CO2) << 16,
		BLDLV_EDGE_CO2);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3F,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_SM_CO3MO) << 24,
		MESSSFT_SMOOTH_CO3MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3F,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_SM_CO3MO) << 16,
	...
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_40,
		...
		MESSTHL_MESS_CO3MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3F,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_EDGE_CO3MO) << 8,
		MESSSFT_EDGE_CO3MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3F,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_EDGE_CO3MO) << 0,
		MESSTHL_EDGE_CO3MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_41,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_SM_CO3ST) << 24,
		MESSSFT_SMOOTH_CO3ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_41,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_SM_CO3ST) << 16,
	...
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_42,
		...
		MESSTHL_MESS_CO3ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_41,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_EDGE_CO3ST) << 8,
		MESSSFT_EDGE_CO3ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_41,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_EDGE_CO3ST) << 0,
		MESSTHL_EDGE_CO3ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_SM_CO3) << 8,
		BLDLV_SM_CO3);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MESS_CO3) << 4,
		BLDLV_MESS_CO3);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_EDGE_CO3) << 0,
		BLDLV_EDGE_CO3);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_4F,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_SM_FRST) << 24,
		MESSSFT_SMOOTH_FRST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_4F,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_SM_FRST) << 16,
		MESSTHL_SMOOTH_FRST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_50,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MESS_FRST) << 24,
		MESSSFT_MESS_FRST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_50,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MESS_FRST) << 16,
		MESSTHL_MESS_FRST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_4F,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_EDGE_FRST) << 8,
		MESSSFT_EDGE_FRST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_4F,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_EDGE_FRST) << 0,
		MESSTHL_EDGE_FRST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_SM_FRST) << 24,
		BLDLV_SM_FRST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MESS_FRST) << 20,
		BLDLV_MESS_FRST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_EDGE_FRST) << 16,
		BLDLV_EDGE_FRST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_51,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_SM_MO) << 24,
		MESSSFT_SMOOTH_MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_51,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_SM_MO) << 16,
		MESSTHL_SMOOTH_MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_52,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MESS_MO) << 24,
		MESSSFT_MESS_MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_52,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MESS_MO) << 16,
		MESSTHL_MESS_MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_51,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_EDGE_MO) << 8,
		MESSSFT_EDGE_MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_51,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_EDGE_MO) << 0,
		MESSTHL_EDGE_MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_SM_MO) << 8,
		BLDLV_SM_MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MESS_MO) << 4,
		BLDLV_MESS_MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_EDGE_MO) << 0,
		BLDLV_EDGE_MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_53,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_SM_ST) << 24,
		MESSSFT_SMOOTH_ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_53,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_SM_ST) << 16,
		MESSTHL_SMOOTH_ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_54,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MESS_ST) << 24,
		MESSSFT_MESS_ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_54,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MESS_ST) << 16,
		MESSTHL_MESS_ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_53,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_EDGE_ST) << 8,
		MESSSFT_EDGE_ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_53,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_EDGE_ST) << 0,
		MESSTHL_EDGE_ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_SM_ST) << 24,
		BLDLV_SM_ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MESS_ST) << 20,
		BLDLV_MESS_ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_EDGE_ST) << 16,
		BLDLV_EDGE_ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_55,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_SM_BK) << 24,
		MESSSFT_SMOOTH_BK);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_55,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_SM_BK) << 16,
		MESSTHL_SMOOTH_BK);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_56,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MESS_BK) << 24,
		MESSSFT_MESS_BK);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_56,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MESS_BK) << 16,
		MESSTHL_MESS_BK);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_55,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_EDGE_BK) << 8,
		MESSSFT_EDGE_BK);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_55,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_EDGE_BK) << 0,
		MESSTHL_EDGE_BK);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_SM_BK) << 24,
		BLDLV_SM_BK);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MESS_BK) << 20,
		BLDLV_MESS_BK);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_EDGE_BK) << 16,
		BLDLV_EDGE_BK);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_57,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_SM_DEF) << 24,
		MESSSFT_SMOOTH_DEF);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_57,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_SM_DEF) << 16,
		MESSTHL_SMOOTH_DEF);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_58,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MESS_DEF) << 24,
		MESSSFT_MESS_DEF);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_58,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MESS_DEF) << 16,
		MESSTHL_MESS_DEF);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_57,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_EDGE_DEF) << 8,
		MESSSFT_EDGE_DEF);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_57,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_EDGE_DEF) << 0,
		MESSTHL_EDGE_DEF);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_SM_DEF) << 8,
		BLDLV_SM_DEF);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MESS_DEF) << 4,
		BLDLV_MESS_DEF);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_EDGE_DEF) << 0,
		BLDLV_EDGE_DEF);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_6E,
		wReadNRQualityTable(QUALITY_SNR_GLOBAL_BLEND) << 28,
		Y_GLOBAL_BLEND);

	/* BNR setting */
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_38,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MOS_CO1MO) << 8,
		MESSSFT_MOS_CO1MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_38,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MOS_CO1MO) << 0,
		MESSTHL_MOS_CO1MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3A,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MOS_CO1ST) << 8,
		MESSSFT_MOS_CO1ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3A,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MOS_CO1ST) << 0,
		MESSTHL_MOS_CO1ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_BK_CO1) << 12,
		BLDLV_BK_CO1);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MOS_CO1) << 4,
		BLDLV_MOS_CO1);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3C,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MOS_CO2MO) << 8,
		MESSSFT_MOS_CO2MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3C,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MOS_CO2MO) << 0,
		MESSTHL_MOS_CO2MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3E,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MOS_CO2ST) << 8,
		MESSSFT_MOS_CO2ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3E,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MOS_CO2ST) << 0,
		MESSTHL_MOS_CO2ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_BK_CO2) << 28,
		BLDLV_BK_CO2);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MOS_CO2) << 8,
		BLDLV_MOS_CO2);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_40,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MOS_CO3MO) << 8,
		MESSSFT_MOS_CO3MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_40,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MOS_CO3MO) << 0,
		MESSTHL_MOS_CO3MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_42,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MOS_CO3ST) << 8,
		MESSSFT_MOS_CO3ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_42,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MOS_CO3ST) << 0,
		MESSTHL_MOS_CO3ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_BK_CO3) << 12,
		BLDLV_BK_CO3);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MOS_CO3) << 12,
		BLDLV_MOS_CO3);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_50,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MOS_FRST) << 8,
		MESSSFT_MOS_FRST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_50,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MOS_FRST) << 0,
		MESSTHL_MOS_FRST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_BK_FRST) << 28,
		BLDLV_BK_FRST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MOS_FRST) << 0,
		BLDLV_NEAR_FRST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_52,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MOS_MO) << 8,
		MESSSFT_MOS_MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_52,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MOS_MO) << 0,
		MESSTHL_MOS_MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_BK_MO) << 12,
		BLDLV_BK_MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MOS_MO) << 24,
		BLDLV_MOS_MO);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_54,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MOS_ST) << 8,
		MESSSFT_MOS_ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_54,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MOS_ST) << 0,
		MESSTHL_MOS_ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_BK_ST) << 28,
		BLDLV_BK_ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MOS_ST) << 20,
		BLDLV_MOS_ST);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_56,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MOS_BK) << 8,
		MESSSFT_MOS_BK);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_56,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MOS_BK) << 0,
		MESSTHL_MOS_BK);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_BK_BK) << 28,
		BLDLV_BK_BK);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MOS_BK) << 28,
		BLDLV_MOS_BK);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_58,
		wReadNRQualityTable(QUALITY_SNR_MESSSFT_MOS_DEF) << 8,
		MESSSFT_MOS_DEF);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_58,
		wReadNRQualityTable(QUALITY_SNR_MESSTHL_MOS_DEF) << 0,
		MESSTHL_MOS_DEF);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
		wReadNRQualityTable(QUALITY_SNR_BLDLV_MOS_DEF) << 16,
		BLDLV_MOS_DEF);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_65,
		wReadNRQualityTable(QUALITY_SNR_CUR_SM_NUM) << 8,
		SM_NUM_THR);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_65,
		wReadNRQualityTable(QUALITY_SNR_CUR_SM_THR) << 24,
		MNR_SM_THR);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_65,
		wReadNRQualityTable(QUALITY_SNR_NEAREDGE_SELWIDTH) << 0,
		NEAREDGE_SEL_WIDTH);
	vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_65,
		wReadNRQualityTable(QUALITY_SNR_NEAREDGE_EDGE_THR) << 16,
		MNR_EDGE_THR);
	...
	if (u4Strength != NR_STRENGTH_OFF) {
		...
		case NR_STRENGTH_LOW:
			...
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
				(0x4 << 8), BLDLV_MOS_CO2);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
				(0x4 << 12), BLDLV_MOS_CO3);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x4 << 20), BLDLV_MOS_ST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x4 << 24), BLDLV_MOS_MO);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
				(0x4 << 0), BLDLV_NEAR_FRST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x4 << 16), BLDLV_MOS_DEF);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x4 << 28), BLDLV_MOS_BK);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x1 << 8), BLDLV_SM_CO1);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x1 << 4), BLDLV_MESS_CO1);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x1 << 0), BLDLV_EDGE_CO1);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x1 << 24), BLDLV_SM_CO2);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x1 << 20), BLDLV_MESS_CO2);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x1 << 16), BLDLV_EDGE_CO2);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x1 << 8), BLDLV_SM_CO3);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x1 << 4), BLDLV_MESS_CO3);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x1 << 0), BLDLV_EDGE_CO3);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x1 << 24), BLDLV_SM_ST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x1 << 20), BLDLV_MESS_ST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x1 << 16), BLDLV_EDGE_ST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
				(0x1 << 8), BLDLV_SM_MO);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
				(0x1 << 4), BLDLV_MESS_MO);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
				(0x1 << 0), BLDLV_EDGE_MO);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x1 << 24), BLDLV_SM_FRST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x1 << 20), BLDLV_MESS_FRST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x1 << 16), BLDLV_EDGE_FRST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x1 << 8), BLDLV_SM_DEF);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x1 << 4), BLDLV_MESS_DEF);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x1 << 0), BLDLV_EDGE_DEF);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_37,
				0x48084808, 0xFF3FFF3F);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_38,
				0x48084808, 0xFF3FFF3F);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_39,
				0x48084808, 0xFF3FFF3F);
			...
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_58,
				0x48084808, 0xFF3FFF3F);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_09,
				0x20000000, 0x28000000);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_8E,
		...
		case NR_STRENGTH_MED:
			...
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
				(0x6 << 8), BLDLV_MOS_CO2);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
				(0x6 << 12), BLDLV_MOS_CO3);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x6 << 20), BLDLV_MOS_ST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x6 << 24), BLDLV_MOS_MO);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
				(0x6 << 0), BLDLV_NEAR_FRST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x6 << 16), BLDLV_MOS_DEF);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x6 << 28), BLDLV_MOS_BK);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x2 << 8), BLDLV_SM_CO1);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x2 << 4), BLDLV_MESS_CO1);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x2 << 0), BLDLV_EDGE_CO1);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x2 << 24), BLDLV_SM_CO2);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x2 << 20), BLDLV_MESS_CO2);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x2 << 16), BLDLV_EDGE_CO2);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x2 << 8), BLDLV_SM_CO3);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x2 << 4), BLDLV_MESS_CO3);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x2 << 0), BLDLV_EDGE_CO3);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x2 << 24), BLDLV_SM_ST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x2 << 20), BLDLV_MESS_ST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x2 << 16), BLDLV_EDGE_ST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
				(0x2 << 8), BLDLV_SM_MO);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
				(0x2 << 4), BLDLV_MESS_MO);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
				(0x2 << 0), BLDLV_EDGE_MO);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x2 << 24), BLDLV_SM_FRST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x2 << 20), BLDLV_MESS_FRST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x2 << 16), BLDLV_EDGE_FRST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x2 << 8), BLDLV_SM_DEF);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x2 << 4), BLDLV_MESS_DEF);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x2 << 0), BLDLV_EDGE_DEF);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_37,
				0x4B0B4B0B, 0xFF3FFF3F);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_38,
				0x4B0B4B0B, 0xFF3FFF3F);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_39,
				0x4B0B4B0B, 0xFF3FFF3F);
		...
		case NR_STRENGTH_HIGH:
			...
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
				(0x8 << 8), BLDLV_MOS_CO2);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
				(0x8 << 12), BLDLV_MOS_CO3);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x8 << 20), BLDLV_MOS_ST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x8 << 24), BLDLV_MOS_MO);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
				(0x8 << 0), BLDLV_NEAR_FRST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x8 << 16), BLDLV_MOS_DEF);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x8 << 28), BLDLV_MOS_BK);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x3 << 8), BLDLV_SM_CO1);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x3 << 4), BLDLV_MESS_CO1);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x3 << 0), BLDLV_EDGE_CO1);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x3 << 24), BLDLV_SM_CO2);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x3 << 20), BLDLV_MESS_CO2);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x3 << 16), BLDLV_EDGE_CO2);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x3 << 8), BLDLV_SM_CO3);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x3 << 4), BLDLV_MESS_CO3);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_81,
				(0x3 << 0), BLDLV_EDGE_CO3);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x3 << 24), BLDLV_SM_ST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x3 << 20), BLDLV_MESS_ST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x3 << 16), BLDLV_EDGE_ST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
				(0x3 << 8), BLDLV_SM_MO);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
				(0x3 << 4), BLDLV_MESS_MO);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7F,
				(0x3 << 0), BLDLV_EDGE_MO);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x3 << 24), BLDLV_SM_FRST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x3 << 20), BLDLV_MESS_FRST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_80,
				(0x3 << 16), BLDLV_EDGE_FRST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x3 << 8), BLDLV_SM_DEF);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x3 << 4), BLDLV_MESS_DEF);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_7E,
				(0x3 << 0), BLDLV_EDGE_DEF);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_37,
				0x8F0F8B0B, 0xFF3FFF3F);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_38,
				0x8B0B8F0F, 0xFF3FFF3F);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_39,
				0x8F0F8B0B, 0xFF3FFF3F);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_3A,
				0x8B0B8F0F, 0xFF3FFF3F);
		...
		if (u4MNRStrength == NR_STRENGTH_OFF) {
			...
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
				(0x0 << 8), BLDLV_MOS_CO2);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
				(0x0 << 12), BLDLV_MOS_CO3);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x0 << 20), BLDLV_MOS_ST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x0 << 24), BLDLV_MOS_MO);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_84,
				(0x0 << 0), BLDLV_NEAR_FRST);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x0 << 16), BLDLV_MOS_DEF);
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_83,
				(0x0 << 28), BLDLV_MOS_BK);
		} else {
		...
		if (u4BNRStrength == NR_STRENGTH_OFF) {
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_1F,
				0x00000000, BLOCK_PROC_ENABLE);
		} else {
...
static void nr_hal_adaptive_bnr_para(void __iomem *reg_base,
	struct nr_config_param *ptNrPrm)
{
	...
	if (u1VBKLv == 7) {
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_08,
			0x0005A040, 0x007FF7FF);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_0C,
			0x0006405A, 0x007FF7FF);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_10,
			0x0005A040, 0x007FF7FF);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_14,
			0x0005A040, 0x007FF7FF);
	} else {
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_08,
			0x0002D020, 0x007FF7FF);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_0C,
			0x0003602D, 0x007FF7FF);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_10,
			0x0002D820, 0x007FF7FF);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_14,
			0x0002D020, 0x007FF7FF);
	}
	if (u1HBKLv == 7) {
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_0A,
			0x20180000, 0xFFFF0000);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_0E,
			0x20180000, 0xFFFF0000);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_12,
			0x20180000, 0xFFFF0000);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_16,
			0x20180000, 0xFFFF0000);
	} else {
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_0A,
			0x0E0A0000, 0xFFFF0000);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_0E,
			0x0E0A0000, 0xFFFF0000);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_12,
			0x0E0A0000, 0xFFFF0000);
...
{
	return devm_request_irq(nr->dev, nr->irq,
		nr_irq_handler, 0, "nr", (void *)nr);
}
...
static void nr_hal_config(void __iomem *reg_base,
	struct nr_config_param *ptNrPrm)
{
	...
	if (ptNrPrm->u4NRMode == NR_STD_MODE) {
		vNrWriteReg(reg_base + RW_NR_CURR_Y_RD_ADDR,
			ptNrPrm->u4CurrRdYAddr);
		vNrWriteReg(reg_base + RW_NR_CURR_C_RD_ADDR,
			ptNrPrm->u4CurrRdCAddr);

		vNrWriteReg(reg_base + RW_NR_Y_WR_SADDR,
			ptNrPrm->u4CurrWrYAddr);
		vNrWriteReg(reg_base + RW_NR_Y_WR_EADDR, 0xFFFFFFFF);
		vNrWriteReg(reg_base + RW_NR_C_WR_SADDR,
			ptNrPrm->u4CurrWrCAddr);
	...
	if (ptNrPrm->u1FrameMode == MODE_FRAME)
		vNRWriteRegMsk(reg_base + RW_NR_DRAM_CTRL_00,
		0x00001000, 0x0000FF01);
	else
		vNRWriteRegMsk(reg_base + RW_NR_DRAM_CTRL_00,
		0x00001001, 0x0000FF01);

	/* reset NR module */
	vNrWriteReg(reg_base + RW_NR_MISC_CTRL, 0x000000ff);

	/* select CRC source */
	vNrWriteReg(reg_base + RW_NR_MAIN_CTRL_00, 0x6010007c);
	...
	/* Range Remap Setting */
	{
		u4Value = (vNrReadReg(reg_base +
			RW_NR_HD_RANGE_MAP) & 0xFFFFE0E0);
	...
	u4MBCnt = ((ptNrPrm->u2FrameWidth + 15) >> 4);
	u2HActive = ptNrPrm->u2FrameWidth;
	u2VActive = ptNrPrm->u2PicHeight;

	/* output buffer width */
	vNRWriteRegMsk(reg_base + RW_NR_DRAM_CTRL_00,
		(u4MBCnt << 24), 0xFF000000);
	...
	if (ptNrPrm->u1FrameMode == MODE_FRAME) {
		...
		u4Value = u4Value << 16;
		u4Value = u4Value | u2HActive;
		vNRWriteRegMsk(reg_base + RW_NR_DRAM_CTRL_01,
			u4Value, 0x07FF0FFF);
	} else {
		u4Value = (u2VActive / 2);
		u4Value = u4Value << 16;
		...
		vNRWriteRegMsk(reg_base + RW_NR_DRAM_CTRL_01,
			u4Value, 0x07FF0FFF);
		vNRWriteRegMsk(reg_base + RW_NR_LAST_SIZE_CTRL,
			u4Value, 0x07FF0FFF);
	}

	if (ptNrPrm->u1DemoMode == NR_DEMO_0) {
		vNRWriteRegMsk(reg_base + RW_NR_3D_0D,
			(((ptNrPrm->u2PicWidth / 2) - 1) << 20),
			C_LINE_MANUAL_LEN);
		vNRWriteRegMsk(reg_base + RW_NR_3D_00,
			(0x1 << 12) | ((ptNrPrm->u2PicWidth / 4) - 1),
			C_LINE_HALF_WIDTH);
	} else {
		vNRWriteRegMsk(reg_base + RW_NR_3D_0D,
			(0x3FF << 20), C_LINE_MANUAL_LEN);
		vNRWriteRegMsk(reg_base + RW_NR_3D_00,
			0xEF, C_LINE_HALF_WIDTH);
	}
	...
	if (ptNrPrm->u1DemoMode == NR_DEMO_0) {
		...
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_02,
			((ptNrPrm->u2PicWidth / 2) << 16),
			SLICE_X_POSITION);
	...
	/* Block meter setting */
	if (ptNrPrm->u1FrameMode == MODE_FRAME) {
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_01,
			ptNrPrm->u2PicHeight, 0x7FF);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_01,
			(ptNrPrm->u2PicWidth << 16), 0x7FF0000);
	} else {
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_01,
			(ptNrPrm->u2PicHeight / 2), 0x7FF);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_01,
			(ptNrPrm->u2PicWidth << 16), 0x7FF0000);
	}

	if (ptNrPrm->u1FrameMode == MODE_FRAME) {
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_5B,
			ptNrPrm->u2PicHeight, BK_METER_HEIGHT);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_5B,
			((ptNrPrm->u2PicWidth / 2) << 16),
			       BK_METER_WIDTH);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_95,
			       ((((ptNrPrm->u2PicHeight / 8) / 2) / 6) *
			       2) << 10, 0x000FFC00);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_97,
			       (((((ptNrPrm->u2PicWidth / 8) / 2) / 6) *
			       2) << 11), 0x003FF800);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_96,
			       (((ptNrPrm->u2PicHeight + 31) / (8 * 8)) *
			       2) << 11, 0x0003FF800);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_94,
			       ((ptNrPrm->u2PicWidth / (64 * 6)) * 3) << 15,
			       0x3FFF8000);
	} else {
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_5B,
			ptNrPrm->u2PicHeight / 2, BK_METER_HEIGHT);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_5B,
			((ptNrPrm->u2PicWidth / 2) << 16),
			       BK_METER_WIDTH);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_95,
			       ((((ptNrPrm->u2PicHeight / 8) / 4) /
			       6) * 2) << 10, 0x000FFC00);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_97,
			       (((((ptNrPrm->u2PicWidth / 8) / 2) /
			       6) * 2) << 11), 0x003FF800);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_96,
			       (((ptNrPrm->u2PicHeight + 63) /
			       (8 * 8 * 2)) * 2) << 11,
			       0x0003FF800);
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_94,
			((ptNrPrm->u2PicWidth / (64 * 6)) * 3) << 15,
	...
	if (ptNrPrm->fgBypassEn)
		vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_1F,
		0x00000000, 0x00000001);	/* turn off NR kernel process */
	else {
		nr_hal_adaptive_bnr_para(reg_base, ptNrPrm);
		nr_hal_set_level(reg_base, ptNrPrm->u4Strength,
			ptNrPrm->u4MNRStrength, ptNrPrm->u4BNRStrength);
	}
	...
	if (ptNrPrm->u4NRMode == NR_STD_MODE) {
		if (ptNrPrm->fgUseBlockMeter)
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_1F,
			0x100, BLOCK_METER_ENABLE);
		else
			vNRWriteRegMsk(reg_base + RW_NR_2DNR_CTRL_1F,
			0x000, BLOCK_METER_ENABLE);
...
int nr_hal_set_info(void __iomem *reg_base,
	struct mtk_vq_config_info *config_info)
{
	...
	if (config->vq_mode == VQ_NR_STANDALONE) {
		nr_param.u4CurrRdYAddr = config_info->src_mva[0] +
			config->src_ofset_y_len[0];
		nr_param.u4CurrRdCAddr = config_info->src_mva[0] +
			config->src_ofset_c_len[0];

		nr_param.u4CurrWrYAddr = config_info->dst_mva +
			config->dst_ofset_y_len;
		nr_param.u4CurrWrCAddr = config_info->dst_mva +
			config->dst_ofset_c_len;
	}
