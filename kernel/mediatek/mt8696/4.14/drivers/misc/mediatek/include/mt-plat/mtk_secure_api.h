...
#define MTK_SIP_KERNEL_MFG_CONTROL \
...
#define emi_mpu_smc_protect(start, end, apc, lock_status) \
mt_secure_call(MTK_SIP_KERNEL_EMIMPU_SET, start, end, apc, lock_status)
#define emi_mpu_smc_region_protect(start, end, region_num_lock_status, apc) \
mt_secure_call(MTK_SIP_KERNEL_EMIMPU_REGION_SET, start, end, \
region_num_lock_status, apc)
