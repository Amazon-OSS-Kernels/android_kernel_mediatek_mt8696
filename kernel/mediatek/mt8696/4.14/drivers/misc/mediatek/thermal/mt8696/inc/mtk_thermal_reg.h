...
#ifndef _MTK_THERMAL_TYPE_H
#define _MTK_THERMAL_TYPE_H
...
#define PERI_GLOBALCON_RST0 (PERICFG_AO_BASE + 0x000)
...
#define PTPCORESEL          (THERM_CTRL_BASE_2 + 0x700)
#define THERMINTST          (THERM_CTRL_BASE_2 + 0x704)
#define PTPODINTST          (THERM_CTRL_BASE_2 + 0x708)
#define THSTAGE0ST          (THERM_CTRL_BASE_2 + 0x70C)
#define THSTAGE1ST          (THERM_CTRL_BASE_2 + 0x710)
#define THSTAGE2ST          (THERM_CTRL_BASE_2 + 0x714)
#define THAHBST0            (THERM_CTRL_BASE_2 + 0x718)
#define THAHBST1            (THERM_CTRL_BASE_2 + 0x71C) /*Only for DE debug*/
#define PTPSPARE0           (THERM_CTRL_BASE_2 + 0x720)
#define PTPSPARE1           (THERM_CTRL_BASE_2 + 0x724)
#define PTPSPARE2           (THERM_CTRL_BASE_2 + 0x728)
#define PTPSPARE3           (THERM_CTRL_BASE_2 + 0x72C)
#define THSLPEVEB           (THERM_CTRL_BASE_2 + 0x730)


#define PTPSPARE0_P           (thermal_phy_base + 0x720)
#define PTPSPARE1_P           (thermal_phy_base + 0x724)
#define PTPSPARE2_P           (thermal_phy_base + 0x728)
#define PTPSPARE3_P           (thermal_phy_base + 0x72C)
