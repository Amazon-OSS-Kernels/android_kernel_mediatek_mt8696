...
enum imgresz_ticket_fun_type mdp_imgresz_get_function_type(
	enum DP_COLOR_ENUM format, int width, int height)
{
	/* ufo format */
...
enum MDP_TASK_STATUS mdp_imgresz_fill_task(struct mdp_task_struct *pTask)
{
	...
	(enum IMGRZ_MEM_ENUM)p_command_buffer->buffer_info.memory_type;

	p_task_src_buffer->buf_info.fd =
