...
#if 1
#define TZ_TA_IMGRZ_UUID   "88da5a2c-22c1-88dc-49a8-24f9bdc58890"
#else
#define TZ_TA_IMGRZ_NAME "IMGRESZ_TA"
#define TZ_TA_IMGRZ_UUID "imgresz_ta_uuid_11575"
#endif

enum IMGRESZ_TZ_CALL_DIR {
	IMGRESZ_TZ_CALL_DIR_NONE = 0,
	IMGRESZ_TZ_CALL_DIR_VALUE_INPUT = 1,
	IMGRESZ_TZ_CALL_DIR_VALUE_OUTPUT = 2,
	IMGRESZ_TZ_CALL_DIR_VALUE_INOUT = 3,
	IMGRESZ_TZ_CALL_DIR_MEM_INPUT = 4,
	IMGRESZ_TZ_CALL_DIR_MEM_OUTPUT = 5,
	IMGRESZ_TZ_CALL_DIR_MEM_INOUT = 6,
	IMGRESZ_TZ_CALL_DIR_MEMREF_INPUT = 7,
	IMGRESZ_TZ_CALL_DIR_MEMREF_OUTPUT = 8,
	IMGRESZ_TZ_CALL_DIR_MEMREF_INOUT = 9,
};
...
#endif
extern dma_addr_t imgrz_test_buffer_pa;
