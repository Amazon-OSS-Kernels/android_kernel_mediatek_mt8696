...
void vPerformanceCalConf(void)
{
	...
	cal1 = get_devinfo_with_index(73);
	TX_DEF_LOG("[HDMI]cal 0x11c10b98 = 0x%x\n", cal1);
	cal2 = get_devinfo_with_index(74);
...
{
#if 0 //mark on 2020-9-15
	HDMI_PLUG_LOG("%s = %lums\n",
		__func__, jiffies);

		vWriteIoHdmiAnaMsk(HDMI20_CFG_7,
			RG_HDMITX20_RESERVE, RG_HDMITX20_RESERVE);
		vWriteIoHdmiAnaMsk(HDMI20_PLL_CFG_0,
			RG_HDMITX20PLL_BG_EN, RG_HDMITX20PLL_BG_EN);
		vWriteIoHdmiAnaMsk(HDMI20_PLL_CFG_0,
			RG_HDMITX20PLL_EN, RG_HDMITX20PLL_EN);
		udelay(100);
		vWriteIoHdmiAnaMsk(HDMI20_CFG_8,
			RG_HDMITX20_BIAS_EN, RG_HDMITX20_BIAS_EN);
		vWriteIoHdmiAnaMsk(HDMI20_CFG_5,
			RG_HDMITX20_CKLDO_EN, RG_HDMITX20_CKLDO_EN);
		vWriteIoHdmiAnaMsk(HDMI20_CFG_4,
			RG_HDMITX20_SLDO_EN, RG_HDMITX20_SLDO_EN);
		vWriteIoHdmiAnaMsk(HDMI20_CFG_8,
			RG_HDMITX20_TX_POSDIV_EN, RG_HDMITX20_TX_POSDIV_EN);
		vWriteIoHdmiAnaMsk(HDMI20_CFG_0,
			RG_HDMITX20_SER_EN, RG_HDMITX20_SER_EN);

		vWriteIoHdmiAnaMsk(HDMI20_CFG_0,
			RG_HDMITX20_PRD_EN, RG_HDMITX20_PRD_EN);

		vWriteIoHdmiAnaMsk(HDMI20_CFG_8, 0, RG_HDMITX20_BIAS_LPF_EN);
		vWriteIoHdmiAnaMsk(HDMI20_CFG_8,
			RG_HDMITX20_INTR_EN, RG_HDMITX20_INTR_EN);
...
void vHalVrrEnable(bool fgEnable)
{
	...
	vWriteByteHdmiGRL(HDMI_VRR_CFG, fgEnable);
}
...
void vcommon_status(char *str)
{
	if (_stAvdAVInfo.e_resolution < HDMI_VIDEO_RESOLUTION_NUM &&
		...
		sprintf(str, "%s\n%s\n%s\n\n",
		szHdmiResStr[_stAvdAVInfo.e_resolution],
	szHdmiDeepcolorStr[_stAvdAVInfo.e_deep_color_bit],
