...
enum CMDQ_SEC_ENG_ENUM {
	/* VDO3 */
	CMDQ_SEC_DISP_VDO3_Y0,   /* 0 */
	CMDQ_SEC_DISP_VDO3_Y1,   /* 1 */
	CMDQ_SEC_DISP_VDO3_Y2,   /* 2 */
	CMDQ_SEC_DISP_VDO3_Y3,   /* 3 */
	CMDQ_SEC_DISP_VDO3_C0,   /* 4 */
	CMDQ_SEC_DISP_VDO3_C1,   /* 5 */
	CMDQ_SEC_DISP_VDO3_C2,   /* 6 */
	CMDQ_SEC_DISP_VDO3_C3,   /* 7 */
	CMDQ_SEC_DISP_VDO3_Y_LEN,   /* 8 */
	CMDQ_SEC_DISP_VDO3_C_LEN,   /* 9 */

	/* VDO4*/
	CMDQ_SEC_DISP_VDO4_Y0,   /* 10*/
	CMDQ_SEC_DISP_VDO4_Y1,   /* 11*/
	CMDQ_SEC_DISP_VDO4_C0,   /* 12*/
	CMDQ_SEC_DISP_VDO4_C1,   /* 13*/
	CMDQ_SEC_DISP_VDO4_Y_LEN,   /* 14*/
	CMDQ_SEC_DISP_VDO4_C_LEN,   /* 15*/
