...
static ssize_t show_rt5738_access(struct device *dev,
...
static ssize_t store_rt5738_access(struct device *dev,
...
static DEVICE_ATTR(rt5738_access, 0664,
		show_rt5738_access, store_rt5738_access);/* 664 */
