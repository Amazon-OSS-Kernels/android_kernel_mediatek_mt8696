...
/*
 * Some i2c pins have 4 driving gears adjustable, only the first
 * four Macro values can be set(MTK_EH_I2C_DRVE_001~MTK_EH_I2C_DRVE_011).
 * Some i2c pins have 8 driving gears adjustable, all Macro values can be set.
 */
#define MTK_I2C_DRIVE_000 100
#define MTK_I2C_DRIVE_001 101
#define MTK_I2C_DRIVE_010 102
#define MTK_I2C_DRIVE_011 103
#define MTK_I2C_DRIVE_100 104
#define MTK_I2C_DRIVE_101 105
#define MTK_I2C_DRIVE_110 106
#define MTK_I2C_DRIVE_111 107
